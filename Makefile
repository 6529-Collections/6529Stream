...
check: build test gas-snapshot-check size metadata-fixtures-check release-artifacts-check source-verification-inputs-check abi-compatibility-check architecture-threat-model-check audit-package-check release-readiness-check release-checksums-check changelog-check deploy-rehearsal
...
release-manifest: address-books source-verification-inputs dependency-artifacts ceremony-evidence-check randomizer-operations-check release-signatures-check architecture-threat-model-check audit-package-check release-readiness-check
	$(PYTHON) scripts/generate_release_manifest.py

release-manifest-check: address-books-check source-verification-inputs-check dependency-artifacts-check ceremony-evidence-check randomizer-operations-check release-signatures-check architecture-threat-model-check audit-package-check release-readiness-check
