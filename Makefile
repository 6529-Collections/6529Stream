...
release-manifest: address-books protocol-surface-report custom-error-catalog source-verification-inputs dependency-artifacts one-of-one-provenance-manifest one-of-one-permanence-manifest ceremony-evidence-check randomizer-operations-check release-signatures-check non-local-release-evidence-check external-audit-report-evidence-check fork-deployment-rehearsal-evidence-check testnet-deployment-rehearsal-evidence-check marketplace-indexer-evidence-check drop-authorization-signing-evidence-check signer-custody-readiness-check public-beta-evidence-check risk-register public-beta-blocker-report-check production-release-blocker-report-check release-evidence-packet-index-check release-evidence-issue-backlog-check release-evidence-issue-links-check release-evidence-issue-body-sync-check release-evidence-issue-bodies-check release-evidence-issue-closure-check release-evidence-live-audit-markdown-check architecture-threat-model-check audit-package-check incident-response-check integrations-readme-check contract-flows-check auction-flows-check wallet-signature-flows-check events-and-indexing-check metadata-rendering-check react-next-reference-check mobile-walletconnect-check electron-security-wallets-check operator-admin-ui-check royalty-policy-check warning-dispositions-check drop-authorization-fixtures-check release-readiness-check
	$(PYTHON) scripts/generate_release_manifest.py

release-manifest-check: address-books-check protocol-surface-report-check custom-error-catalog-check source-verification-inputs-check dependency-artifacts-check one-of-one-provenance-manifest-check one-of-one-permanence-manifest-check ceremony-evidence-check randomizer-operations-check release-signatures-check non-local-release-evidence-check external-audit-report-evidence-check fork-deployment-rehearsal-evidence-check testnet-deployment-rehearsal-evidence-check marketplace-indexer-evidence-check drop-authorization-signing-evidence-check signer-custody-readiness-check public-beta-evidence-check risk-register-check public-beta-blocker-report-check production-release-blocker-report-check release-evidence-packet-index-check release-evidence-issue-backlog-check release-evidence-issue-links-check release-evidence-issue-body-sync-check release-evidence-issue-bodies-check release-evidence-issue-closure-check release-evidence-live-audit-markdown-check architecture-threat-model-check audit-package-check incident-response-check integrations-readme-check contract-flows-check auction-flows-check wallet-signature-flows-check events-and-indexing-check metadata-rendering-check react-next-reference-check mobile-walletconnect-check electron-security-wallets-check operator-admin-ui-check royalty-policy-check warning-dispositions-check drop-authorization-fixtures-check release-readiness-check
