...
release-manifest: address-books source-verification-inputs dependency-artifacts ceremony-evidence-check randomizer-operations-check release-signatures-check non-local-release-evidence-check drop-authorization-signing-evidence-check signer-custody-readiness-check public-beta-evidence-check public-beta-blocker-report-check architecture-threat-model-check audit-package-check incident-response-check drop-authorization-fixtures-check release-readiness-check
