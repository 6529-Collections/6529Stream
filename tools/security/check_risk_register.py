...
GOVERNED_PARAMETER_COMPLETENESS_RISK_ID = "RISK-GOV-004"
RECORD_FAMILY_AUTHORIZATION_RISK_ID = "RISK-GOV-002"
REQUIRED_RISK_STATUSES = {
    RECORD_FAMILY_AUTHORIZATION_RISK_ID: "open_blocker",
    GOVERNANCE_NATIVE_VALUE_RISK_ID: "open_blocker",
    GOVERNED_PARAMETER_COMPLETENESS_RISK_ID: "open_blocker",
}
