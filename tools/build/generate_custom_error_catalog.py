...
CATEGORY_BY_ERROR_NAME = {
    ...
    "AuthorityProviderCallFailed": "access_control",
    "AuthorityProviderNoOp": "configuration",
    "BurnedTokenRemintNotAllowed": "supply_minting",
    "CollectionBurnsAreBlocked": "supply_minting",
    ...
    "CollectionIsFrozen": "metadata_integrity",
    "CollectionUnknown": "metadata_integrity",
    ...
    "EntropyRegistrationFailed": "randomness_lifecycle",
    ...
    "GasParameterTransitionInvalid": "configuration",
    "GasParameterUnknown": "configuration",
    "GovernanceActionAlreadyApplied": "configuration",
    "GovernanceActionClassMismatch": "configuration",
    "GovernanceTransitionMismatch": "configuration",
    ...
    "InvalidAuthorityProvider": "configuration",
    "InvalidAuthorizationClassMask": "configuration",
    ...
    "InvalidMintGate": "mint_manager_policy",
    "InvalidMintModule": "mint_manager_policy",
    "InvalidMintModuleInfo": "mint_manager_policy",
    "InvalidMintModuleRegistry": "mint_manager_policy",
    ...
    "InvalidCollectionRecordRecorder": "metadata_integrity",
    "InvalidCollectionConfiguration": "configuration",
    "InvalidCollectionTransition": "configuration",
    "InvalidCoreConfiguration": "configuration",
    "InvalidGasParameterConfiguration": "configuration",
    "InvalidGenesisModuleRegistry": "configuration",
    "InvalidBlockHeight": "configuration",
    "InvalidHashRef": "metadata_integrity",
    "InvalidMetadataRecord": "metadata_integrity",
    "InvalidMetadataRefresh": "metadata_integrity",
    "InvalidSnapshotFamilySet": "metadata_integrity",
    "InvalidSnapshotId": "metadata_integrity",
    "InvalidSnapshotRecordType": "metadata_integrity",
    ...
    "InvalidSatellitePointer": "configuration",
    "InvalidRecordFamilyConfigurationAuthority": "configuration",
    "InvalidRecordFamilyRegistry": "configuration",
    "InvalidRecordType": "metadata_integrity",
    ...
    "InvalidTokenData": "metadata_integrity",
    ...
    # Historical names retained only so the generator can validate the committed
    # pre-cutover surface until the atomic release-artifact regeneration.
    ...
    "InvalidPolicyGrace": "mint_ledger_accounting",
    "InvalidPhasePolicy": "mint_ledger_accounting",
    "NullifierAlreadyConsumed": "mint_ledger_accounting",
    "OperationRootAlreadyConsumed": "mint_ledger_accounting",
    "OperationRootRequired": "mint_ledger_accounting",
    ...
    "MintGateAuthorizationMismatch": "mint_manager_policy",
    "MintGateAuthorizerMismatch": "mint_manager_policy",
    ...
    "MintInvalidAuthorizerKind": "mint_manager_policy",
    "MintModuleCodehashMismatch": "mint_manager_policy",
    "MintModuleInterfaceUnsupported": "mint_manager_policy",
    ...
    "MintOperationIdDuplicate": "mint_manager_policy",
    "MintOperationIdRequired": "mint_manager_policy",
    "MintOperationNonceOverflow": "mint_manager_policy",
    "MintOperationRootRequired": "mint_manager_policy",
    "MintExecutionInProgress": "supply_minting",
    ...
    "NoExecutingGovernanceAction": "access_control",
    ...
    "PreparedMintAbortNotReplacement": "supply_minting",
    "PreparedMintNotFound": "supply_minting",
    # Historical name retained only so the generator can validate the committed
    # pre-cutover surface until the atomic release-artifact regeneration.
    "PreparedMintOperationReused": "supply_minting",
    "PreparedMintOperationRequired": "supply_minting",
    ...
    "RecordFamilyConfigurationAuthorityAcceptanceRequired": "access_control",
    "RecordFamilyConfigurationAuthorityProposalMissing": "configuration",
    "RecordFamilyConfigurationAuthorityProposalNoOp": "configuration",
    "RecordFamilyConfigurationAuthorityProposalPending": "configuration",
    "RecordFamilyConfigurationAuthorityRequired": "access_control",
    "RecordFamilyGrantNoOp": "configuration",
    "RecordFamilyGrantNotAllowed": "access_control",
    "RecordFamilyHostNotAllowed": "metadata_integrity",
    "RecordFamilyLockNotAllowed": "metadata_integrity",
    "RecordFamilyRegistryOwnerRequired": "access_control",
    "RecordFamilyUnauthorized": "access_control",
    "RecordTypeAlreadyAdmitted": "configuration",
    "RecordTypeNotAdmitted": "metadata_integrity",
    "ReentrancyGuardReentrantCall": "auction_payment_safety",
    "SettlementAlreadyConsumed": "primary_settlement_safety",
    "RevisionOverflow": "configuration",
    "SatellitePointerFrozen": "configuration",
    "SatellitePointerInterfaceUnresolved": "configuration",
    "SatellitePointerNoOp": "configuration",
    ...
    "UnknownSatellitePointer": "configuration",
    ...
    "UnauthorizedGovernanceExecutor": "access_control",
    "UnauthorizedMetadataEmitter": "access_control",
    "UnknownAuthorizationClass": "configuration",
    "UnknownDependency": "metadata_integrity",
    "UnknownRecordFamily": "configuration",
...
TRACEABILITY_BY_CATEGORY = {
    "access_control": [
        "test/regression/legacy/protocol/StreamCustomErrorNegative.t.sol",
        "test/regression/legacy/core/StreamCoreCustomErrors.t.sol",
    ],
    "asset_policy_safety": [
    ...
    "metadata_integrity": [
        "test/regression/legacy/metadata/StreamMetadataCrossInvariants.t.sol",
        "test/regression/legacy/metadata/StreamMetadataUtf8.t.sol",
        "test/regression/legacy/protocol/StreamCustomErrorNegative.t.sol",
    ],
    "randomness_lifecycle": [
        "test/regression/legacy/entropy/StreamRandomizerLifecycle.t.sol",
        "test/unit/entropy/StreamRandomizerAdversarial.t.sol",
        "test/regression/legacy/protocol/StreamCustomErrorNegative.t.sol",
    ],
    ...
    "mint_manager_policy": [
        "test/regression/legacy/mint/StreamMintManager.t.sol",
...
TRACEABILITY_BY_ERROR_NAME = {
    ...
    "InvalidMintManagerContract": [
        "test/regression/legacy/mint/StreamMintManagerCoreHooks.t.sol",
    ],
    "InvalidSnapshotId": [
        "test/regression/legacy/metadata/StreamCollectionMetadata.t.sol",
    ],
...
TRACEABILITY_BY_ERROR_ID = {
    "StreamArtistArchiveV2:ArtistArchiveBlockNumberOverflow(uint256)": [
        "test/unit/artist/StreamArtistArchiveV2.t.sol",
    ],
    ...
    "StreamArtistRegistryV2:ArtistRegistryExternalProviderBindingMismatch(uint8,bytes32,bytes32)": [
        "test/unit/artist/StreamArtistRegistryV2.t.sol",
    ],
...
def build_catalog(repo_root: Path, surface_path: Path, output_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "generated_by": f"tools/build/generate_custom_error_catalog.py:{GENERATOR_VERSION}",
        "source": {
...
def check_catalog(repo_root: Path, surface_path: Path, output_path: Path) -> int:
    if not output_path.exists():
        print(
            f"{output_path} is missing; run `python -m tools.build.generate_custom_error_catalog`.",
            file=sys.stderr,
        )
        return 1
