...
def build_manifest(
    ...
    return {
        ...
        "generated_by": f"tools/build/generate_source_verification_inputs.py:{GENERATOR_VERSION}",
        "source": {
...
def check_output(
    ...
    if not output_path.exists():
        ...
        print(
            "run `python -m tools.build.generate_source_verification_inputs` and commit "
