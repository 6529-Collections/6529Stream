...
CANONICAL_BUILD_COMMAND = "python -m tools.build.build_release_artifacts"
...
_COMMON_SIX = (
    ...
    # R4 identifies an immutable earlier capture; its source labels are hash-bound.
...
def build_manifest(
    ...
    *,
    ...
    return {
        ...
        "generated_by": f"tools/build/build_release_artifacts.py:{GENERATOR_VERSION}",
        "source": {
...
def validate_release_output_with_snapshots(
    ...
    *,
    ...
    if manifest.get("generated_by") != (
        f"tools/build/build_release_artifacts.py:{GENERATOR_VERSION}"
    ):
