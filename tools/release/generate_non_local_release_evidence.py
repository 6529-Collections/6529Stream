...
from tools.release import check_non_local_release_evidence as evidence_checker
...
def check_output(output_path: Path, generated: dict[str, Any]) -> None:
    ...
    if existing != generated:
        raise NonLocalEvidenceGeneratorError(
            f"{output_path} is stale; rerun tools/release/generate_non_local_release_evidence.py"
        )
