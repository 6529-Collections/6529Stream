...
from tools.release import check_release_evidence_issue_bodies as body_checker
from tools.release import check_release_evidence_issue_links as issue_link_checker
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "`python -m tools.release.fetch_release_evidence_issue_snapshot --output <path>` "
