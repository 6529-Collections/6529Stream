...
RELEASE_TOOL_CALL_POLICY_PATH_PATTERN = (
    r"^(?:scripts|tools)/(?:[A-Za-z0-9_-]+/)*[A-Za-z0-9_-]+\.py$"
)
...
RELEASE_TOOL_ROOTS = (
    ...
    Path("tools/release/generate_release_notes.py"),
    Path("tools/release/generate_release_manifest.py"),
    Path("tools/build/generate_bytecode_release_proof.py"),
    Path("tools/release/generate_release_candidate_lockfile.py"),
    Path("tools/release/generate_release_checksums.py"),
...
REVIEWED_RELEASE_TOOL_ROOTS_SHA256 = (
    "98e68d820f6da73f8b7684b0bd054af1c7c706c8482c344a0ff4bcb5551a148c"
)
RELEASE_TOOL_FOCUSED_TESTS = (
    Path("tools/docs/test_changelog_check.py"),
    Path("tools/release/test_release_notes.py"),
    Path("tools/deployment/test_admin_ceremony_evidence.py"),
    Path("tools/release/test_drop_authorization_signing_evidence.py"),
    Path("tools/release/test_non_local_release_evidence.py"),
    Path("tools/protocol/test_artist_semantic_owner_matrix.py"),
    Path("tools/protocol/test_record_family_authorization.py"),
    Path("tools/release/test_release_signatures.py"),
    Path("tools/release/test_signer_custody_readiness.py"),
    Path("tools/build/test_bytecode_release_proof.py"),
)
RELEASE_TOOL_SEMANTIC_SOURCE_PATHS = (
    Path("smart-contracts/interfaces/stream/records/IStreamRecordFamilyAuthorityProvider.sol"),
    Path("smart-contracts/interfaces/stream/records/IStreamRecordFamilyRegistry.sol"),
    ...
    Path("smart-contracts/interfaces/stream/metadata/IStreamCollectionMetadata.sol"),
    Path("smart-contracts/domains/preservation/StreamPreservationRecords.sol"),
    Path("smart-contracts/interfaces/stream/preservation/IStreamPreservationRecords.sol"),
    Path("script/legacy/RehearseDeployment.s.sol"),
    Path("test/regression/legacy/records/StreamRecordFamilyAuthorization.t.sol"),
    Path("test/regression/legacy/metadata/StreamCollectionMetadata.t.sol"),
    Path("test/regression/legacy/preservation/StreamPreservationRecords.t.sol"),
    Path("test/regression/legacy/protocol/StreamDeploymentManifest.t.sol"),
)
REVIEWED_RELEASE_TOOL_RUNTIME_CLOSURE = (
    Path("tools/__init__.py"),
    Path("tools/build/__init__.py"),
    Path("tools/build/generate_bytecode_release_proof.py"),
    Path("tools/build/verify_release_artifacts.py"),
    Path("tools/deployment/__init__.py"),
    Path("tools/deployment/check_admin_ceremony_evidence.py"),
    Path("tools/docs/__init__.py"),
    Path("tools/docs/check_changelog.py"),
    Path("tools/protocol/__init__.py"),
    Path("tools/protocol/check_artist_semantic_owner_matrix.py"),
    Path("tools/protocol/check_governance_action_policy.py"),
    Path("tools/protocol/check_governed_parameter_identifiers.py"),
    Path("tools/protocol/check_governed_parameter_inventory.py"),
    Path("tools/protocol/check_record_family_authorization.py"),
    Path("tools/release/__init__.py"),
    Path("tools/release/check_drop_authorization_signing_evidence.py"),
    Path("tools/release/check_non_local_release_evidence.py"),
    Path("tools/release/check_public_beta_evidence.py"),
    Path("tools/release/check_release_evidence_issue_links.py"),
    Path("tools/release/check_release_signatures.py"),
    Path("tools/release/check_signer_custody_readiness.py"),
    Path("tools/release/generate_release_candidate_lockfile.py"),
    Path("tools/release/generate_release_checksums.py"),
    Path("tools/release/generate_release_manifest.py"),
    Path("tools/release/generate_release_notes.py"),
    Path("tools/release/release_evidence_paths.py"),
    Path("tools/security/__init__.py"),
    Path("tools/security/check_risk_register.py"),
    Path("tools/security/check_slither_baseline.py"),
    Path("tools/security/generate_risk_register.py"),
    Path("tools/shared/__init__.py"),
    Path("tools/shared/no_secret_scanner.py"),
)
...
RELEASE_TOOL_CALL_POLICY_IMPORTED_VALUE_ALLOWLIST = frozenset(
    tuple(line.split("|"))
    for line in """
tools/deployment/check_admin_ceremony_evidence.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/protocol/check_artist_semantic_owner_matrix.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/protocol/check_artist_semantic_owner_matrix.py|sys.stderr|local:print|keyword:file
tools/deployment/check_admin_ceremony_evidence.py|re.IGNORECASE|re.compile|arg:1
tools/deployment/check_admin_ceremony_evidence.py|sys.argv|local:parse_args|arg:0
tools/deployment/check_admin_ceremony_evidence.py|sys.stderr|local:print|keyword:file
tools/docs/check_changelog.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/docs/check_changelog.py|re.IGNORECASE|re.compile|arg:1
tools/docs/check_changelog.py|subprocess.PIPE|subprocess.run|keyword:stderr
tools/docs/check_changelog.py|subprocess.PIPE|subprocess.run|keyword:stdout
tools/docs/check_changelog.py|sys.stderr|local:print|keyword:file
tools/release/check_drop_authorization_signing_evidence.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/check_drop_authorization_signing_evidence.py|sys.argv|local:parse_args|arg:0
tools/release/check_drop_authorization_signing_evidence.py|sys.stderr|local:print|keyword:file
tools/protocol/check_governance_action_policy.py|sys.stderr|local:print|keyword:file
tools/protocol/check_governed_parameter_identifiers.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/protocol/check_governed_parameter_identifiers.py|re.IGNORECASE|re.match|keyword:flags
tools/protocol/check_governed_parameter_identifiers.py|re.IGNORECASE|re.compile|keyword:flags
tools/protocol/check_governed_parameter_inventory.py|tools.protocol.check_governed_parameter_identifiers.GGP_NAMES|local:tuple|arg:0
tools/protocol/check_governed_parameter_inventory.py|tools.protocol.check_governed_parameter_identifiers.GTP_NAMES|local:tuple|arg:0
tools/protocol/check_governed_parameter_inventory.py|jsonschema.Draft202012Validator|<none>|Compare.left
tools/protocol/check_governed_parameter_inventory.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/protocol/check_governed_parameter_inventory.py|re.MULTILINE|re.search|arg:2
tools/protocol/check_governed_parameter_inventory.py|stat|local:getattr|arg:0
tools/release/check_non_local_release_evidence.py|tools.release.check_public_beta_evidence.PRODUCTION_REQUIREMENTS|local:frozenset|arg:0
tools/release/check_non_local_release_evidence.py|tools.release.check_public_beta_evidence.PRODUCTION_REQUIREMENTS|local:set|arg:0
tools/release/check_non_local_release_evidence.py|tools.release.check_public_beta_evidence.PUBLIC_BETA_REQUIREMENTS|local:frozenset|arg:0
tools/release/check_non_local_release_evidence.py|tools.release.check_public_beta_evidence.PUBLIC_BETA_REQUIREMENTS|local:set|arg:0
tools/release/check_non_local_release_evidence.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/check_non_local_release_evidence.py|re.MULTILINE|re.compile|arg:1
tools/release/check_non_local_release_evidence.py|sys.argv|local:parse_args|arg:0
tools/release/check_non_local_release_evidence.py|sys.stderr|local:print|keyword:file
tools/release/check_public_beta_evidence.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/check_public_beta_evidence.py|sys.argv|local:parse_args|arg:0
tools/release/check_public_beta_evidence.py|sys.stderr|local:print|keyword:file
tools/protocol/check_record_family_authorization.py|jsonschema.Draft202012Validator|<none>|Compare.left
tools/protocol/check_record_family_authorization.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/protocol/check_record_family_authorization.py|stat|local:getattr|arg:0
tools/protocol/check_record_family_authorization.py|subprocess.PIPE|subprocess.run|keyword:stderr
tools/protocol/check_record_family_authorization.py|subprocess.PIPE|subprocess.run|keyword:stdout
tools/protocol/check_record_family_authorization.py|sys.stderr|local:print|keyword:file
tools/release/check_release_evidence_issue_links.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/check_release_evidence_issue_links.py|sys.stderr|local:print|keyword:file
tools/release/check_release_signatures.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/check_release_signatures.py|re.IGNORECASE|re.compile|arg:1
tools/release/check_release_signatures.py|sys.stderr|local:print|keyword:file
tools/security/check_risk_register.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/security/check_risk_register.py|re.IGNORECASE|re.compile|arg:1
tools/security/check_risk_register.py|sys.argv|local:main|arg:0
tools/security/check_risk_register.py|sys.stderr|local:print|keyword:file
tools/release/check_signer_custody_readiness.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/check_signer_custody_readiness.py|sys.argv|local:parse_args|arg:0
tools/release/check_signer_custody_readiness.py|sys.stderr|local:print|keyword:file
tools/security/check_slither_baseline.py|pathlib.Path|local:mode.add_argument|keyword:type
tools/security/check_slither_baseline.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/security/check_slither_baseline.py|sys.argv|local:parse_args|arg:0
tools/security/check_slither_baseline.py|sys.executable|<none>|List.elts
tools/security/check_slither_baseline.py|sys.stderr|local:print|keyword:file
tools/build/generate_bytecode_release_proof.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/build/generate_bytecode_release_proof.py|sys.argv|local:parse_args|arg:0
tools/build/generate_bytecode_release_proof.py|sys.stderr|local:print|keyword:file
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_SCHEMA|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_TEMPLATE|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.DEFAULT_GRANT_MAP_SCHEMA|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY_SCHEMA|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG_SCHEMA|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.EVIDENCE_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.EVIDENCE_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.GRANT_MAP_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.GRANT_MAP_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.INVENTORY_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.INVENTORY_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.JSON_SCHEMA_DRAFT|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.SOURCE_CATALOG_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.protocol.check_record_family_authorization.SOURCE_CATALOG_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.release.check_release_signatures.EVIDENCE_SCHEMA|local:require_schema|arg:1
tools/release/generate_release_candidate_lockfile.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_PATH|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_SCHEMA|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_SCHEMA_PATH|<none>|Assign.value
tools/release/generate_release_candidate_lockfile.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/generate_release_candidate_lockfile.py|sys.argv|local:parse_args|arg:0
tools/release/generate_release_candidate_lockfile.py|sys.stderr|local:print|keyword:file
tools/release/generate_release_checksums.py|ast.AST|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Assign|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.AsyncFunctionDef|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Attribute|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Call|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.ClassDef|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Constant|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Del|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.ExceptHandler|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.FunctionDef|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Global|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Import|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.ImportFrom|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.List|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Load|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.MatchAs|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.MatchMapping|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.MatchStar|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Name|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Nonlocal|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Starred|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Store|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.Tuple|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.arg|local:isinstance|arg:1
tools/release/generate_release_checksums.py|ast.stmt|local:isinstance|arg:1
tools/release/generate_release_checksums.py|tools.protocol.check_governed_parameter_inventory.DEFAULT_INVENTORY|<none>|Assign.value
tools/release/generate_release_checksums.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/generate_release_checksums.py|stat|local:getattr|arg:0
tools/release/generate_release_checksums.py|sys.argv|local:main|arg:0
tools/release/generate_release_checksums.py|sys.stderr|local:print|keyword:file
tools/release/generate_release_manifest.py|tools.release.check_non_local_release_evidence.EVIDENCE_SCHEMA|<none>|Compare.comparators
tools/release/generate_release_manifest.py|tools.release.check_public_beta_evidence.BLOCKING_STATUSES|local:sum|arg:0
tools/release/generate_release_manifest.py|tools.release.check_public_beta_evidence.PRODUCTION_PHASE|<none>|Dict.keys
tools/release/generate_release_manifest.py|tools.release.check_public_beta_evidence.PUBLIC_BETA_PHASE|<none>|Dict.keys
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_SCHEMA|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_TEMPLATE|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.DEFAULT_GRANT_MAP_SCHEMA|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY_SCHEMA|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG_SCHEMA|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.EVIDENCE_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.EVIDENCE_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.GRANT_MAP_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.GRANT_MAP_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.INVENTORY_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.INVENTORY_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.JSON_SCHEMA_DRAFT|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.SOURCE_CATALOG_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.protocol.check_record_family_authorization.SOURCE_CATALOG_SCHEMA_VERSION|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_PATH|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_SCHEMA|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_SCHEMA_ID|<none>|Assign.value
tools/release/generate_release_manifest.py|tools.release.generate_release_checksums.RELEASE_TOOL_CALL_POLICY_SCHEMA_PATH|<none>|Assign.value
tools/release/generate_release_manifest.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/generate_release_manifest.py|sys.argv|local:main|arg:0
tools/release/generate_release_manifest.py|sys.stderr|local:print|keyword:file
tools/release/generate_release_notes.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/release/generate_release_notes.py|re.IGNORECASE|re.compile|arg:1
tools/release/generate_release_notes.py|sys.argv|local:parse_args|arg:0
tools/release/generate_release_notes.py|sys.stderr|local:print|keyword:file
tools/security/generate_risk_register.py|tools.security.check_risk_register.DEFAULT_REGISTER|<none>|Assign.value
tools/security/generate_risk_register.py|tools.security.check_risk_register.RISK_REGISTER_SCHEMA|<none>|Dict.values
tools/security/generate_risk_register.py|tools.security.check_slither_baseline.DEFAULT_BASELINE|tools.security.check_slither_baseline.validate_baseline|arg:1
tools/security/generate_risk_register.py|tools.security.check_slither_baseline.DEFAULT_MARKDOWN|tools.security.check_slither_baseline.validate_baseline|arg:2
tools/security/generate_risk_register.py|tools.security.check_slither_baseline.IMPACTS|<none>|comprehension.iter
tools/security/generate_risk_register.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/security/generate_risk_register.py|sys.argv|local:main|arg:0
tools/security/generate_risk_register.py|sys.stderr|local:print|keyword:file
tools/shared/no_secret_scanner.py|re.IGNORECASE|re.compile|arg:1
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.ADMIN_REJECTION_FAMILY_GROUPS|<none>|Compare.comparators
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.ADMIN_REJECTION_FAMILY_GROUP_BLOCKERS|local:expected.extend|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.AUTHORIZATION_CLASS_HOME|expression:Subscript:eb818dd54cbe2594957bcb6fa36c5f79070833f16f47ca2c5c2b5f090179ea58.__setitem__|arg:1
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.COMMON_FAMILY_GROUP_BLOCKERS|local:list|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.COMPLETION_BLOCKER|local:self.assertEqual|arg:1
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_SCHEMA|<none>|BinOp.right
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_SCHEMA|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_TEMPLATE|<none>|BinOp.right
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_TEMPLATE|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_EVIDENCE_TEMPLATE|local:_read|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_GRANT_MAP_SCHEMA|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY|<none>|BinOp.right
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY|local:_read|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_INVENTORY_SCHEMA|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG|<none>|BinOp.right
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.HISTORICAL_SOURCE_CATALOG|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.HISTORICAL_SOURCE_CATALOG|<none>|BinOp.right
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.HISTORICAL_SOURCE_CATALOG|local:_read|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.HISTORICAL_SOURCE_CATALOG_SHA256|local:self.assertEqual|arg:1
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.SOURCE_IMPLEMENTATION_COMMIT|local:self.assertEqual|arg:1
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG|local:_read|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.DEFAULT_SOURCE_CATALOG_SCHEMA|<none>|Set.elts
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.EXPECTED_AUTHORIZATION_CLASSES|local:enumerate|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.EXPECTED_FAMILY_GROUPS|<none>|comprehension.iter
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.EXPECTED_FAMILY_GROUPS|local:enumerate|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.EXPECTED_FAMILY_GROUPS|local:self.subTest|keyword:family
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.EXPECTED_GRANT_MAP_PATHS|<none>|Subscript.value
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.EXPECTED_NORMATIVE_SOURCES|<none>|Subscript.value
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.FAMILY_GROUP_HOME|expression:Subscript:fdde61149fa73b405d912aa28abaf073c7ee2ccc25e8233c4f02b5b85115352d.__setitem__|arg:1
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.GRANT_MAP_SCHEMA_VERSION|<none>|Dict.values
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.GRANT_MAP_SCHEMA_VERSION|local:evidence.update|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.IMPLEMENTATION_COMPLETION_SUPPORTED|<none>|Assign.targets
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.IMPLEMENTATION_COMPLETION_SUPPORTED|<none>|Assign.value
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.INVENTORY_SCHEMA_VERSION|local:evidence.update|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.NORMATIVE_FRAGMENT_BINDINGS|<none>|For.iter
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.RecordFamilyAuthorizationError|local:self.assertRaisesRegex|arg:0
tools/protocol/test_record_family_authorization.py|tools.protocol.check_record_family_authorization.SNAPSHOT_FAMILY_GROUP_EXTRA_BLOCKERS|local:expected.extend|arg:0
tools/protocol/test_record_family_authorization.py|os.environ|<none>|Subscript.value
tools/protocol/test_record_family_authorization.py|os.name|<none>|Compare.left
tools/protocol/test_record_family_authorization.py|subprocess.DEVNULL|subprocess.run|keyword:stderr
tools/protocol/test_record_family_authorization.py|subprocess.DEVNULL|subprocess.run|keyword:stdout
tools/protocol/test_record_family_authorization.py|subprocess.PIPE|subprocess.run|keyword:stderr
tools/protocol/test_record_family_authorization.py|subprocess.PIPE|subprocess.run|keyword:stdout
tools/build/verify_release_artifacts.py|ast.AST|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Assign|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.AsyncFunctionDef|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Attribute|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Call|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.ClassDef|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Constant|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Del|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.ExceptHandler|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.FunctionDef|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Global|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Import|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.ImportFrom|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Load|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.MatchAs|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.MatchMapping|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.MatchStar|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Name|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Nonlocal|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Starred|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.Store|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.arg|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|ast.stmt|local:isinstance|arg:1
tools/build/verify_release_artifacts.py|pathlib.Path|local:parser.add_argument|keyword:type
tools/build/verify_release_artifacts.py|stat.FILE_ATTRIBUTE_REPARSE_POINT|local:bool|arg:0
tools/build/verify_release_artifacts.py|sys.argv|local:parse_args|arg:0
tools/build/verify_release_artifacts.py|sys.modules|<none>|Subscript.value
tools/build/verify_release_artifacts.py|sys.modules|local:set|arg:0
tools/build/verify_release_artifacts.py|sys.modules|local:list|arg:0
tools/build/verify_release_artifacts.py|sys.modules|<none>|comprehension.iter
tools/build/verify_release_artifacts.py|sys.path|<none>|Subscript.value
tools/build/verify_release_artifacts.py|sys.path|local:list|arg:0
tools/build/verify_release_artifacts.py|sys.stderr|local:print|keyword:file
""".strip().splitlines()
    if line
)
RELEASE_TOOL_CALL_POLICY_IMPORTED_SHADOW_ALLOWLIST = frozenset(
    tuple(line.split("|"))
    for line in """
tools/protocol/check_governed_parameter_inventory.py|Draft202012Validator|jsonschema.Draft202012Validator|Constant(value=None)
tools/protocol/check_governed_parameter_inventory.py|SchemaError|jsonschema.exceptions.SchemaError|Name(id='Exception', ctx=Load())
tools/protocol/check_record_family_authorization.py|Draft202012Validator|jsonschema.Draft202012Validator|Constant(value=None)
tools/protocol/check_record_family_authorization.py|FormatChecker|jsonschema.FormatChecker|Constant(value=None)
tools/protocol/check_record_family_authorization.py|SchemaError|jsonschema.exceptions.SchemaError|Name(id='Exception', ctx=Load())
""".strip().splitlines()
    if line
)
REVIEWED_RELEASE_TOOL_SUBPROCESS_SOURCES = {
    Path("tools/docs/check_changelog.py"): (
        "2908c8c7ce570b25528d3a41ea7526694b511d72cff16f8af505d7a892aa5df6",
        9_070,
    ),
    Path("tools/protocol/check_record_family_authorization.py"): (
        "e0fa94ebc982bab4b2cf2323fb87ebbdd2293edc316a90b87276fd32cc155688",
        129_908,
    ),
    Path("tools/security/check_slither_baseline.py"): (
        "4bd12e50ac34108097fd4e3741d3820bde7036bf013bcb0406c59ca9ea0f2189",
        49_634,
    ),
}
...
DEFAULT_COVERED_PATHS = [
    ...
    Path("tools/build/__init__.py"),
    Path("tools/deployment/__init__.py"),
    Path("tools/development/__init__.py"),
    Path("tools/docs/__init__.py"),
    Path("tools/protocol/__init__.py"),
    Path("tools/release/__init__.py"),
    Path("tools/security/__init__.py"),
    Path("tools/shared/__init__.py"),
    Path("tools/build/test_release_package_loading.py"),
    Path("tools/development/test_dev.py"),
    Path("tools/docs/doc_contract.py"),
    Path("scripts/dev.py"),
    Path("scripts/README.md"),
    Path("smart-contracts/source-layout-current.json"),
    ...
    Path("scripts/test_current_stack_transaction_journal.ps1"),
    Path("scripts/test_current_stack_launch_status.ps1"),
    Path("scripts/run-current-stack-scenarios.ps1"),
    Path("scripts/test_current_stack_scenarios.ps1"),
    Path("scripts/complete-current-stack-collection.ps1"),
    Path("scripts/test_current_stack_completion.ps1"),
    ...
    Path("packages/stream-client/tsconfig.json"),
    Path("packages/stream-client/tsconfig.test.json"),
    Path("packages/stream-client/src"),
    Path("packages/stream-client/examples"),
    Path("packages/stream-client/scripts"),
    Path("packages/stream-client/test"),
    Path("test/README.md"),
    Path("test/current"),
    Path("test/helpers/StreamCurrentStackFixture.sol"),
    Path("test/helpers/StreamCurrentStackHandler.sol"),
    Path("docs/README.md"),
    Path("docs/integrations/typescript-client.md"),
    Path("docs/integrations/product-demo.md"),
    ...
    Path("tools/build/check_solidity_source_layout.py"),
    Path("tools/build/test_solidity_source_layout.py"),
    Path("tools/build/check_solidity_layout_equivalence.py"),
    Path("tools/build/test_solidity_layout_equivalence.py"),
    ...
    Path("tools/development/test_windows_ci_wrapper.py"),
    Path("tools/build/build_release_artifacts.py"),
    Path("tools/build/test_release_build_artifacts.py"),
    Path("tools/deployment/materialize_canonical_deployment_plan.py"),
    Path("tools/deployment/test_materialize_canonical_deployment_plan.py"),
    Path("tools/deployment/check_canonical_deployment_candidate.py"),
    Path("tools/deployment/test_canonical_deployment_candidate.py"),
    Path("tools/release/generate_release_checksums.py"),
    Path("tools/release/test_release_checksums.py"),
    Path("tools/docs/check_changelog.py"),
    Path("tools/docs/test_changelog_check.py"),
    Path("tools/deployment/check_admin_ceremony_evidence.py"),
    Path("tools/deployment/test_admin_ceremony_evidence.py"),
    ...
    Path("tools/release/test_signer_custody_readiness.py"),
    Path("tools/shared/no_secret_scanner.py"),
    Path("tools/shared/test_no_secret_scanner.py"),
    Path("tools/build/generate_bytecode_release_proof.py"),
    Path("tools/build/test_bytecode_release_proof.py"),
    Path("tools/release/generate_release_manifest.py"),
    Path("tools/release/test_release_manifest.py"),
    Path("tools/release/test_release_notes.py"),
    Path("tools/release/generate_release_candidate_lockfile.py"),
    Path("tools/release/test_release_candidate_lockfile.py"),
    Path("tools/security/generate_risk_register.py"),
    Path("tools/security/check_risk_register.py"),
    Path("tools/security/test_risk_register.py"),
    Path("tools/protocol/check_record_family_authorization.py"),
    Path("tools/protocol/test_record_family_authorization.py"),
    Path("tools/protocol/check_artist_semantic_owner_matrix.py"),
    Path("tools/protocol/test_artist_semantic_owner_matrix.py"),
    ...
    Path("test/unit/core/StreamCorePermanentTarget.t.sol"),
    *RELEASE_TOOL_SEMANTIC_SOURCE_PATHS,
    Path("tools/release/check_release_evidence_issue_links.py"),
    Path("tools/release/test_release_evidence_issue_links.py"),
    Path("tools/release/check_public_beta_evidence.py"),
    Path("tools/release/test_public_beta_evidence.py"),
    ...
    Path("tools/protocol/generate_dependency_provenance_attestation.py"),
    Path("tools/release/check_release_mode.py"),
    Path("tools/release/test_release_mode.py"),
    Path("tools/build/check_contract_size_budget.py"),
    Path("tools/protocol/check_genesis_deployment_profile.py"),
    Path("tools/protocol/test_genesis_deployment_profile.py"),
    Path("ops/EXTERNAL_CALL_GAS_INVENTORY.json"),
    Path("tools/protocol/check_external_call_gas_inventory.py"),
    Path("tools/protocol/test_external_call_gas_inventory.py"),
    Path("tools/build/check_abi_compatibility.py"),
    Path("tools/build/test_abi_compatibility.py"),
    Path("tools/protocol/check_governed_parameter_identifiers.py"),
    Path("tools/protocol/test_governed_parameter_identifiers.py"),
    Path("tools/protocol/check_governed_parameter_inventory.py"),
    Path("tools/protocol/test_governed_parameter_inventory.py"),
    Path("tools/protocol/check_governance_action_policy.py"),
    Path("tools/protocol/test_governance_action_policy.py"),
    Path("tools/protocol/generate_system_manifest_payload_vector.py"),
    Path("tools/protocol/check_system_manifest_payload_vector.py"),
    Path("tools/protocol/test_system_manifest_payload_vector.py"),
    Path("tools/protocol/check_system_manifest_payload_vector_reference.py"),
    Path("tools/protocol/test_system_manifest_payload_vector_reference.py"),
    Path("tools/security/check_slither_baseline.py"),
    Path("tools/security/test_slither_baseline.py"),
    Path("tools/release/release_evidence_paths.py"),
    Path("tools/release/check_production_broadcast_retention.py"),
    Path("tools/release/check_production_verified_addresses.py"),
    Path("tools/release/check_public_beta_verified_addresses.py"),
    Path("tools/release/test_public_beta_verified_addresses.py"),
    Path("tools/release/check_production_release_signing_evidence.py"),
    Path("tools/release/test_production_release_signing_evidence.py"),
    Path("tools/release/check_fork_metadata_browser_evidence.py"),
    Path("tools/release/test_fork_metadata_browser_evidence.py"),
    Path("tools/release/check_live_metadata_browser_evidence.py"),
    Path("tools/release/check_incident_drill_evidence.py"),
    Path("tools/release/check_signer_compromise_drill_evidence.py"),
    Path("tools/release/test_signer_compromise_drill_evidence.py"),
    Path("tools/release/check_stuck_auction_drill_evidence.py"),
    Path("tools/release/test_stuck_auction_drill_evidence.py"),
    Path("tools/release/check_failed_randomness_drill_evidence.py"),
    Path("tools/release/test_failed_randomness_drill_evidence.py"),
    Path("tools/protocol/check_bad_metadata_dependency_drill_evidence.py"),
    Path("tools/protocol/test_bad_metadata_dependency_drill_evidence.py"),
    Path("tools/docs/check_readme.py"),
    Path("tools/docs/test_readme.py"),
    Path("tools/docs/check_first_30_minutes.py"),
    Path("tools/docs/test_first_30_minutes.py"),
    Path("docs/first-30-minutes.md"),
    Path("tools/docs/check_audit_finding_workflow.py"),
    Path("tools/docs/test_audit_finding_workflow.py"),
    ...
    Path("tools/docs/check_issue_templates.py"),
    Path("tools/docs/test_issue_templates.py"),
    Path("tools/docs/check_pr_template.py"),
    Path("tools/docs/test_pr_template.py"),
    Path("tools/docs/check_markdown_links.py"),
    Path("tools/docs/test_markdown_links.py"),
    Path("tools/docs/check_monitoring_spec.py"),
    Path("tools/docs/test_monitoring_spec.py"),
    Path("docs/monitoring.md"),
    Path("tools/docs/check_operator_dashboard_query_model.py"),
    Path("tools/docs/test_operator_dashboard_query_model.py"),
    Path("docs/operator-dashboard-query-model.md"),
    Path("tools/docs/check_curator_rewards_flow.py"),
    Path("tools/docs/test_curator_rewards_flow.py"),
    Path("tools/docs/check_withdrawals_credits_flow.py"),
    Path("tools/docs/test_withdrawals_credits_flow.py"),
    Path("tools/docs/check_react_next_reference.py"),
    Path("tools/docs/test_react_next_reference.py"),
    Path("tools/protocol/check_typescript_artifact_chain_config.py"),
    Path("tools/protocol/test_typescript_artifact_chain_config.py"),
    Path("tools/protocol/check_typescript_eip712_drop_authorization.py"),
    Path("tools/protocol/test_typescript_eip712_drop_authorization.py"),
    Path("tools/protocol/check_typescript_event_decoding_indexer.py"),
    Path("tools/protocol/test_typescript_event_decoding_indexer.py"),
    Path("tools/protocol/check_integration_conformance_fixtures.py"),
    Path("tools/protocol/test_integration_conformance_fixtures.py"),
    Path("docs/reference/legacy-stack/integrations/fixtures/integration-conformance-fixtures.json"),
    Path("tools/security/check_warning_dispositions.py"),
    Path("tools/security/test_warning_dispositions.py"),
    Path("tools/protocol/check_mint_manager_domain_constants.py"),
    Path("tools/protocol/test_mint_manager_domain_constants.py"),
    Path("tools/build/run_forge_size_log.py"),
    Path("tools/release/generate_release_notes.py"),
    Path("tools/build/verify_release_artifacts.py"),
    Path("tools/build/test_verify_release_artifacts.py"),
    ...
    Path("test/gas/StreamPostEntropyCompletionGas.t.sol"),
    ...
    Path("smart-contracts/interfaces/stream/governance/IStreamRoleRegistry.sol"),
    Path("smart-contracts/interfaces/stream/core/IStreamCore.sol"),
    Path("smart-contracts/interfaces/stream/parameters/IStreamGovernedParameterAuthority.sol"),
    Path("smart-contracts/interfaces/stream/finality/IStreamArtworkFinalityRegistry.sol"),
    Path("smart-contracts/domains/artist/StreamArtistArchiveV2.sol"),
    Path("smart-contracts/interfaces/stream/artist/IStreamArtistArchiveV2.sol"),
    Path("smart-contracts/domains/artist/StreamCollectionArtistRegistry.sol"),
    Path("smart-contracts/interfaces/stream/artist/IStreamCollectionArtistRegistry.sol"),
    Path("smart-contracts/domains/artist/StreamArtistRegistryV2.sol"),
    Path("smart-contracts/interfaces/stream/artist/IStreamArtistRegistryV2.sol"),
    ...
    Path("docs/reference/legacy-stack/integrations/curator-rewards.md"),
    Path("docs/reference/legacy-stack/integrations/electron-security-wallets.md"),
    Path("docs/integrations/events-and-indexing.md"),
    Path("docs/reference/legacy-stack/integrations/frontend-reference-architecture.md"),
    Path("docs/reference/legacy-stack/integrations/integration-conformance-fixtures.md"),
    Path("docs/reference/legacy-stack/integrations/interface-versioning.md"),
    Path("docs/integrations/marketplace-indexer-evidence.md"),
    Path("docs/integrations/metadata-rendering.md"),
    Path("docs/reference/legacy-stack/integrations/mobile-walletconnect.md"),
    Path("docs/reference/legacy-stack/integrations/operator-admin-ui.md"),
    Path("docs/integrations/wallets-and-signatures.md"),
    Path("docs/integrations/withdrawals-and-credits.md"),
    Path("docs/reference/legacy-stack/integrations/examples/react-viem.md"),
    Path("docs/reference/legacy-stack/integrations/examples/typescript-artifacts-and-chain-config.md"),
    Path("docs/reference/legacy-stack/integrations/examples/typescript-eip712-drop-authorization.md"),
    Path("docs/reference/legacy-stack/integrations/examples/typescript-event-decoding-and-indexer-ingestion.md"),
...
def _validated_release_tool_source(
    ...
    *,
    ...
    if (
        ...
        or relative_path.parts[0] not in {"scripts", "tools"}
...
def _repo_local_script_imports(
    ...
    def repo_script_candidates(
        ...
        *,
        ...
        if module_parts and module_parts[0] in {"scripts", "tools"}:
            parts = module_parts
        elif package_parts:
            parts = package_parts + module_parts
        else:
            # Flat scripts remain supported for explicit legacy test fixtures.
            parts = ("scripts",) + module_parts
        resolved_candidates: list[Path] = []
        for length in range(1, len(parts)):
            initializer = Path(*parts[:length], "__init__.py")
            if _validated_release_tool_source(repo_root, initializer, required=False) is not None:
                resolved_candidates.append(initializer)
        module_candidate = Path(*parts).with_suffix(".py")
        package_candidate = Path(*parts, "__init__.py")
        if _validated_release_tool_source(repo_root, package_candidate, required=False) is not None:
            resolved_candidates.append(package_candidate)
        elif _validated_release_tool_source(repo_root, module_candidate, required=False) is not None:
    ...
    if not current_parts or current_parts[0] not in {"scripts", "tools"}:
        raise ChecksumError(
            "release-tool checksum closure source must be below scripts/: "
            f"{relative_path.as_posix()}"
        )
    current_package = tuple(current_parts[:-1])
    for node in ast.walk(tree):
        if isinstance(node, ast.Import):
            for alias in node.names:
                if alias.name == "importlib":
    ...
    # `python -m` executes each parent initializer even if the leaf has no imports.
    for parent in relative_path.parents:
        if not parent.parts:
            continue
        initializer = parent / "__init__.py"
        if initializer != relative_path and _validated_release_tool_source(repo_root, initializer, required=False) is not None:
...
def _release_tool_call_policy_imports(
    ...
    *,
    ...
    reviewed_module_paths = {
        ".".join(path.with_suffix("").parts[:-1] if path.name == "__init__.py" else path.with_suffix("").parts): path
    ...
    if local_dependencies is not None:
        for parent in relative_path.parents:
            initializer = parent / "__init__.py"
            if initializer != relative_path and initializer in reviewed_module_paths.values():
                local_dependencies.add(initializer)
    ...
    def validate_module(
        ...
        *,
        ...
        if module in RELEASE_TOOL_CALL_POLICY_EXTERNAL_MODULES:
            ...
            return
        candidate = f"{module}.{member}" if member else module
        if candidate not in reviewed_module_names:
            candidate = module
        source = reviewed_module_paths.get(candidate)
        if source is not None and not (member and source.name == "__init__.py"):
            if local_dependencies is not None:
                local_dependencies.add(source)
                for parent in source.parents:
                    initializer = parent / "__init__.py"
                    if initializer in reviewed_module_paths.values():
                        local_dependencies.add(initializer)
            return
        raise ChecksumError(
...
def _release_tool_call_policy_row(
    ...
    *,
    ...
    if (
        role == "runtime"
        and relative_path != Path("tools/build/verify_release_artifacts.py")
    ):
        for node in ast.walk(tree):
            if (
                isinstance(node, ast.Attribute)
...
def build_release_tool_call_policy(
    ...
    *,
    ...
    """Build the bounded static call policy, including executed package initializers."""
    ...
    if len(runtime_paths) != 32 or len(focused_paths) != 10:
        raise ChecksumError(
            "release-tool call policy requires exactly 32 runtime and 10 "
...
def release_tool_call_policy_schema_document() -> dict[str, Any]:
    """Return the strict schema for the explicitly reviewed tool inventory."""
...
def _validate_release_tool_call_policy_schema_document(schema: dict[str, Any]) -> None:
    if schema != release_tool_call_policy_schema_document():
        raise ChecksumError(
...
def build_manifest(
    ...
    return {
        ...
        "generated_by": f"tools/release/generate_release_checksums.py:{GENERATOR_VERSION}",
        "algorithm": "sha256",
        "source": {
...
def check_outputs(
    ...
    *,
    ...
    if mismatches:
        ...
        print(
            "run `python -m tools.release.generate_release_checksums` and commit the regenerated files",
            file=sys.stderr,
        )
        return 1
