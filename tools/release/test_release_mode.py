...
from tools.protocol import test_genesis_deployment_profile as genesis_profile_test_support
from tools.security import generate_risk_register as risk_register_generator
...
class ReleaseModeTests(unittest.TestCase):
    ...
    def test_committed_slither_baseline_is_a_release_blocker(self) -> None:
        """A matching baseline with 30 Open rows remains blocked."""
        repo_root = Path(__file__).resolve().parents[2]
        ...
        self.assertIn("High=2, Medium=28", blockers[0])
