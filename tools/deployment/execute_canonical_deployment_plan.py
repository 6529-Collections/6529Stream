...
EXECUTOR_DRIVER_PATH = Path("tools/deployment/execute_canonical_deployment_plan.py")
    ...
    *,
    ...
    try:
        ...
        receipt = {
            ...
            "generated_by": (
                f"tools/deployment/execute_canonical_deployment_plan.py:{GENERATOR_VERSION}"
            ),
            "release_posture": {
