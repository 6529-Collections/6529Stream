...
def valid_evidence(root: Path) -> dict[str, object]:
    ...
    deployment_script = file_ref(root, "script/legacy/RehearseDeployment.s.sol")
    metadata_script = file_ref(root, "script/legacy/RehearseMetadataBrowser.s.sol")
    auction_script = file_ref(root, "script/legacy/RehearseAuctionCeremony.s.sol")
    emergency_script = file_ref(root, "script/legacy/RehearseEmergencyRedeployment.s.sol")
    ...
    return {
        ...
        "ceremony_results": {
            ...
            "metadata_browser": {
                "status": "passed",
                "command": "python -m tools.deployment.check_rehearsal_metadata_browser_sandbox",
