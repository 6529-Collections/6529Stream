...
def valid_evidence(root: Path) -> dict[str, object]:
    ...
    lifecycle_test = file_ref(root, "test/regression/legacy/entropy/StreamRandomizerLifecycle.t.sol")
    payment_test = file_ref(root, "test/unit/entropy/StreamRandomizerPayments.t.sol")
    emergency_test = file_ref(root, "test/unit/protocol/StreamEmergencyWithdraw.t.sol")
