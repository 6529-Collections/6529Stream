...
def build_address_book(
    ...
    return {
        ...
        "generated_by": f"tools/deployment/generate_address_books.py:{GENERATOR_VERSION}",
        "source": {
...
def check_address_books(
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        if mismatches:
            ...
            print(
                "run `python -m tools.deployment.generate_address_books` after deployment manifests are generated",
                file=sys.stderr,
            )
            return 1
