...
- Fork block hash: `TBD`
- Command: `forge script script/legacy/RehearseDeployment.s.sol:RehearseDeployment --sig "run()" --rpc-url <redacted> --via-ir`
...
- Command: `forge script script/legacy/RehearseDeployment.s.sol:RehearseDeployment --sig "run()" --via-ir`
