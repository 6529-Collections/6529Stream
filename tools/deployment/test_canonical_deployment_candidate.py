...
from tools.deployment import check_canonical_deployment_candidate as checker
from tools.deployment import execute_canonical_deployment_plan as executor
