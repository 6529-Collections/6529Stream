...
def reviewed_artifact() -> str:
    ...
    replacements = {
        ...
        "Command: `TBD`": 'Command: `forge script script/legacy/RehearseDeployment.s.sol:RehearseDeployment --sig "run()" --rpc-url REDACTED_LOCAL_ANVIL_FORK --broadcast --unlocked --via-ir`',
