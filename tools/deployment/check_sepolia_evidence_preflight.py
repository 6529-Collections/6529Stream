...
REQUIRED_PATHS = {
    ...
    "non_local_evidence_checker": Path("tools/release/check_non_local_release_evidence.py"),
    "public_beta_evidence_checker": Path("tools/release/check_public_beta_evidence.py"),
    "sepolia_preflight_checker": Path("tools/deployment/check_sepolia_evidence_preflight.py"),
    "sepolia_preflight_tests": Path("tools/deployment/test_sepolia_evidence_preflight.py"),
}
REQUIRED_ENV_NAMES = [
    "SEPOLIA_RPC_URL",
