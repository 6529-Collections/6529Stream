...
from tools.protocol import check_system_manifest_payload_vector as checker
from tools.protocol import generate_system_manifest_payload_vector as generator
