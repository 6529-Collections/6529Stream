...
EXPECTED_BINDING_PATHS = [
    ...
    ("semantic_owner_matrix_checker", "tools/protocol/check_artist_semantic_owner_matrix.py"),
    ("semantic_owner_matrix_tests", "tools/protocol/test_artist_semantic_owner_matrix.py"),
    ...
    ("owner_state_foundation_checker", "tools/protocol/check_artist_owner_state_mechanics_foundation.py"),
    ("owner_state_foundation_tests", "tools/protocol/test_artist_owner_state_mechanics_foundation.py"),
    ...
    ("shared_mechanics_checker", "tools/protocol/check_artist_operation_shared_mechanics_freeze.py"),
    ("shared_mechanics_tests", "tools/protocol/test_artist_operation_shared_mechanics_freeze.py"),
]
