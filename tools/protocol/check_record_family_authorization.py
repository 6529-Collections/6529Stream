...
# The immutable as-built inventory predates domain-grouped interfaces. Its labels
# remain historical; only explicit live-source lookups use these two aliases.
_HISTORICAL_INTERFACE_PREFIX: Final = "smart-contracts/interfaces/stream/"
HISTORICAL_INVENTORY_SOURCE_ALIASES: Final = {
    _HISTORICAL_INTERFACE_PREFIX + "IStreamCollectionMetadata.sol": "smart-contracts/interfaces/stream/metadata/IStreamCollectionMetadata.sol",
    _HISTORICAL_INTERFACE_PREFIX + "IStreamPreservationRecords.sol": "smart-contracts/interfaces/stream/preservation/IStreamPreservationRecords.sol",
}


def current_inventory_source_path(relative: str) -> str:
    """Translate only the exact two retired inventory interface labels."""
    return HISTORICAL_INVENTORY_SOURCE_ALIASES.get(relative, relative)
...
AS_BUILT_SOURCE_SHA256: Final = {
    ...
    _HISTORICAL_INTERFACE_PREFIX + "IStreamCollectionMetadata.sol": (
    ...
    _HISTORICAL_INTERFACE_PREFIX + "IStreamPreservationRecords.sol": (
...
SOURCE_IMPLEMENTATION_COMMIT: Final = '7b4ef22b052419e88d56cf7f207a7a7738dba7a7'
HISTORICAL_SOURCE_CATALOG: Final = Path('release-artifacts/baselines/record-family-authorization-source-catalog-f5c7164f.json')
HISTORICAL_SOURCE_CATALOG_SHA256: Final = 'ffafa7c4f543b6f0e3497709aa0462d408e81f254cdef25d630ffc847a66dc39'
EXPECTED_SOURCE_BINDINGS: Final = (
    ('smart-contracts/interfaces/stream/records/IStreamRecordFamilyAuthorityProvider.sol', 'eb381ae81e56bfa27495c5c20de82843a642995b50d5c07de102e4e20399cb2f'),
    ('smart-contracts/interfaces/stream/records/IStreamRecordFamilyRegistry.sol', 'c3581e64296603cbc4548c8eb250f03a6e1b671c6a53807f735f79fb390a2dbc'),
    ('smart-contracts/domains/records/StreamRecordFamilyRegistry.sol', 'f7dcd1693b704faf217316398db8f45abc27ee6263a8bb3aeee81aa528166cda'),
    ('smart-contracts/interfaces/stream/metadata/IStreamCollectionMetadata.sol', '94089b62e7b655bfb962a8f3e13be18778556304bb8153e98fca64429b4aab4f'),
    ('smart-contracts/domains/metadata/StreamCollectionMetadata.sol', '7255adc0d8899ac6611e9df9f17dcac749edc032938af1873e914b33a5a5d89c'),
    ('smart-contracts/interfaces/stream/preservation/IStreamPreservationRecords.sol', '699e2dd62061702633d00a5e70afde86b00da36b76f5259aad384ebe82b92ef6'),
    ('smart-contracts/domains/preservation/StreamPreservationRecords.sol', 'dc1c96e433db6c6a943bd8533615d1c1d2e186f2677ce564a18c59211577a648'),
    ('script/legacy/RehearseDeployment.s.sol', '57a9ac3bea6cdd2c61026f666b428cad15130e294c8538951b86fc7fe7ea20a7'),
)
...
EXPECTED_CONTRACTS: Final = (
    {
        ...
        "interface_path": _HISTORICAL_INTERFACE_PREFIX + "IStreamCollectionMetadata.sol",
    ...
    },
    {
        ...
        "interface_path": _HISTORICAL_INTERFACE_PREFIX + "IStreamPreservationRecords.sol",
...
EXPECTED_FAIL_OPEN: Final = (
    ...
    ("authorization_class_event_absent", _HISTORICAL_INTERFACE_PREFIX + "IStreamCollectionMetadata.sol", "CollectionMetadataRecordSet"),
...
def _validate_source_catalog_semantics(
    ...
    historical_catalog = resolve_repo_file(repo_root, HISTORICAL_SOURCE_CATALOG.as_posix(), "historical source catalog")
    _expect(_sha256(historical_catalog) == HISTORICAL_SOURCE_CATALOG_SHA256, "historical source catalog byte identity changed")
    ...
    _expect(
        ...
        == {
            ...
            "interface_path": "smart-contracts/interfaces/stream/records/IStreamRecordFamilyRegistry.sol",
...
def _validate_inventory_semantics(inventory: dict[str, Any], repo_root: Path) -> None:
    ...
    for index, (row, expected) in enumerate(zip(surfaces, EXPECTED_SURFACES, strict=True)):
        ...
        source = resolve_repo_file(repo_root, current_inventory_source_path(row["source_path"]), f"mutation_surfaces[{index}].source_path")
        interface = resolve_repo_file(repo_root, current_inventory_source_path(row["interface_path"]), f"mutation_surfaces[{index}].interface_path")
    ...
    for index, (row, expected) in enumerate(zip(failures, EXPECTED_FAIL_OPEN, strict=True)):
        ...
        path = resolve_repo_file(repo_root, current_inventory_source_path(row["source_path"]), f"known_fail_open_behaviors[{index}].source_path")
