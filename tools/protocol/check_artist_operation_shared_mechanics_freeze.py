...
COORDINATOR_INTERFACE_PATH = Path(
    "smart-contracts/interfaces/stream/artist/IStreamArtistOperationCoordinator.sol"
)
...
# The supported collection registry is separate from this blocked modular proposal.
