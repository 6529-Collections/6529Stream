...
REQUIRED_PHRASES = [
    ...
    "unknown emitter",
    "unknown `topic0`",
    "tools/build/generate_release_artifacts.py:1",
    "validation layer",
    "ABI/topic drift",
    "malformed logs",
...
REQUIRED_CODE_TOKENS = [
    ...
    "EXPECTED_EVENT_TOPIC_CATALOG_GENERATOR",
...
REQUIRED_LINK_TARGETS = [
    ...
    "docs/reference/legacy-stack/integrations/integration-conformance-fixtures.md",
    ...
    "test/regression/legacy/protocol/StreamEventReconstructability.t.sol",
