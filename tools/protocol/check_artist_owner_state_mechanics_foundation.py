...
EXPECTED_AUTHORITY_BINDINGS = (
    (
        ...
        "f2a894262aeeb35abf6d6bce591b7474cfbc17655591386223be6e7c706fea3b",
    ),
    (
        "coordinator_source_gate",
        "docs/architecture/artist-operation-coordinator-source-acceptance-gate.md",
        "ac74b8b2c3f4fff9ff51b4bc66ed4eba20befecbdf08a05412760288209ca20f",
    ),
    (
        "semantic_owner_matrix",
        "docs/architecture/artist-semantic-owner-matrix-v2.json",
        "f76fc366a0a62e8c79ea064f2a1efc2f932ce6f3be86b8917ee7828dcb8ddf90",
    ),
    (
    ...
    (
        ...
        "1ef144c2a3fd2e09d3e75c45f3784ef051ec81f7c28bc92876237165fb6d9ad6",
    ),
    (
        "semantic_owner_matrix_tests",
        "tools/protocol/test_artist_semantic_owner_matrix.py",
        "e9c5cd604fc76f1d982a97df5c2a12a139cf714241ace5f0b39c1c2c9c3c8218",
    ),
    (
        "shared_mechanics_packet",
        "docs/architecture/artist-operation-shared-mechanics-freeze-v1.json",
        "1e8da06698d400ec4e526507551fc163513721d57ca3233c83a92c70130e41da",
    ),
    (
        "shared_mechanics_schema",
        "docs/architecture/artist-operation-shared-mechanics-freeze-v1.schema.json",
        "d61b29f63c662494047fc1b30bf72035ab7d586a23fe45c2bb6f2d8a0ae795b0",
    ),
    (
        "shared_mechanics_checker",
        "tools/protocol/check_artist_operation_shared_mechanics_freeze.py",
        "a2e0100707ac93b5373969032b1fd34273f31c67a5f6aea02b5ca99a776d19eb",
    ),
    (
        "shared_mechanics_tests",
        "tools/protocol/test_artist_operation_shared_mechanics_freeze.py",
        "b85c5fe3901869554eca5935f359b06c17f33a728fc49d6bac908fbfaaf3e5e7",
    ),
    (
        "archive_v2_implementation",
        "smart-contracts/domains/artist/StreamArtistArchiveV2.sol",
        "52cb15cd2f26c263b8a02b7c089f693f2148073c85b036a96b0de30a94ff8ffb",
    ),
    (
        "archive_v2_interface",
        "smart-contracts/interfaces/stream/artist/IStreamArtistArchiveV2.sol",
        "a85028dcf76714692c4904380b44fc757e19a22bf1c9e4d6bacd5068c2786133",
    ),
    (
        "registry_v2_implementation",
        "smart-contracts/domains/artist/StreamArtistRegistryV2.sol",
        "3df9ce6121e6aa19a9a2bc7775d5067233d477450fcacadd23cc982a0bb84758",
    ),
    (
        "registry_v2_interface",
        "smart-contracts/interfaces/stream/artist/IStreamArtistRegistryV2.sol",
        "5b3508e9100ebfefadfa4b5bccaf241f4d6ecd74133b9b5638add1f5620dd56f",
    ),
)
