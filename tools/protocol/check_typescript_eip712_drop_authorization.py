...
DEFAULT_DOC = Path("docs/reference/legacy-stack/integrations/examples/typescript-eip712-drop-authorization.md")
...
REQUIRED_LINK_TARGETS = [
    ...
    "tools/protocol/generate_drop_authorization_payload.py",
    "tools/protocol/check_drop_authorization_fixtures.py",
    ...
    "test/regression/legacy/protocol/StreamSafeERC1271ForkSmoke.t.sol",
]
