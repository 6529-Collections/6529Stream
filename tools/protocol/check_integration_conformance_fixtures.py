...
DEFAULT_FIXTURE = Path("docs/reference/legacy-stack/integrations/fixtures/integration-conformance-fixtures.json")
DEFAULT_DOC = Path("docs/reference/legacy-stack/integrations/integration-conformance-fixtures.md")
...
REQUIRED_DOC_LINK_TARGETS = [
    "docs/reference/legacy-stack/integrations/fixtures/integration-conformance-fixtures.json",
    ...
    "docs/reference/legacy-stack/integrations/examples/typescript-artifacts-and-chain-config.md",
    "docs/reference/legacy-stack/integrations/examples/typescript-eip712-drop-authorization.md",
    "docs/reference/legacy-stack/integrations/examples/typescript-event-decoding-and-indexer-ingestion.md",
