#!/usr/bin/env python3
"""Negative and current-source checks for metadata rendering documentation."""
...
from tools.docs import check_metadata_rendering as checker
...
class CurrentDocumentationTests(unittest.TestCase):
    def validate_changed(self, transform):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            checker.validate_metadata_rendering(root, path)

    def test_committed_document(self):
        checker.validate_metadata_rendering(ROOT, ROOT / checker.DEFAULT_DOC)
