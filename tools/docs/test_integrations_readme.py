#!/usr/bin/env python3
"""Negative and current-source checks for integrations readme documentation."""
...
from tools.docs import check_integrations_readme as checker
...
class CurrentDocumentationTests(unittest.TestCase):
    def validate_changed(self, transform):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            checker.validate_integrations_readme(root, path)

    def test_committed_document(self):
        checker.validate_integrations_readme(ROOT, ROOT / checker.DEFAULT_DOC)
