#!/usr/bin/env python3
"""Negative and current-source checks for first 30 minutes documentation."""
...
from tools.docs import check_first_30_minutes as checker
...
class CurrentDocumentationTests(unittest.TestCase):
    def validate_changed(self, transform):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            checker.validate_guide(root, path)

    def test_committed_document(self):
        checker.validate_guide(ROOT, ROOT / checker.DEFAULT_DOC)
