...
DEFAULT_OPERATOR_ADMIN_UI = Path("docs/reference/legacy-stack/integrations/operator-admin-ui.md")
...
REQUIRED_LINK_TARGETS = [
    ...
    "smart-contracts/integrations/randomizers/legacy/StreamRandomizerLifecycle.sol",
    "test/unit/access/StreamAdmins.t.sol",
    "test/regression/legacy/access/StreamAdminSelectors.t.sol",
    "test/regression/legacy/core/StreamCoreAdminCharacterization.t.sol",
