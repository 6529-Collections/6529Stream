#!/usr/bin/env python3
"""Negative and current-source checks for withdrawals credits flow documentation."""
...
from tools.docs import check_withdrawals_credits_flow as checker
...
class CurrentDocumentationTests(unittest.TestCase):
    def validate_changed(self, transform):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            checker.validate_withdrawals_credits_flow(root, path)
