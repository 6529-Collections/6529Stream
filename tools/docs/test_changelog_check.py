    ...
    def test_valid_unreleased_entry_passes(self) -> None:
        errors, impacted = checker.validate_changelog_state(
            [
                ...
                "tools/build/check_solidity_formatting.py",
                "tools/security/check_warning_dispositions.py",
                "tools/build/test_solidity_formatting.py",
        ...
        self.assertEqual(
            ...
            [
                ...
                ("tools/build/check_solidity_formatting.py", "release-tooling"),
                ("tools/build/test_solidity_formatting.py", "release-tooling"),
                ("tools/docs/check_changelog.py", "release-tooling"),
                ("tools/security/check_warning_dispositions.py", "release-tooling"),
                ("tools/security/test_warning_dispositions.py", "release-tooling"),
            ],
        )
