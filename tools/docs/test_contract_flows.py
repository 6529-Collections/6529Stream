#!/usr/bin/env python3
"""Negative and current-source checks for contract flows documentation."""
...
from tools.docs import check_contract_flows as checker
...
class CurrentDocumentationTests(unittest.TestCase):
    def validate_changed(self, transform):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            checker.validate_contract_flows(root, path)

    def test_committed_document(self):
        checker.validate_contract_flows(ROOT, ROOT / checker.DEFAULT_DOC)
