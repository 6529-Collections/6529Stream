#!/usr/bin/env python3
"""Negative and current-source checks for events and indexing documentation."""
...
from tools.docs import check_events_and_indexing as checker
...
class CurrentDocumentationTests(unittest.TestCase):
    def validate_changed(self, transform):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            checker.validate_events_and_indexing(root, path)

    def test_committed_document(self):
        checker.validate_events_and_indexing(ROOT, ROOT / checker.DEFAULT_DOC)
