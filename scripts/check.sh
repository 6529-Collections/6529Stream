...
"$python_bin" scripts/test_post_entropy_completion_gas.py
"$python_bin" scripts/generate_post_entropy_completion_gas.py --check
"$python_bin" scripts/check_post_entropy_completion_gas.py
...
"$python_bin" scripts/check_system_manifest_payload_vector_reference.py
"$python_bin" scripts/test_slither_baseline.py
...
"$python_bin" scripts/check_solidity_layout_equivalence.py --check-source
...
"$python_bin" scripts/test_sepolia_evidence_preflight.py
"$python_bin" scripts/check_sepolia_evidence_preflight.py
...
"$python_bin" scripts/test_live_deployment_manifest_evidence.py
"$python_bin" scripts/check_live_deployment_manifest_evidence.py
"$python_bin" scripts/test_production_verified_addresses.py
"$python_bin" scripts/check_production_verified_addresses.py
"$python_bin" scripts/test_production_release_signing_evidence.py
"$python_bin" scripts/check_production_release_signing_evidence.py
"$python_bin" scripts/test_generate_fork_metadata_browser_evidence_draft.py
"$python_bin" scripts/test_fork_metadata_browser_evidence.py
"$python_bin" scripts/check_fork_metadata_browser_evidence.py
"$python_bin" scripts/test_fork_ceremony_evidence.py
"$python_bin" scripts/check_fork_ceremony_evidence.py
"$python_bin" scripts/test_fork_randomizer_operations_evidence.py
"$python_bin" scripts/check_fork_randomizer_operations_evidence.py
...
"$python_bin" scripts/test_stuck_auction_drill_evidence.py
...
"$python_bin" scripts/check_audit_finding_workflow.py
...
"$python_bin" scripts/test_first_30_minutes.py
...
"$python_bin" scripts/test_autonomous_state.py
"$python_bin" scripts/check_autonomous_state.py
"$python_bin" scripts/test_markdown_links.py
...
"$python_bin" scripts/test_curator_rewards_flow.py
"$python_bin" scripts/check_curator_rewards_flow.py
"$python_bin" scripts/test_withdrawals_credits_flow.py
"$python_bin" scripts/check_withdrawals_credits_flow.py
...
"$python_bin" scripts/test_integration_conformance_fixtures.py
"$python_bin" scripts/check_integration_conformance_fixtures.py
...
"$python_bin" scripts/test_operator_dashboard_query_model.py
"$python_bin" scripts/check_operator_dashboard_query_model.py
...
"$python_bin" scripts/test_deployment_rehearsal_gate.py
"$python_bin" scripts/check_deployment_rehearsal_gate.py
