...
REQUIRED_PHRASES = [
    ...
    "INT-011",
    "curator rewards frontend flow spec",
    "curator reward claims",
    "Merkle proof",
    "delegated claim",
    "pull-payment credit",
    "INT-012",
    "withdrawal and credit UX flow spec",
    "withdrawal and credit reconstruction",
    "fixed-price",
    "auction",
    "curator",
    "surplus",
    ...
    "no-secret public environment snippets",
    "INT-014",
