...
REQUIRED_READINESS_PHRASES = [
    ...
    "check_incident_drill_evidence.py",
...
REQUIRED_LINK_TARGETS = [
    ...
    "scripts/test_production_release_signing_evidence.py",
    "scripts/check_production_release_signing_evidence.py",
    "release-artifacts/evidence/public-beta-verified-addresses/public-beta-verified-addresses-retained-artifact-template.md",
    "scripts/test_public_beta_verified_addresses.py",
    "scripts/check_public_beta_verified_addresses.py",
    "scripts/test_sepolia_evidence_preflight.py",
    "scripts/check_sepolia_evidence_preflight.py",
