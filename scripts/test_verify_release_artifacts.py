...
class ReleaseArtifactVerifierTests(unittest.TestCase):
    ...
    def test_committed_release_bundle_verifies(self) -> None:
        ...
        self.assertEqual(summary.checksum_entries, 445)
        self.assertEqual(summary.checksum_manifest_records, 445)
    ...
    def test_main_json_output(self) -> None:
        ...
        self.assertEqual(data["checksum_entries"], 445)
        self.assertEqual(data["checksum_manifest_records"], 445)
