...
| Integrator, frontend, mobile, Electron, or indexer engineer | [docs/integrations/README.md](docs/integrations/README.md), [docs/integrations/contract-flows.md](docs/integrations/contract-flows.md), [docs/integrations/auction-flows.md](docs/integrations/auction-flows.md), [docs/integrations/wallets-and-signatures.md](docs/integrations/wallets-and-signatures.md), [docs/integrations/events-and-indexing.md](docs/integrations/events-and-indexing.md), [docs/integrations/metadata-rendering.md](docs/integrations/metadata-rendering.md), [docs/integrations/frontend-reference-architecture.md](docs/integrations/frontend-reference-architecture.md), [docs/integrations/mobile-walletconnect.md](docs/integrations/mobile-walletconnect.md), [docs/integrations/electron-security-wallets.md](docs/integrations/electron-security-wallets.md), [docs/integrations/operator-admin-ui.md](docs/integrations/operator-admin-ui.md), [docs/monitoring.md](docs/monitoring.md) | ABIs, address books, deployment manifests, EIP-712 and ERC-1271 rules, event reconstruction, monitoring, metadata rendering, and app security boundaries |
