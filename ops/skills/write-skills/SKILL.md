...
2. Choose name and location
   ...
   Use lowercase letters, digits, and hyphens only. Keep the folder name identical to the skill name. In this repo, place operational skills under `ops/skills/<skill-name>/SKILL.md` unless the user asks for an auto-discovered Codex skill location.
