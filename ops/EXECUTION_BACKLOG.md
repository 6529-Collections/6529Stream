...
| `EXT-021` | Harden live randomizer operations retained artifact validation | F/G | In progress on issue #544 / PR #545 and branch `codex/live-randomizer-operations-evidence-hardening`; add stronger retained-path, non-symlinked UTF-8 file, missing-file, no-secret, and declared `sha256:` drift validation for future reviewed live randomizer operations evidence without closing tracker issue #229 |
