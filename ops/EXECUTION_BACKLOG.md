...
| `EXT-020` | Harden live ceremony retained artifact validation | F/G | In progress on issue #542 and branch `codex/live-ceremony-evidence-hardening`; add stronger retained-path, missing-file, no-secret, and declared `sha256:` drift validation for future reviewed live ceremony evidence without closing tracker issue #228 |
