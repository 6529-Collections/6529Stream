...
| --- | --- | --- | --- |
| `SHIP-001` | Working current-stack RC and Sepolia demonstration | Tested transactions and concrete deployment | Active issue #738, branch `codex/developer-experience-reorganization`; prior PR #739 merged |
