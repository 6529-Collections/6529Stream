...
| `EXT-023` | Add production release-signing retained artifact validation | F/G | PR #549 open for issue #548 on branch `codex/production-release-signing-evidence-validation`; adds a dedicated retained-artifact template/checker for future reviewed production checksum-signature and signed-Git-tag evidence without closing tracker issues #223 or #224 |
