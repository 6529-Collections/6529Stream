...
| `GOV-007` | Add failed randomness drill retained evidence | F | In progress on issue #514 and branch `codex/failed-randomness-drill-evidence`; depends on merged `GOV-004` and follows merged `GOV-006` |
