...
| `EXT-034` | Retain live issue audit after deployment manifest validation | F/G | Active issue #575 on branch `codex/live-deployment-manifest-issue-audit`; sync issue #227 to the generated body, prove it remains open, and retain an exact-linked live issue audit report after PR #574 without changing readiness claims |
