...
| ART-04 | Rotation contests, guardians, recovery, estate and dormancy complete their real lifecycle and replay rules | Artist; ART-01/02 | Building: rotation, identity filing and succession source integrated; dismissal/cohort closure `3489d360` has 202 independently accepted domain cases. Actual dismissal12 is running; current succession/cohort acceptance, recovery, estate and dormancy remain. Artist builder is implementing estate activation and archival prerequisites |
...
| SALE-02 | Dutch schedule, clearing rebates and maximum-price excess credits conserve funds | Revenue; PAY-04 | Building: standard native Dutch `b3152198` has 33 reviewed domain cases and two 256-input fuzz properties; its four actual-current Safe cases are running. Revenue builder is implementing the financial-only supplemental settlement prerequisite and separate clearing/rebate lifecycle |
