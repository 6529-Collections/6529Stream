...
| SALE-02 | Dutch schedule, clearing rebates and maximum-price excess credits conserve funds | Revenue; PAY-04 | Building: standard native Dutch and supplemental settlement have independently reviewed current composition. Clearing consumer `d807421e` has 59 reviewed domain cases, five fuzz properties and both compiler profiles; current clearing2 runs. First purchase measures 6,843,542 gas before full cold composition versus the 500,000 ceiling, so gas optimization remains a deployment blocker |
