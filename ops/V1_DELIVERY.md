...
| ART-04 | Rotation contests, guardians, recovery, estate and dormancy complete their real lifecycle and replay rules | Artist; ART-01/02 | Building: rotation `c71003dc` and identity-compromise filing `677b9ae9` integrated; four actual Safe/Executor dispute cases and seven entropy regressions independently accepted in `b002c4d4`; succession36/37 source integrated `8227e0b6` with 185 reviewed domain tests and eight CREATE proofs. Dismissal implementation, actual succession composition, recovery, activation and dormancy remain |
...
| SALE-01 | Fixed/open-edition sale variants, zero/PWYW pricing and refund-window custody obey drift, cancellation, reveal and pause rules | Revenue; PAY-04 and artist consent | Building: signed free/open/PWYW programs have actual current/Safe evidence in `72c208f2`; artist op16 and native/universal enforcement integrated as `f8564761` / `dac3ef4a`, with unsupported legacy consumers rejecting REQUIRED under `99b53aab`; capability correction integrated `592635fc` with ten focused tests; the prior fourteen current cases pass and the three corrected REQUIRED cases now pass separately on the same production snapshot, with independent artifact review accepted; refund source integrated `ea107e58` with 63 reviewed domain tests and two fuzz properties, actual current composition running |
| SALE-02 | Dutch schedule, clearing rebates and maximum-price excess credits conserve funds | Revenue; PAY-04 | Building: schedule arithmetic passes independent review in both compiler profiles; the consumer, settlement and Safe tests are underway. Clearing rebates and actual current-stack acceptance remain |
