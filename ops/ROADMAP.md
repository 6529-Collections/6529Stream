...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  production-release blocker reports, per-requirement public-beta evidence
  templates, and per-requirement production-release evidence templates,
