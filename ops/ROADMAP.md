...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-13 23:30 UTC` for Queue Item 133 / PR #278 live audit Markdown parity checker; PR #278 local validation covered focused live audit JSON/Markdown tests/checks, release-readiness, release manifest, release checksums, changelog, Python bytecode compilation, Bash syntax, traceability, heading, whitespace, and full Windows check-script gates |
| OS tested | Windows local validation for Queue Item 133 / PR #278; Linux GitHub Actions passed for latest merged baseline PR #278 run `27482144262` on final head `9a9ccfa74c6e7ad9021e4b50e86317804a540fbd`, with merged baseline commit `07d9218dc916c2f7ad9eaf44998d611987648854` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #278 final CI run `27482144262` passed on head `9a9ccfa74c6e7ad9021e4b50e86317804a540fbd`; CodeRabbit status was success with no unresolved review threads, explicit review requests returned review-finished replies, CodeRabbit acknowledged the documented merge evidence, and PR #278 squash-merged as `07d9218dc916c2f7ad9eaf44998d611987648854` |
