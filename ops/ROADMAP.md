...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-13 21:55 UTC` for Queue Item 130 / PR #272 release evidence live audit report bundle merge-state reconciliation; PR #272 local validation covered release-readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace gates |
| OS tested | Windows local validation for Queue Item 130 / PR #272; Linux GitHub Actions passed for latest merged baseline PR #272 run `27480079767` on final head `a9dfef7d7a33cb26fd03bb36b3bde1df14f61a69`, with merged baseline commit `f014477b5d1f60e3ad2e30e6db0bbab1c28fb71c` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #272 final CI run `27480079767` passed on head `a9dfef7d7a33cb26fd03bb36b3bde1df14f61a69`; CodeRabbit status was success with no unresolved review threads, and PR #272 squash-merged as `f014477b5d1f60e3ad2e30e6db0bbab1c28fb71c` |
...
| Release evidence live audit report schema/checker | Retained live audit JSON reports have a committed no-secret schema, template, snapshot fixture set, and offline checker so operators can validate reports without GitHub network access or readiness-claim changes | `scripts/test_release_evidence_live_audit_report.py`, `scripts/check_release_evidence_live_audit_report.py` | In Progress for issue #273 / Queue Item 131: the local draft adds schema version, repo target, blocked readiness claim, exact no-secret wording, label/body/closure profile coverage, snapshot path and SHA-256 digest validation, command provenance, checker status, validation count, and secret-shaped key/value regressions; CI/local gate wiring, release-readiness links, release manifest coverage, and checksum coverage are part of the PR scope | [`#273`](https://github.com/6529-Collections/6529Stream/issues/273) | Gate G | TBD |
