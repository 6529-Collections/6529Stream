...
- Known remaining P0 blockers include broader payment accounting and
  ...
  headroom remains a tracked release risk: the P1-SIZE-001 recovery pass brings
  the IR-optimized runtime to 24,135 bytes with 441 bytes of EIP-170 headroom,
...
- Continue [`P1-META-006`](https://github.com/6529-Collections/6529Stream/issues/51):
  ...
  dependency registry script/provenance writes. `StreamCore` production UTF-8
  enforcement is split into
  [`#125`](https://github.com/6529-Collections/6529Stream/issues/125) because
  direct Core wiring exceeded the EIP-170 production size gate.
...
- Complete the remaining render-safety work for full browser execution
  sandboxing and `StreamCore` production invalid UTF-8 enforcement.
