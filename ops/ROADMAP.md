...
- Known remaining production-readiness blockers include broader invariant/gas
  ...
  ceremonies, live/fork metadata browser execution coverage, and external audit
  packaging.
