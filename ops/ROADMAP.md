...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  runbook, and runs the local deployment and auction ceremony rehearsals. It
