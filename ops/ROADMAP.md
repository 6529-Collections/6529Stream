...
- Known remaining production-readiness blockers include fork-level invariant
  ...
  and non-local evidence envelope are retained for issue #216; testnet
  rehearsals, production broadcast retention, live artifact verification, and
...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 16:31 UTC` for active branch `codex/accept-fork-rehearsal-evidence`: reviewed fork rehearsal evidence, public-beta evidence, blocker report, packet index, issue backlog, issue links, body sync, label/body/closure checks, release-readiness, release manifest, checksum bundle, and changelog checks passed; full Windows `$env:Path="$HOME\.foundry\bin;$env:Path"; powershell -NoProfile -ExecutionPolicy Bypass -File scripts\check.ps1` passed locally with existing compiler/test warning noise only; latest merged baseline is PR #349 with CI run `27504228132`, passed on final head `489c38640a82c2d6c874340107d977b4c9b9a835` before squash merge `6e968d2702837b4f1eaa5e002e5d30748deba228` |
| OS tested | Windows local validation for active reviewed fork rehearsal evidence acceptance; Windows and Linux GitHub Actions passed for latest merged baseline PR #349 CI run `27504228132` on head `489c38640a82c2d6c874340107d977b4c9b9a835`, with merged baseline commit `6e968d2702837b4f1eaa5e002e5d30748deba228` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #349 CI run `27504228132` passed on head `489c38640a82c2d6c874340107d977b4c9b9a835`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4702280727`; merge-decision comment `4702301404`; PR #349 squash-merged as `6e968d2702837b4f1eaa5e002e5d30748deba228` |
