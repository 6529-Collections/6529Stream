...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 07:23 UTC` for current issue #314 first-party interface formatting-deferral retirement; local validation includes focused formatting checks, artifact drift checks, ABI compatibility, and the full Windows `scripts\check.ps1` gate |
