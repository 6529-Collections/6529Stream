...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 06:50 UTC` for latest merged baseline PR #312 scoped Solidity formatting gate; PR #312 local validation covered the scoped formatting checker/tests, changelog gate, release manifest/checksum checks, script syntax checks, and whitespace checks |
| OS tested | Windows local validation for Queue Item 150 / PR #312; Linux GitHub Actions passed for latest merged baseline PR #312 run `27490962706` on final head `42e31f8a7a8535ef7404ea31169bbef794be4756`, with merged baseline commit `7f08087f25014151373ef67cbd6fc6e243ed36bd` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #312 final CI run `27490962706` passed on head `42e31f8a7a8535ef7404ea31169bbef794be4756`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700938271`, review-finished reply `4700938454`, merge-decision comment `4700968034`, and PR #312 squash-merged as `7f08087f25014151373ef67cbd6fc6e243ed36bd` |
...
| Formatting | Scoped formatting baseline passes in PR #312 / issue #311: 24 formatting-required files pass `forge fmt --check`, and the raw all-files diagnostic is allowed to fail only for 27 documented deferred legacy/provenance-sensitive files | `python scripts/test_solidity_formatting.py`, `python scripts/check_solidity_formatting.py`, `make fmt-check`; raw diagnostic: `forge fmt --check smart-contracts` | Scoped gate passes in CI; deferred files retired through focused formatting/provenance PRs, starting with first-party interface issue #314 |
...
| Solidity formatting scoped gate | Formatting-required Solidity files stay formatted and the deferred raw all-files formatting baseline cannot grow silently | `scripts/test_solidity_formatting.py`, `scripts/check_solidity_formatting.py`, `make fmt-check`; raw diagnostic `forge fmt --check smart-contracts` | Passing in PR #312 / issue #311: parser tests cover Windows/POSIX diff headers, required-file filtering, exact deferred-baseline acceptance, unexpected new unformatted files, fixed deferred files without manifest updates, and missing baseline files; checker confirms 24 formatting-required files pass and the 27 deferred legacy/provenance-sensitive files match the documented raw `forge fmt` failure set. Final CI run `27490962706` passed on head `42e31f8a7a8535ef7404ea31169bbef794be4756`, CodeRabbit status was success with no unresolved review threads, and PR #312 squash-merged as `7f08087f25014151373ef67cbd6fc6e243ed36bd`. Deferred baseline retirement starts with first-party interface issue #314. | [`#311`](https://github.com/6529-Collections/6529Stream/issues/311), [`PR #312`](https://github.com/6529-Collections/6529Stream/pull/312), [`#314`](https://github.com/6529-Collections/6529Stream/issues/314) | Gate A/Gate G | TBD |
