...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 10:55 UTC` for merged PR #326 fork deployment rehearsal retained-artifact checker baseline; local validation included focused checker tests, public-beta evidence chain checks, release manifest/checksum checks, changelog checks, and whitespace checks; GitHub CI run `27496425459` passed on final head `e580be8f4116d81ab2e55a671d748aeda714262b` before squash merge `9ff5106834994de16a9f3bd55396743de8b98c77` |
| OS tested | Windows local validation for issue #325; Linux GitHub Actions passed for latest merged baseline PR #326 final CI run `27496425459` on head `e580be8f4116d81ab2e55a671d748aeda714262b`, with merged baseline commit `9ff5106834994de16a9f3bd55396743de8b98c77` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #326 final CI run `27496425459` passed on head `e580be8f4116d81ab2e55a671d748aeda714262b`; CodeRabbit status was success with no unresolved review threads after explicit review request comments `4701475798`, `4701478039`, `4701491393`, and `4701508153`, and review-finished replies `4701476016`, `4701478207`, `4701491623`, and `4701508377`; merge-decision comment `4701523477`; PR #326 squash-merged as `9ff5106834994de16a9f3bd55396743de8b98c77` |
...
| Fork deployment rehearsal retained artifact | Reviewed fork deployment rehearsal evidence must retain fork command output, fork block reference, sanitized broadcast, generated manifest, generated address book, verification status, gas or invariant summary, release digest references, and reviewer approval without secrets | `scripts/test_fork_deployment_rehearsal_evidence.py`, `scripts/check_fork_deployment_rehearsal_evidence.py`, `release-artifacts/evidence/fork-deployment-rehearsal/fork-deployment-rehearsal-retained-artifact-template.md`, `docs/non-local-release-evidence.md` | Passing in merged PR #326 / issue #325 for the no-secret support slice: the repo now has a template-only retained-artifact Markdown file, offline checker, focused tests, local/CI gate wiring, docs, release manifest coverage, and checksum coverage. The committed template remains `blocked` and cannot complete issue #216 until a real reviewed retained fork artifact replaces placeholder values, removes the template-only notice, passes the checker, generates non-local evidence metadata, and is linked from public-beta evidence. PR #327 / issue #327 reconciles this merge state and preserves issue #216 as blocked. | [`#325`](https://github.com/6529-Collections/6529Stream/issues/325), [`PR #326`](https://github.com/6529-Collections/6529Stream/pull/326), [`#327`](https://github.com/6529-Collections/6529Stream/issues/327), [`#216`](https://github.com/6529-Collections/6529Stream/issues/216) | Gate E/Gate G | TBD |
| Fork deployment release artifact coverage | The fork deployment retained-artifact checker and template stay covered by local gates, CI, release manifest, checksum bundle, tooling docs, and release-readiness docs without changing readiness claims | `Makefile`, `scripts/check.sh`, `scripts/check.ps1`, `.github/workflows/ci.yml`, `scripts/generate_release_manifest.py --check`, `scripts/generate_release_checksums.py --check`, `docs/tooling.md`, `docs/release-readiness.md`, `CHANGELOG.md` | Passing in merged PR #326 / issue #325: local/CI gates run the checker and tests, release manifest/checksum artifacts include the template/checker surface, and docs explain that the retained artifact file is template-only evidence until reviewed retained fork data exists. Final CI run `27496425459` passed on head `e580be8f4116d81ab2e55a671d748aeda714262b`, CodeRabbit status was success with review-finished reply `4701508377`, merge-decision comment `4701523477` recorded the rate-limit warning as non-actionable, and squash merge `9ff5106834994de16a9f3bd55396743de8b98c77` landed on `main`. | [`#325`](https://github.com/6529-Collections/6529Stream/issues/325), [`PR #326`](https://github.com/6529-Collections/6529Stream/pull/326), [`#327`](https://github.com/6529-Collections/6529Stream/issues/327), [`P1-RELEASE-006`](https://github.com/6529-Collections/6529Stream/issues/105), [`P1-RELEASE-004`](https://github.com/6529-Collections/6529Stream/issues/101) | Gate E/Gate G | TBD |
