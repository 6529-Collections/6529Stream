...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 06:19 UTC` for latest merged baseline PR #310 state reconciliation; PR #310 local validation covered roadmap/run-state traceability scans and whitespace checks without changing readiness claims |
| OS tested | Windows local validation for Queue Item 149 / PR #310; Linux GitHub Actions passed for latest merged baseline PR #310 run `27490294219` on final head `e339df55d746a73d496898703fe0530ea9989cb0`, with merged baseline commit `e622e61ad076a8c65dad1b7c3bc332e17c36b531` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #310 final CI run `27490294219` passed on head `e339df55d746a73d496898703fe0530ea9989cb0`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700885497`, review-finished reply `4700885685`, and PR #310 squash-merged as `e622e61ad076a8c65dad1b7c3bc332e17c36b531` |
...
| Solidity formatting scoped gate | Formatting-required first-party Solidity files stay formatted and the deferred raw all-files formatting baseline cannot grow silently | `scripts/test_solidity_formatting.py`, `scripts/check_solidity_formatting.py`, `make fmt-check`; raw diagnostic `forge fmt --check smart-contracts` | Passing locally for issue #311: parser tests cover Windows/POSIX diff headers, required-file filtering, exact deferred-baseline acceptance, unexpected new unformatted files, fixed deferred files without manifest updates, and missing baseline files; checker confirms 24 formatting-required files pass and the 27 deferred legacy/provenance-sensitive files match the documented raw `forge fmt` failure set. CI wiring is pending PR review. | [`#311`](https://github.com/6529-Collections/6529Stream/issues/311) | Gate A/Gate G | TBD |
