...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  dashboard, public-beta evidence status, generated public-beta blocker
  report, per-requirement public-beta evidence templates, and per-requirement
  production-release evidence templates, documents and checks non-local
