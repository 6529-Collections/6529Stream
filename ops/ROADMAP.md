...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 10:05 UTC` for merged PR #324 vendored-formatting merge-state reconciliation baseline; local validation includes roadmap/run-state heading and traceability checks, release manifest check, release checksum check, and whitespace check; GitHub CI run `27495297786` passed on final head `c1adc247585ac2479ea9846467adfe4646de03c3` before squash merge `6a5c268a1ed3a60b7d557b6398e78a984ac569ab` |
| OS tested | Windows local validation for issue #323; Linux GitHub Actions passed for latest merged baseline PR #324 final CI run `27495297786` on head `c1adc247585ac2479ea9846467adfe4646de03c3`, with merged baseline commit `6a5c268a1ed3a60b7d557b6398e78a984ac569ab` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #324 final CI run `27495297786` passed on head `c1adc247585ac2479ea9846467adfe4646de03c3`; CodeRabbit status was success with no unresolved review threads after explicit review request comments `4701392005` and `4701395328`, and review-finished replies `4701392175` and `4701395575`; merge-decision comment `4701410886`; PR #324 squash-merged as `6a5c268a1ed3a60b7d557b6398e78a984ac569ab` |
