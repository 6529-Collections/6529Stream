...
- Known remaining production-readiness blockers include fork-level invariant
  ...
  EIP-170-deployable at 24,152 bytes with 424 bytes of headroom under the
...
- Track `StreamCore` size as a release risk through the artifact-backed budget
  ...
  non-trivial Core feature work is 512 bytes. The current 24,152-byte runtime
  measurement leaves 424 bytes of headroom, while the approved
