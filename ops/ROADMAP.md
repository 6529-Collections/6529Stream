...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 13:45 UTC` for merged PR #342 Windows check-wrapper native failure hardening baseline; local validation included focused wrapper policy, PowerShell parser, Bash syntax, release manifest/checksum, changelog, artifact tests, py_compile, and whitespace checks; GitHub CI run `27500588477`, job `81282624570`, passed on final head `0e4e1411a87b7d3a7211e679b776c2714fa4737b` before squash merge `770326ddbc9cc84ed64e66e135e56e2029ce8b4b` |
| OS tested | Windows local validation for issue #341; Linux GitHub Actions passed for latest merged baseline PR #342 CI run `27500588477` on head `0e4e1411a87b7d3a7211e679b776c2714fa4737b`, with merged baseline commit `770326ddbc9cc84ed64e66e135e56e2029ce8b4b` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #342 CI run `27500588477`, job `81282624570`, passed on head `0e4e1411a87b7d3a7211e679b776c2714fa4737b`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701914567` and review-finished reply `4701914757`; initial rate-limit warning comment `4701914443` produced no actionable findings; merge-decision comment `4701935996`; PR #342 squash-merged as `770326ddbc9cc84ed64e66e135e56e2029ce8b4b` |
...
| Windows check wrapper executable failure harness | Checked native-command handling has an executable PowerShell harness proving zero-exit native commands succeed and non-zero native commands throw without running the full Foundry gate | `scripts/windows-check-helpers.ps1`, `scripts/test_windows_check_helpers.ps1`, `scripts/test_windows_check_wrapper.py`, `scripts/check.ps1`, `.github/workflows/ci.yml`, `Makefile` | In Progress for issue #343: helper extraction and runtime harness are being added so the PR #342 policy guarantee is backed by an executable PowerShell failure/success check in local and CI PowerShell gates. | [`#343`](https://github.com/6529-Collections/6529Stream/issues/343) | Gate A/Gate G | TBD |
