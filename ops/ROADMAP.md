...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-15 04:11 UTC` on branch `codex/pause-settlement-matrix-invariants`: full `scripts/check.ps1` local gate passed after adding ADV-004 pause and settlement matrix coverage, rebasing onto `origin/main` commit `ba93f5baf368b11d738863086441370145e0aa81`, and tightening paused-action/failed-withdrawal negative tests to exact revert assertions after bot nice-to-have feedback; PR #377 merged as `7d14e95df61f0ef0f1185c42a7a70e3bb50a1ec9`; issue #217 remains open for real reviewed testnet deployment rehearsal evidence |
| OS tested | Local Windows PowerShell wrapper passed on branch `codex/pause-settlement-matrix-invariants`; latest merged baseline PR #377 CI run `27521742421` passed on head `676d3982024bd79c061540bc71aa6184cc84064a`, including Windows PowerShell wrapper job `81340908382` and Foundry smoke job `81340908414` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #377 CI run `27521742421` passed on head `676d3982024bd79c061540bc71aa6184cc84064a`; CodeRabbit status was success with no actionable comments or review threads; PR #377 squash-merged as `7d14e95df61f0ef0f1185c42a7a70e3bb50a1ec9`; issue #374 closed completed |
...
- Royalty policy must be explicit. ERC-2981 is royalty disclosure only; it does
  ...
  creator-fee enforcement is out of scope, optional, or future work.
