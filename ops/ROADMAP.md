...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 13:20 UTC` for merged PR #340 PR #338 merge-state reconciliation baseline; local validation included roadmap/run-state traceability, heading, release manifest/checksum, changelog, and whitespace checks; GitHub CI run `27499976730`, job `81280968647`, passed on final head `790c24248afc5c43a6f14d3fde371f359fdb7653` before squash merge `8cc2bfbf4a9a84a8294ca77a383758b35ca7eaf1` |
| OS tested | Windows local validation for issue #339; Linux GitHub Actions passed for latest merged baseline PR #340 CI run `27499976730` on head `790c24248afc5c43a6f14d3fde371f359fdb7653`, with merged baseline commit `8cc2bfbf4a9a84a8294ca77a383758b35ca7eaf1` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #340 CI run `27499976730`, job `81280968647`, passed on head `790c24248afc5c43a6f14d3fde371f359fdb7653`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701852808` and review-finished reply `4701853050`; initial rate-limit warning comment `4701852605` produced no actionable findings; merge-decision comment `4701874979`; PR #340 squash-merged as `8cc2bfbf4a9a84a8294ca77a383758b35ca7eaf1` |
...
| Windows check wrapper native failures | `scripts/check.ps1` must fail fast when `forge` or Python exits non-zero under Windows PowerShell 5.1 native-command semantics | `scripts/test_windows_check_wrapper.py`, `scripts/check.ps1`, `scripts/check.sh`, `.github/workflows/ci.yml`, `Makefile` | In Progress for issue #341: checked native-command wrappers now route `forge` and the selected Python interpreter through `$LASTEXITCODE` enforcement, and a focused policy test is being wired into local/CI gates so the wrapper cannot regress to false-green native command behavior. | [`#341`](https://github.com/6529-Collections/6529Stream/issues/341) | Gate A/Gate G | TBD |
