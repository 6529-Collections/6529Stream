...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  dashboard, and runs the local deployment and auction ceremony rehearsals. It
...
Status: In Progress.
Owner: TBD.
Blocking issues: [`#162`](https://github.com/6529-Collections/6529Stream/issues/162)
for the release-readiness dashboard and checker; production signatures, signed
tags, live explorer verification, verified live addresses, production address
books, fork/testnet/live ceremony evidence, fork/testnet/live randomizer
operations evidence, and external audit completion remain future release
blockers.
...
model docs, and the in-progress `docs/release-readiness.md` dashboard.
