...
| Safe/ERC-1271 fork-aware smoke | Safe-shaped approved-hash threshold signing succeeds for fixed-price and auction drops, and wrong-chain / wrong-verifying-contract payloads fail without consuming drops | `test/StreamSafeERC1271ForkSmoke.t.sol`, `docs/integrations/wallets-and-signatures.md` | Active issue #442: local PR candidate adds no-RPC Safe-shaped ERC-1271 smoke coverage under an explicit Foundry chain-ID simulation, wires wallet docs/checkers, and preserves the boundary that local smoke tests do not replace reviewed fork/testnet/live Safe evidence | [`#442`](https://github.com/6529-Collections/6529Stream/issues/442) | Gate D/Gate F | TBD |
