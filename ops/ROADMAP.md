...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 11:52 UTC` for merged PR #332 fork tracker retained-artifact merge-state baseline; local validation included roadmap/run-state traceability, heading, release manifest/checksum, and whitespace checks; GitHub CI run `27497791932` passed on final head `523307dac087672bc840c839fcc2b83b35cc58d5` before squash merge `fcb5ae5238420196999b654d88e69a507e221e85` |
| OS tested | Windows local validation for issue #331; Linux GitHub Actions passed for latest merged baseline PR #332 final CI run `27497791932` on head `523307dac087672bc840c839fcc2b83b35cc58d5`, with merged baseline commit `fcb5ae5238420196999b654d88e69a507e221e85` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #332 final CI run `27497791932` passed on head `523307dac087672bc840c839fcc2b83b35cc58d5`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701639516` and review-finished reply `4701639759`; merge-decision comment `4701657448`; PR #332 squash-merged as `fcb5ae5238420196999b654d88e69a507e221e85` |
