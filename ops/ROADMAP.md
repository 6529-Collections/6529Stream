...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 11:37 UTC` for merged PR #330 fork deployment tracker retained-artifact routing baseline; local validation included release evidence packet-index, issue-backlog, issue-body-sync, issue-body, release manifest/checksum, changelog, and full Windows check gates; GitHub CI run `27497423363` passed on final head `2bb2c74ccb97cc9ff286ccb282646adc6634c5d8` before squash merge `54a4e3913304df0222d971658b504e3043be8777` |
| OS tested | Windows local validation for issue #329; Linux GitHub Actions passed for latest merged baseline PR #330 final CI run `27497423363` on head `2bb2c74ccb97cc9ff286ccb282646adc6634c5d8`, with merged baseline commit `54a4e3913304df0222d971658b504e3043be8777` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #330 final CI run `27497423363` passed on head `2bb2c74ccb97cc9ff286ccb282646adc6634c5d8`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701604373` and review-finished reply `4701604582`; merge-decision comment `4701622391`; PR #330 squash-merged as `54a4e3913304df0222d971658b504e3043be8777` |
