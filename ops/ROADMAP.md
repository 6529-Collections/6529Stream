...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 01:01 UTC` for Queue Item 136 / PR #284 live audit report archive merge-state reconciliation; PR #284 local validation covered release-readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 136 / PR #284; Linux GitHub Actions passed for latest merged baseline PR #284 run `27483989654` on final head `553a151a5aa785c79a6c90ad4a2847e75ce9dbc3`, with merged baseline commit `b6b3d1fc5007b0a44b4f774a3356298b2ebc7c00` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #284 final CI run `27483989654` passed on head `553a151a5aa785c79a6c90ad4a2847e75ce9dbc3`; CodeRabbit status was success with no unresolved review threads, explicit review request returned review-finished reply `4700269219`, and PR #284 squash-merged as `b6b3d1fc5007b0a44b4f774a3356298b2ebc7c00` |
