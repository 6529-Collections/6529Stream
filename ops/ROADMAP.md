...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 03:36 UTC` for Queue Item 144 / PR #300 retained live audit manifest/checksum guard reconciliation; PR #300 local validation covered release readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 144 / PR #300; Linux GitHub Actions passed for latest merged baseline PR #300 run `27487104812` on final head `f4db6463461c391a08e02fb97c9892ec18c3d0a3`, with merged baseline commit `4c231c8684adebab89cc7f31f7f519bab7418045` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #300 final CI run `27487104812` passed on head `f4db6463461c391a08e02fb97c9892ec18c3d0a3`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700575512`, and PR #300 squash-merged as `4c231c8684adebab89cc7f31f7f519bab7418045` |
...
| Release evidence live audit report freshness guard | Retained live audit reports cannot present stale issue-label, issue-body, or issue-closure snapshots as current without an explicit stale/readiness-blocked marker | `scripts/test_release_evidence_live_audit_report.py`, `scripts/test_release_evidence_issue_snapshot_audit.py`, `scripts/test_release_evidence_live_audit_markdown.py`, `scripts/test_release_evidence_live_audit_archive.py`, `scripts/check_release_evidence_live_audit_report.py`, `scripts/check_release_evidence_live_audit_markdown.py`, `scripts/generate_release_evidence_live_audit_archive.py --archive-dir release-artifacts/evidence/live-audit-reports --check`, `powershell -ExecutionPolicy Bypass -File scripts\check.ps1` | PR #302 / issue #301 opened on head `30195e922fdd7eada56301092196f31235e764ed`: local validation passing for schema/checker enforcement of `snapshot_freshness`, `currentness_claim`, and per-profile `profile_generated_at`; live-export reports may claim only `current_at_generation_only`, retained template/dry-run reports must claim `not_current`, canonical Markdown and archive rows surface the freshness fields, docs/readiness wording was refreshed, release manifest/checksum evidence was regenerated, and the full Windows wrapper passed; readiness remains blocked pending actual fork/testnet/live/audit evidence | [`#301`](https://github.com/6529-Collections/6529Stream/issues/301), [`PR #302`](https://github.com/6529-Collections/6529Stream/pull/302) | Gate G | TBD |
