...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  dashboard, public-beta evidence status, and generated public-beta blocker
  report, documents and checks non-local
