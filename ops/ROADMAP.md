...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-13 21:42 UTC` for Queue Item 129 / PR #270 release evidence live audit report bundle; PR #270 local validation covered focused report tests, release-readiness, manifest, checksum, changelog, traceability, heading, whitespace, and full Windows `scripts\check.ps1` gates |
| OS tested | Windows local validation for Queue Item 129 / PR #270; Linux GitHub Actions passed for latest merged baseline PR #270 run `27479701303` on final head `3a71a61778baec01cf0d4de0f307f5b3db4f53e6`, with merged baseline commit `774d564b690e8f90380c31244255769af7d9ff63` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #270 final CI run `27479701303` passed on head `3a71a61778baec01cf0d4de0f307f5b3db4f53e6`; CodeRabbit status was success with no unresolved review threads, and PR #270 squash-merged as `774d564b690e8f90380c31244255769af7d9ff63` |
