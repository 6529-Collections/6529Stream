...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  release evidence metadata intake, and runs the local deployment and auction ceremony
  rehearsals. It
