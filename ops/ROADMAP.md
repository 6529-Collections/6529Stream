...
- Known remaining P0 blockers include broader payment accounting and
  ...
  metadata display now keeps the IR-optimized runtime deployable at 24,348
  bytes with 228 bytes of EIP-170 headroom, but this is below the current
