...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  release evidence metadata intake, checks the protocol incident-response
...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 09:01 UTC` for merged PR #318 provider/integration formatting-deferral retirement; final validation shows 34 formatting-required files and 17 remaining vendored/provenance-sensitive raw formatting diffs, deployment/evidence/release artifact drift checks, ABI compatibility, production via-IR size gate, full Windows `scripts\check.ps1`, GitHub Actions CI success, and CodeRabbit success |
| OS tested | Windows full local validation for issue #317 / PR #318; Linux GitHub Actions passed for PR #318 final CI run `27493830680` on head `ee186694672e1e5330405dc8bd593c05b4e1776e`, with merged baseline commit `e66496804adb5064361f763ae781ec153d662e21` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #318 final CI run `27493830680` passed on head `ee186694672e1e5330405dc8bd593c05b4e1776e`; CodeRabbit status was success with no unresolved review threads after final explicit review request comment `4701247477` and review-finished reply `4701248027`; merge-decision comment `4701263404`; PR #318 squash-merged as `e66496804adb5064361f763ae781ec153d662e21` |
...
| Formatting | Merged PR #318 retires provider/integration deferrals: 34 formatting-required files pass `forge fmt --check`, and the raw all-files diagnostic is allowed to fail only for 17 remaining documented vendored/provenance-sensitive files; issue #320 will convert that residual list from deferral language into explicit provenance exemptions | `python scripts/test_solidity_formatting.py`, `python scripts/check_solidity_formatting.py`, `make fmt-check`; raw diagnostic: `forge fmt --check smart-contracts` | Scoped gate passes in CI; remaining vendored/provenance exemptions are explicit, reviewed, and unable to hide new first-party formatting drift |
...
- Add and maintain a scoped Solidity formatting gate that requires first-party
  files to pass `forge fmt --check` while documenting any deferred
  provenance-sensitive files.
- Treat remaining OpenZeppelin-style vendored files as an explicit provenance
  decision instead of an indefinite formatting deferral; issue #320 tracks
...
| Solidity formatting scoped gate | Formatting-required Solidity files stay formatted and the residual raw all-files formatting baseline cannot grow silently | `scripts/test_solidity_formatting.py`, `scripts/check_solidity_formatting.py`, `make fmt-check`; raw diagnostic `forge fmt --check smart-contracts` | Passing in merged PR #318: the provider/integration slice `ArrngConsumer.sol`, `IArrngConsumer.sol`, `IArrngController.sol`, `IDelegationManagementContract.sol`, `IRandomizer.sol`, `VRFConsumerBaseV2.sol`, and `VRFCoordinatorV2Interface.sol` is formatted and removed from `DEFERRED_FORMATTING_FILES`; parser tests continue to cover Windows/POSIX diff headers, required-file filtering, exact deferred-baseline acceptance, unexpected new unformatted files, fixed deferred files without manifest updates, and missing baseline files; the checker now confirms 34 formatting-required files and 17 remaining vendored/provenance-sensitive raw `forge fmt` diffs. PR #312 introduced the gate, PR #315 recorded the merged gate baseline, PR #316 retired first-party interface deferrals, and PR #318 retired the non-vendored provider/integration deferrals after final CI run `27493830680`, CodeRabbit success, and squash merge `e66496804adb5064361f763ae781ec153d662e21`. Issue #319 records this merge-state reconciliation, and issue #320 queues the next policy pass to convert the remaining 17-file residual baseline into explicit vendored/provenance exemptions. | [`#311`](https://github.com/6529-Collections/6529Stream/issues/311), [`PR #312`](https://github.com/6529-Collections/6529Stream/pull/312), [`PR #315`](https://github.com/6529-Collections/6529Stream/pull/315), [`#314`](https://github.com/6529-Collections/6529Stream/issues/314), [`PR #316`](https://github.com/6529-Collections/6529Stream/pull/316), [`#317`](https://github.com/6529-Collections/6529Stream/issues/317), [`PR #318`](https://github.com/6529-Collections/6529Stream/pull/318), [`#319`](https://github.com/6529-Collections/6529Stream/issues/319), [`#320`](https://github.com/6529-Collections/6529Stream/issues/320) | Gate A/Gate G | TBD |
