...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 02:28 UTC` for Queue Item 140 / PR #292 retained live audit dry-run merge-state reconciliation; PR #292 local validation covered release readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 140 / PR #292; Linux GitHub Actions passed for latest merged baseline PR #292 run `27485792693` on final head `4be1827c9ddec07d4cf613a238f5829b181b549f`, with merged baseline commit `8e02f7797e29db4c211fcf54b50dc10b2f84effa` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #292 final CI run `27485792693` passed on head `4be1827c9ddec07d4cf613a238f5829b181b549f`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700447441`, and PR #292 squash-merged as `8e02f7797e29db4c211fcf54b50dc10b2f84effa` |
...
| Release evidence live audit retained dry-run archive guard | The archive test suite fails if the committed retained dry-run row is dropped or loses its blocked readiness, no-secret policy, no-network CI posture, report paths, profile coverage, validation status, or validation commands | `scripts/test_release_evidence_live_audit_archive.py::test_committed_archive_includes_retained_dry_run_bundle` | In Progress in PR #294 / issue #293: focused committed-input regression passes locally for archive ID `20260614T015000Z-release-evidence-live-audit-dry-run`; archive check, release-readiness, manifest, checksum, changelog, traceability, heading, and whitespace gates passed locally before PR open; CI and CodeRabbit remain pending | [`#293`](https://github.com/6529-Collections/6529Stream/issues/293) | Gate G | TBD |
