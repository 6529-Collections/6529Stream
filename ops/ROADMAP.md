...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 01:31 UTC` for Queue Item 137 / PR #286 live audit archive retention workflow; PR #286 local validation covered focused release-readiness, live-audit archive, release manifest, release checksums, release artifacts, changelog, Python bytecode compilation, traceability, heading, whitespace, and full Windows check-script gates |
| OS tested | Windows local validation for Queue Item 137 / PR #286; Linux GitHub Actions passed for latest merged baseline PR #286 run `27484623928` on final head `2b6301eaaeeed67fcc349a637be3baf4a80785b7`, with merged baseline commit `ef76853783dd23d46165050fe01cd6afa031f660` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #286 final CI run `27484623928` passed on head `2b6301eaaeeed67fcc349a637be3baf4a80785b7`; prior CI run `27484559955` caught an EOF hygiene issue that was fixed before merge, CodeRabbit status was success with no unresolved review threads, explicit review requests returned review-finished replies, and PR #286 squash-merged as `ef76853783dd23d46165050fe01cd6afa031f660` |
