...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 02:58 UTC` for Queue Item 142 / PR #296 retained live audit dry-run archive guard merge-state reconciliation; PR #296 local validation covered release readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 142 / PR #296; Linux GitHub Actions passed for latest merged baseline PR #296 run `27486374139` on final head `9a284f68b0930d6a495608618203fbcffe0317d7`, with merged baseline commit `ea40da44571a10e96b8e9f07d4fadc8e6a688763` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #296 final CI run `27486374139` passed on head `9a284f68b0930d6a495608618203fbcffe0317d7`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700504396`, and PR #296 squash-merged as `ea40da44571a10e96b8e9f07d4fadc8e6a688763` |
