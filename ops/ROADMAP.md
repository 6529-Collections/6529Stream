...
- Failed post-processing is now observable: if core token-hash writing reverts
  ...
  clear pending counts, emit a failure event, and reject duplicate callbacks.
