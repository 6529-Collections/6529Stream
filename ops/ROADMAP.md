...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-15 05:29 UTC` on branch `codex/signed-release-tag-gate`: full `scripts/check.ps1` local gate passed after adding the REL-002 signed release tag verifier, wiring the non-release gate into local/CI checks, updating release docs/readiness checks, and regenerating deterministic release manifest/checksum artifacts; branch started from PR #381 squash merge commit `7e47cdf3732111616d4cd24e2c051c894471108d`; issue #217 remains open for real reviewed testnet deployment rehearsal evidence |
| OS tested | Local Windows PowerShell wrapper passed on branch `codex/signed-release-tag-gate`; latest merged baseline PR #381 CI run `27524979955` passed on head `63d2655202edf12f0dfa30c369f672944c3f3511`, including Windows PowerShell wrapper job `81350359315` and Foundry smoke job `81350359309` |
