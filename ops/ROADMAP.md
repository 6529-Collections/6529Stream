...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-13 22:54 UTC` for Queue Item 132 / PR #276 live audit report checker merge-state reconciliation; PR #276 local validation covered release-readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 132 / PR #276; Linux GitHub Actions passed for latest merged baseline PR #276 run `27481408954` on final head `688762c9214ac4d7b27176a4dd37458935d8a1ed`, with merged baseline commit `da1691d21758825567083bedaf7010ef59b8c80d` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #276 final CI run `27481408954` passed on head `688762c9214ac4d7b27176a4dd37458935d8a1ed`; CodeRabbit status was success with no unresolved review threads, a maintainer decision documented the CodeRabbit quota context, and PR #276 squash-merged as `da1691d21758825567083bedaf7010ef59b8c80d` |
