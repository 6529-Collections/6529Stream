...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  dashboard and public-beta evidence status, documents non-local release
  evidence intake, and runs the local deployment and auction ceremony
  rehearsals. It
