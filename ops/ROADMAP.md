...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  report, and per-requirement public-beta evidence templates, documents and checks non-local
