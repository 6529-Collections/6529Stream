...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  documents and checks non-local
...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-13 16:26 UTC` for Queue Item 118 / PR #248 closure-readiness guard; PR #248 local validation covered closure checker tests/check, body checker tests/check, release-readiness, manifest, checksum, changelog, shell/PowerShell syntax, heading, whitespace, and optional live GitHub closure snapshot audit |
| OS tested | Windows local closure-readiness validation for Queue Item 118 / PR #248, including committed artifact consistency and optional live GitHub issue closure snapshot audit; Linux GitHub Actions passed for latest merged baseline PR #248 run `27472194068` on final head `9968e0f3cd476b82494edbd2b7cbd674ed778a9d`, with merged baseline commit `1c258231820cfb022b1ba859608d9be1c8970392` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #248 final CI run `27472194068` passed on head `9968e0f3cd476b82494edbd2b7cbd674ed778a9d`; CodeRabbit status was success with no unresolved review threads, and PR #248 squash-merged as `1c258231820cfb022b1ba859608d9be1c8970392` |
