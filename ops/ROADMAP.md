...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 16:50 UTC` for merged baseline PR #350: reviewed fork rehearsal evidence, public-beta evidence, blocker report, packet index, issue backlog, issue links, body sync, label/body/closure checks, release-readiness, release manifest, checksum bundle, and changelog checks passed locally on the PR branch; full Windows `$env:Path="$HOME\.foundry\bin;$env:Path"; powershell -NoProfile -ExecutionPolicy Bypass -File scripts\check.ps1` passed locally with existing compiler/test warning noise only; PR #350 CI run `27505334136` passed on final head `978a44eccf2ccfe1405aa4697c70853f9fa2fcfb` before squash merge `8af52acb1072d106033162f251e4aa2fa321d628`; issue #216 closed completed |
| OS tested | Windows local validation for reviewed fork rehearsal evidence acceptance; GitHub Actions passed for merged baseline PR #350 CI run `27505334136` on head `978a44eccf2ccfe1405aa4697c70853f9fa2fcfb`, including Windows PowerShell wrapper job `81295431136` and Foundry smoke job `81295431140`, with merged baseline commit `8af52acb1072d106033162f251e4aa2fa321d628` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #350 CI run `27505334136` passed on head `978a44eccf2ccfe1405aa4697c70853f9fa2fcfb`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4702384067` and review-finished reply `4702384287`; merge-decision comment `4702403805`; PR #350 squash-merged as `8af52acb1072d106033162f251e4aa2fa321d628`; issue #216 closed completed |
