...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-13 22:40 UTC` for Queue Item 131 / PR #274 release evidence live audit report schema/checker; PR #274 local validation covered focused checker tests, committed template check, release-readiness, release manifest, release checksums, changelog, syntax, traceability, heading, whitespace, and full Windows `scripts\check.ps1` gates |
| OS tested | Windows local validation for Queue Item 131 / PR #274; Linux GitHub Actions passed for latest merged baseline PR #274 run `27481075679` on final head `8cc0b4acdfba32035fcedad0b32dc32688da576d`, with merged baseline commit `42c365d1beb80ce0d209049177621be0e2afb995` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #274 final CI run `27481075679` passed on head `8cc0b4acdfba32035fcedad0b32dc32688da576d`; CodeRabbit status was success with no unresolved review threads, a maintainer decision documented the CodeRabbit quota context, and PR #274 squash-merged as `42c365d1beb80ce0d209049177621be0e2afb995` |
