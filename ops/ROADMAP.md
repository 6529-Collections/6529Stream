...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 08:16 UTC` for current issue #317 provider/integration formatting-deferral retirement; local validation includes focused formatting checks showing 34 required files and 17 deferred files, deployment/evidence/release artifact drift checks, ABI compatibility, production via-IR size gate, and full Windows `scripts\check.ps1` |
| OS tested | Windows full local validation for issue #317; Windows full local validation for issue #314 / PR #316; Linux GitHub Actions passed for latest merged baseline PR #316 run `27492328469` on final head `06d77acd23c15fb3193e5e9f621e33c4137cbcaf`, with merged baseline commit `e10f487bbe6c16a2f2a1c2643426f986cc3e339e` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #316 final CI run `27492328469` passed on head `06d77acd23c15fb3193e5e9f621e33c4137cbcaf`; CodeRabbit status was success with no unresolved review threads after explicit review request comments `4701042752`, `4701081061`, and `4701089381`, merge-decision comment `4701109319`, and PR #316 squash-merged as `e10f487bbe6c16a2f2a1c2643426f986cc3e339e` |
...
| Formatting | Current issue #317 local validation retires provider/integration deferrals: 34 formatting-required files pass `forge fmt --check`, and the raw all-files diagnostic is allowed to fail only for 17 documented deferred legacy/provenance-sensitive files | `python scripts/test_solidity_formatting.py`, `python scripts/check_solidity_formatting.py`, `make fmt-check`; raw diagnostic: `forge fmt --check smart-contracts` | Scoped gate passes in CI; remaining deferred files retired through focused formatting/provenance PRs |
...
- Retire the deferred raw `forge fmt --check smart-contracts` baseline through
  focused formatting/provenance PRs.
...
| Solidity formatting scoped gate | Formatting-required Solidity files stay formatted and the deferred raw all-files formatting baseline cannot grow silently | `scripts/test_solidity_formatting.py`, `scripts/check_solidity_formatting.py`, `make fmt-check`; raw diagnostic `forge fmt --check smart-contracts` | Passing locally for issue #317: the provider/integration slice `ArrngConsumer.sol`, `IArrngConsumer.sol`, `IArrngController.sol`, `IDelegationManagementContract.sol`, `IRandomizer.sol`, `VRFConsumerBaseV2.sol`, and `VRFCoordinatorV2Interface.sol` is formatted and removed from `DEFERRED_FORMATTING_FILES`; parser tests continue to cover Windows/POSIX diff headers, required-file filtering, exact deferred-baseline acceptance, unexpected new unformatted files, fixed deferred files without manifest updates, and missing baseline files; the checker now confirms 34 formatting-required files and 17 deferred legacy/provenance-sensitive raw `forge fmt` diffs. PR #312 introduced the gate, PR #315 recorded the merged gate baseline, PR #316 retired first-party interface deferrals, and remaining deferred-file retirement will continue through focused provenance/formatting PRs. Local validation includes `make fmt-check`, deployment/evidence/release artifact drift checks, ABI compatibility, production via-IR size gate, and full Windows `scripts\check.ps1`. | [`#311`](https://github.com/6529-Collections/6529Stream/issues/311), [`PR #312`](https://github.com/6529-Collections/6529Stream/pull/312), [`PR #315`](https://github.com/6529-Collections/6529Stream/pull/315), [`#314`](https://github.com/6529-Collections/6529Stream/issues/314), [`PR #316`](https://github.com/6529-Collections/6529Stream/pull/316), [`#317`](https://github.com/6529-Collections/6529Stream/issues/317) | Gate A/Gate G | TBD |
