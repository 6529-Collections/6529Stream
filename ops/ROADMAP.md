...
- Add non-local release evidence intake. Initial
  ...
  invariant, signature, and signed-tag evidence.
...
- Non-local release evidence intake followed before any fork, testnet, live,
  audit, explorer, gas, invariant, signature, or signed-tag requirement is
  marked complete in `release-artifacts/latest/public-beta-evidence.json`.
