...
- [`P1-META-005`](https://github.com/6529-Collections/6529Stream/issues/50)
  ...
  state, are excluded from live supply, and can record valid post-burn
  randomness as audit-only state without changing live metadata or freeze
  manifests.
