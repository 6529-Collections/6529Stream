...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 02:11 UTC` for Queue Item 139 / PR #290 retained live audit dry-run bundle; PR #290 local validation covered live-audit report tests/checks, Markdown parity tests/checks, archive tests/checks, release artifact catalog, release manifest, release checksums, release readiness, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 139 / PR #290; Linux GitHub Actions passed for latest merged baseline PR #290 run `27485413902` on final head `e5cbe22483538d1231988510ab3a6bb0f453fe3c`, with merged baseline commit `441b390f2fe0f9fd3ca1fb64beb613132768ae21` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #290 final CI run `27485413902` passed on head `e5cbe22483538d1231988510ab3a6bb0f453fe3c`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700407445`, and PR #290 squash-merged as `441b390f2fe0f9fd3ca1fb64beb613132768ae21` |
