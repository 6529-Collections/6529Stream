...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-15 06:23 UTC` on branch `codex/bytecode-release-proof`: full `scripts/check.ps1` local gate passed after adding the REL-003 bytecode-to-release proof generator/checker/tests, checksum coverage, local/CI wiring, release docs/readiness checks, and reviewer-comment roadmap/backlog updates; branch started from PR #383 squash merge commit `b0ee33f59e7c3f28bd93cdd81fa5ed4e6e361fa9`; issue #217 remains open for real reviewed testnet deployment rehearsal evidence |
| OS tested | Local Windows PowerShell wrapper passed on branch `codex/bytecode-release-proof`; latest merged baseline PR #383 passed Windows wrapper and Foundry smoke CI before squash merge `b0ee33f59e7c3f28bd93cdd81fa5ed4e6e361fa9` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #383 passed Windows wrapper and Foundry smoke CI on head `f4dd225ec6ddb152df5d797ed6990fd99dd12b98`; CodeRabbit status was success with no unresolved review threads; PR #383 squash-merged as `b0ee33f59e7c3f28bd93cdd81fa5ed4e6e361fa9`; issue #382 closed completed. Current branch CI is pending until PR creation |
...
gaps. New "best 1/1" product surfaces should default to satellites,
read-adapters, release artifacts, or documentation while `StreamCore` remains
