...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 04:20 UTC` for Queue Item 145 / PR #302 retained live audit report freshness guard; PR #302 local validation covered focused freshness tests/checkers, release readiness, release manifest, release checksums, changelog, full Windows `scripts\check.ps1`, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 145 / PR #302; Linux GitHub Actions passed for latest merged baseline PR #302 run `27487986670` on final head `8f52a4ad71082209d596e60dc70525dfd1d32622`, with merged baseline commit `96c1e7cd63a3129f04658d16eab56229063e4718` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #302 final CI run `27487986670` passed on head `8f52a4ad71082209d596e60dc70525dfd1d32622`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700659492`, and PR #302 squash-merged as `96c1e7cd63a3129f04658d16eab56229063e4718` |
