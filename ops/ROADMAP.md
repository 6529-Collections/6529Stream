...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 09:46 UTC` for merged PR #322 vendored/provenance formatting exemption baseline; local validation includes focused formatting tests/checker, `make fmt-check`, terminology grep, changelog gate, release-readiness check, release artifact catalog check, release manifest check, release checksum check, and full Windows `scripts\check.ps1`; GitHub CI run `27494893331` passed on final head `eca2cbc46b5cbba236335afbb7d11bc603af7602` before squash merge `e3e98e7f3284558a4cc747cf4b634bee2d8205a6` |
| OS tested | Windows local validation for issue #320; Linux GitHub Actions passed for latest merged baseline PR #322 final CI run `27494893331` on head `eca2cbc46b5cbba236335afbb7d11bc603af7602`, with merged baseline commit `e3e98e7f3284558a4cc747cf4b634bee2d8205a6` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #322 final CI run `27494893331` passed on head `eca2cbc46b5cbba236335afbb7d11bc603af7602`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701353924` and review-finished reply `4701354147`; merge-decision comment `4701372430`; PR #322 squash-merged as `e3e98e7f3284558a4cc747cf4b634bee2d8205a6` |
