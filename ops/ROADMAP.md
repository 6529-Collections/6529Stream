...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 11:11 UTC` for merged PR #328 fork deployment rehearsal evidence-checker merge-state baseline; local validation included roadmap/run-state traceability checks, release manifest/checksum checks, and whitespace checks; GitHub CI run `27496787719` passed on final head `756728b15a6771acf6ff55106a04cbe7452a9a70` before squash merge `49e2434e0699c989e89d7cfd20ac2a8726875123` |
| OS tested | Windows local validation for issue #327; Linux GitHub Actions passed for latest merged baseline PR #328 final CI run `27496787719` on head `756728b15a6771acf6ff55106a04cbe7452a9a70`, with merged baseline commit `49e2434e0699c989e89d7cfd20ac2a8726875123` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #328 final CI run `27496787719` passed on head `756728b15a6771acf6ff55106a04cbe7452a9a70`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701539951` and review-finished reply `4701540159`; merge-decision comment `4701560832`; PR #328 squash-merged as `49e2434e0699c989e89d7cfd20ac2a8726875123` |
