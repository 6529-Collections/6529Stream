...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 03:20 UTC` for Queue Item 143 / PR #298 retained live audit release integrity coverage; PR #298 local validation covered focused manifest/checksum tests, release readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 143 / PR #298; Linux GitHub Actions passed for latest merged baseline PR #298 run `27486783805` on final head `7d71324e7ddec76263bac97d88a500a4ecdf3cdd`, with merged baseline commit `ebf38ee8f5396674b92ef49b8a566c5fd1074f87` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #298 final CI run `27486783805` passed on head `7d71324e7ddec76263bac97d88a500a4ecdf3cdd`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700544004`, and PR #298 squash-merged as `ebf38ee8f5396674b92ef49b8a566c5fd1074f87` |
...
| Release evidence live audit report freshness guard | Retained live audit reports cannot present stale issue-label, issue-body, or issue-closure snapshots as current without an explicit stale/readiness-blocked marker | TBD: likely `scripts/test_release_evidence_live_audit_report.py`, `scripts/check_release_evidence_live_audit_report.py`, and retained live audit report fixtures | Queued after issue #299: add no-secret offline freshness/currentness checks for retained report snapshot timestamps, generated-at values, and snapshot digest provenance without GitHub network access in CI or any public-beta/production readiness claim | TBD | Gate G | TBD |
