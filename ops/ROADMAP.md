...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-13 20:55 UTC` for Queue Item 128 / PR #268 reconciliation of the release evidence live audit orchestrator merge state; PR #268 local validation covered release-readiness, manifest, checksum, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 128 / PR #268; Linux GitHub Actions passed for latest merged baseline PR #268 run `27478649600` on final head `ce9f2aea8762e76386a315d72953c93d8acfb9b5`, with merged baseline commit `bb36ddb9bbf387accedeecfb5dd7dfb5d58b6fa4` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #268 final CI run `27478649600` passed on head `ce9f2aea8762e76386a315d72953c93d8acfb9b5`; CodeRabbit status was success with no open review threads, and PR #268 squash-merged as `bb36ddb9bbf387accedeecfb5dd7dfb5d58b6fa4` |
...
| Release evidence live audit report bundle | Operator live audits can retain no-secret JSON/Markdown report bundles for label, body, and closure tracker snapshots without adding GitHub network access to CI or changing readiness claims | `scripts/test_release_evidence_issue_snapshot_audit.py`, optional `scripts/audit_release_evidence_issue_snapshots.py --report-json tmp/release-evidence-live-audit-report.json --report-md tmp/release-evidence-live-audit-report.md` operator run | In Progress for issue #269: report mode records selected profiles, snapshot paths, SHA-256 digests, command provenance, checker outcomes, repo target, deterministic or operator-supplied generated-at value, no-secret notice, and blocked-readiness warning; tests cover deterministic JSON/Markdown output, profile ordering, missing snapshots, and failed-check no-report behavior | [`#269`](https://github.com/6529-Collections/6529Stream/issues/269) | Gate G | TBD |
