...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-15 00:13 UTC` on branch `codex/admin-ceremony-evidence-checker`: full `scripts/check.ps1` local gate passed after adding and sidecar-hardening the admin ceremony evidence schema/template/checker; PR #361 previously merged as `63b1c30444db9ed143c3914e8bfce4803a456a5e`; issue #217 remains open for real reviewed testnet deployment rehearsal evidence |
| OS tested | Local Windows PowerShell wrapper passed on branch `codex/admin-ceremony-evidence-checker`; latest merged baseline PR #361 CI run `27515414735` passed on head `9f0017b18c97495565b6f4a91161023e769130d6`, including Windows PowerShell wrapper job `81323076315` and Foundry smoke job `81323076314` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #361 CI run `27515414735` passed on head `9f0017b18c97495565b6f4a91161023e769130d6`; CodeRabbit was rate-limited, sidecar review caught the signer wording issue before merge, and merge-decision comment `4703427194` recorded the autonomous basis; PR #361 squash-merged as `63b1c30444db9ed143c3914e8bfce4803a456a5e`; issue #360 closed completed |
...
GOV-001 is in progress on issue #362. The intended local baseline is a
no-secret admin ceremony evidence schema, template, retained-artifact
checklist, checker, tests, local/CI wiring, release-manifest coverage, checksum
coverage, and deployment/release-readiness/runbook documentation. It does not
complete fork, testnet, mainnet, or production admin ceremony readiness. Future
reviewed evidence must prove ownership transfer or intentional blocking,
Safe/multisig control, temporary deployer-admin revocation, role grants,
signer setup, pause and emergency controls, post-state reads, source/explorer
verification status, approval, retained artifact hashes, and redaction.
