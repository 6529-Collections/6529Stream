...
- Implement [`P1-META-001`](https://github.com/6529-Collections/6529Stream/issues/46):
  metadata schema and golden-file tests. Initial characterization fixtures now
  pin current off-chain pending/final URIs and current on-chain pending/final
  JSON data URIs; the final schema-versioned public-beta metadata model remains
  open.
