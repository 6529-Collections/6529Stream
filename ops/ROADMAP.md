...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 15:54 UTC` for active branch `codex/reconcile-fork-evidence-merge-state`: live issue #216 was synced to the committed `pending` body-sync payload, retained live audit report bundle `20260614T153950Z` was generated with labels/body/closure snapshots, focused live-audit/body-sync/archive/release-integrity checks passed, and full Windows `$env:Path="$HOME\.foundry\bin;$env:Path"; powershell -NoProfile -ExecutionPolicy Bypass -File scripts\check.ps1` passed locally with existing compiler/test warning noise only; latest merged baseline is PR #347 with CI run `27503447725`, jobs `81290377472` and `81290377482`, passed on final head `2f3447ae41ee9896622c921c0982be89ed2e8cff` before squash merge `25a792a43144231392e7cc7f017ec11882ae0f7f` |
| OS tested | Windows local validation for active reconciliation artifacts; Windows and Linux GitHub Actions passed for latest merged baseline PR #347 CI run `27503447725` on head `2f3447ae41ee9896622c921c0982be89ed2e8cff`, with merged baseline commit `25a792a43144231392e7cc7f017ec11882ae0f7f` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #347 CI run `27503447725`, Foundry smoke job `81290377472` and Windows PowerShell wrapper job `81290377482`, passed on head `2f3447ae41ee9896622c921c0982be89ed2e8cff`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4702188617`; merge-decision comment `4702224195`; PR #347 squash-merged as `25a792a43144231392e7cc7f017ec11882ae0f7f` |
