...
- Continue [`P1-META-006`](https://github.com/6529-Collections/6529Stream/issues/51):
  ...
  regressions without changing production bytecode.
...
- Complete the remaining render-safety work for full browser execution
  sandboxing, production raw-attribute enforcement, production invalid UTF-8
  enforcement, and production structured attributes or semantic attribute schema
  validation.
