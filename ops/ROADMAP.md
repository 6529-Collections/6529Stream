...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-12 13:13 UTC` after Queue Item 80 focused checks, release drift checks, Unix wrapper syntax, full `make check`, Windows wrapper validation, and whitespace checks |
| OS tested | Windows local; Linux CI pending for Queue Item 80 PR |
