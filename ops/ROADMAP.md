...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-15 03:08 UTC` on branch `codex/signer-compromise-fuzz`: full `scripts/check.ps1` local gate passed after adding ADV-003 signer compromise and revocation fuzz coverage; PR #376 merged as `ba83f54ca2ea952a62403a8b74faa09e11e150c7`; issue #217 remains open for real reviewed testnet deployment rehearsal evidence |
| OS tested | Local Windows PowerShell wrapper passed on branch `codex/signer-compromise-fuzz`; latest merged baseline PR #376 CI run `27520925937` passed on head `a4b695ddb24e3f0b102c7d85391c757a949f3d94`, including Windows PowerShell wrapper job `81338566247` and Foundry smoke job `81338566333` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #376 CI run `27520925937` passed on head `a4b695ddb24e3f0b102c7d85391c757a949f3d94`; CodeRabbit passed with no actionable comments; PR #376 squash-merged as `ba83f54ca2ea952a62403a8b74faa09e11e150c7`; issue #375 closed completed |
