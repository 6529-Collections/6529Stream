...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  release evidence metadata intake, retains pending-review mainnet-fork
  ...
  payload-generator examples, retained signing evidence template, and signer
  custody readiness template, and runs the local deployment and auction
  ceremony rehearsals. It still does not prove full protocol correctness.
- Known remaining production-readiness blockers include fork-level invariant
  baselines, review acceptance for pending fork deployment rehearsal retained
  evidence, live testnet rehearsals, production broadcast retention, live
  ...
  mainnet-fork deployment rehearsal broadcast, manifest, address book, and
  non-local evidence envelope are retained in `pending_review` state for issue
  #216; review acceptance, testnet rehearsals, production broadcast retention,
  live artifact verification, and fork/testnet/live ceremony evidence contents
  remain open.
...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 15:19 UTC` for active branch `codex/retain-fork-deployment-rehearsal-evidence`: focused fork broadcast/evidence checks, generated public-beta and tracker evidence checks, release-readiness/changelog/manifest/checksum checks, Python syntax compilation, whitespace check, and full Windows `scripts\check.ps1` passed locally after regenerating stale default Anvil broadcast-derived outputs; latest merged baseline remains PR #346 with CI run `27501729525`, jobs `81285737978` and `81285738002`, passed on final head `b70e9592fb6e54dff52ab9937a3b241004d06705` before squash merge `a35c24a4f3bcbf61db73c78f2e98822f09d17d59` |
| OS tested | Windows local validation and Windows GitHub Actions job for issue #345; Linux GitHub Actions passed for latest merged baseline PR #346 CI run `27501729525` on head `b70e9592fb6e54dff52ab9937a3b241004d06705`, with merged baseline commit `a35c24a4f3bcbf61db73c78f2e98822f09d17d59` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #346 CI run `27501729525`, jobs `81285737978` and `81285738002`, passed on head `b70e9592fb6e54dff52ab9937a3b241004d06705`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4702020821`; merge-decision comment `4702043390`; PR #346 squash-merged as `a35c24a4f3bcbf61db73c78f2e98822f09d17d59` |
...
- Add signed tags. Initial release signature evidence schema/checker records the
  ...
  requirements; actual production signed tags remain a future release ceremony
  output.
