...
| Randomness request lifecycle | Request records expose token, collection, provider, request ID, epoch, state, request time, and fulfillment time | `test/StreamRandomizerLifecycle.t.sol`, `test/StreamFixedPriceRandomizerComposition.t.sol` | Passing for VRF and arRNG request records, request state, request-to-token, token-to-request, token-to-collection, first-class token-level request/state views, empty token lookup, token-level stale lookup, requested block/time, fulfilled block/time, and derived seed storage. ADV-017 / issue #595 proves paid fixed-price drops preserve token/request binding across payment rollback, signer lifecycle controls, credit withdrawals before fulfillment, and later arRNG fulfillment through the composed drop/minter/core/randomizer path. | [`P0-RAND-001`](https://github.com/6529-Collections/6529Stream/issues/37), [`P0-RAND-002`](https://github.com/6529-Collections/6529Stream/issues/38), [`#595`](https://github.com/6529-Collections/6529Stream/issues/595) | Gate C/Gate D | TBD |
