...
- Known remaining P0 blockers include broader payment accounting and
  ...
  check, manifest parsing test, generated local address book, generated source
  verification input bundle, generated release manifest, and release checksum
  bundle, while fork/testnet rehearsals and broadcast-derived production
  artifact generation remain open.
...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-11 13:02 UTC` local source-verification PR candidate validation; CI TBD |
...
- ABIs, address books, deployment manifests, source verification inputs,
  checksums, and verified contract addresses are published.
