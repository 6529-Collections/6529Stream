...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 01:49 UTC` for Queue Item 138 / PR #288 live audit retention merge-state reconciliation; PR #288 local validation covered release-readiness, release manifest, release checksums, changelog, traceability, heading, and whitespace checks |
| OS tested | Windows local validation for Queue Item 138 / PR #288; Linux GitHub Actions passed for latest merged baseline PR #288 run `27484957096` on final head `30f5e865c885a209989a7f0dc45b675a094da0a3`, with merged baseline commit `5dfcce09f68d9e8e481efaf720af88c2d803c4f1` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #288 final CI run `27484957096` passed on head `30f5e865c885a209989a7f0dc45b675a094da0a3`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4700363421`, and PR #288 squash-merged as `5dfcce09f68d9e8e481efaf720af88c2d803c4f1` |
