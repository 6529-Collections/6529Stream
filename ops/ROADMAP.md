...
- The current smoke baseline builds the repo, runs Foundry tests, checks
  ...
  release evidence metadata intake, adds a template-only fork deployment
  rehearsal retained-artifact checker, checks the protocol incident-response
...
- Known remaining production-readiness blockers include fork-level invariant
  ...
  explorer verification, reviewed fork deployment rehearsal retained evidence,
  signed release artifacts, production governance
...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 14:13 UTC` for merged PR #344 Windows check-wrapper runtime harness baseline; local validation included executable PowerShell harness, focused wrapper policy, PowerShell parser, Makefile target, release manifest/checksum, changelog, artifact tests, py_compile, and whitespace checks; GitHub CI run `27501279202`, job `81284495028`, passed on final head `d303ad5bb340f35d5a438f5379cbe691f9d51534` before squash merge `fe378036ac4686d94ee8e4f926adadd30ebef385` |
| OS tested | Windows local validation for issue #343; Linux GitHub Actions passed for latest merged baseline PR #344 CI run `27501279202` on head `d303ad5bb340f35d5a438f5379cbe691f9d51534`, with merged baseline commit `fe378036ac4686d94ee8e4f926adadd30ebef385` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #344 CI run `27501279202`, job `81284495028`, passed on head `d303ad5bb340f35d5a438f5379cbe691f9d51534`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701972035` and review-finished reply `4701972232`; initial rate-limit warning comment `4701971874` produced no actionable findings; merge-decision comment `4702003701`; PR #344 squash-merged as `fe378036ac4686d94ee8e4f926adadd30ebef385` |
...
| Windows PowerShell 5.1 CI harness | The checked native-command wrapper harness runs in a lightweight `windows-latest` CI job under Windows PowerShell semantics without requiring the full Foundry gate | `.github/workflows/ci.yml`, `scripts/test_windows_check_helpers.ps1`, `scripts/windows-check-helpers.ps1`, `scripts/test_windows_check_wrapper.py`, `scripts/test_windows_ci_wrapper.py` | In Progress for issue #345: a lightweight Windows job is being added to parse the wrapper scripts and run the executable checked-native harness under Windows PowerShell, with a focused workflow-wiring policy test, while preserving the existing Ubuntu PowerShell Core gate. | [`#345`](https://github.com/6529-Collections/6529Stream/issues/345) | Gate A/Gate G | TBD |
...
| Fork deployment rehearsal retained artifact | Reviewed fork deployment rehearsal evidence must retain fork command output, fork block reference, sanitized broadcast, generated manifest, generated address book, verification status, gas or invariant summary, release digest references, and reviewer approval without secrets | `scripts/test_fork_deployment_rehearsal_evidence.py`, `scripts/check_fork_deployment_rehearsal_evidence.py`, `release-artifacts/evidence/fork-deployment-rehearsal/fork-deployment-rehearsal-retained-artifact-template.md`, `docs/non-local-release-evidence.md`, `scripts/test_release_evidence_packet_index.py` | Tracker support merged in PR #330 / issue #329 after merged PR #326 / issue #325 support: the repo has a template-only retained-artifact Markdown file, offline checker, focused tests, local/CI gate wiring, docs, release manifest coverage, checksum coverage, and generated tracker rows that point issue #216 at the canonical fork-specific retained-artifact template and checker/test commands instead of the generic public-beta retained-artifact placeholder. Final CI run `27497423363` passed on head `2bb2c74ccb97cc9ff286ccb282646adc6634c5d8`, CodeRabbit status was success after review-finished reply `4701604582`, and PR #330 squash-merged as `54a4e3913304df0222d971658b504e3043be8777`. A follow-up live tracker sync under issue #333 updated issue #216 from the committed body-sync payload and verified that issues #215 through #231 match the committed body-sync artifact. The committed template remains `blocked` and cannot complete issue #216 until real reviewed retained fork evidence replaces placeholder values, removes the template-only notice, passes the checker, generates non-local evidence metadata, and is linked from public-beta evidence. | [`#325`](https://github.com/6529-Collections/6529Stream/issues/325), [`PR #326`](https://github.com/6529-Collections/6529Stream/pull/326), [`#327`](https://github.com/6529-Collections/6529Stream/issues/327), [`PR #328`](https://github.com/6529-Collections/6529Stream/pull/328), [`#329`](https://github.com/6529-Collections/6529Stream/issues/329), [`PR #330`](https://github.com/6529-Collections/6529Stream/pull/330), [`#333`](https://github.com/6529-Collections/6529Stream/issues/333), [`#216`](https://github.com/6529-Collections/6529Stream/issues/216) | Gate E/Gate G | TBD |
| Fork deployment release artifact coverage | The fork deployment retained-artifact checker and template stay covered by local gates, CI, release manifest, checksum bundle, tooling docs, release-readiness docs, and generated evidence tracker issue payloads without changing readiness claims | `Makefile`, `scripts/check.sh`, `scripts/check.ps1`, `.github/workflows/ci.yml`, `scripts/generate_release_evidence_packet_index.py --check`, `scripts/generate_release_evidence_issue_backlog.py --check`, `scripts/generate_release_evidence_issue_body_sync.py --check`, `scripts/generate_release_manifest.py --check`, `scripts/generate_release_checksums.py --check`, `docs/tooling.md`, `docs/release-readiness.md`, `CHANGELOG.md` | Passing for tracker routing in PR #330 / issue #329 and live issue-body sync under issue #333: the packet-index generator has a fork-specific retained-artifact expectation override and regression coverage for the fork row path, digest, and checker/test commands; regenerated packet-index, issue-backlog, issue-body-sync, release-manifest, and checksum artifacts keep issue #216 pointed at the fork-specific retained artifact while preserving blocked readiness claims. PR #328 / issue #327 reconciled the PR #326 merge state after final CI run `27496787719`, CodeRabbit review-finished reply `4701540159`, merge-decision comment `4701560832`, and squash merge `49e2434e0699c989e89d7cfd20ac2a8726875123`; PR #330 final CI run `27497423363` passed on head `2bb2c74ccb97cc9ff286ccb282646adc6634c5d8`, CodeRabbit review-finished reply `4701604582` reported success, merge-decision comment `4701622391` recorded no actionable review threads, and squash merge `54a4e3913304df0222d971658b504e3043be8777` landed the tracker routing; issue #216 was then updated from `tmp/release-evidence-issue-bodies/issue-216.md`, fetched live as open, and a fresh issues #215 through #231 snapshot passed `python scripts/check_release_evidence_issue_bodies.py --live-json tmp\release-evidence-issue-bodies-live.json`. | [`#325`](https://github.com/6529-Collections/6529Stream/issues/325), [`PR #326`](https://github.com/6529-Collections/6529Stream/pull/326), [`#327`](https://github.com/6529-Collections/6529Stream/issues/327), [`PR #328`](https://github.com/6529-Collections/6529Stream/pull/328), [`#329`](https://github.com/6529-Collections/6529Stream/issues/329), [`PR #330`](https://github.com/6529-Collections/6529Stream/pull/330), [`#333`](https://github.com/6529-Collections/6529Stream/issues/333), [`P1-RELEASE-006`](https://github.com/6529-Collections/6529Stream/issues/105), [`P1-RELEASE-004`](https://github.com/6529-Collections/6529Stream/issues/101) | Gate E/Gate G | TBD |
