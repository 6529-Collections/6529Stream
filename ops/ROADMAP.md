...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-14 09:35 UTC` for current issue #320 vendored/provenance formatting exemption implementation; local validation includes focused formatting tests/checker, `make fmt-check`, terminology grep, changelog gate, release-readiness check, release artifact catalog check, release manifest check, release checksum check, and full Windows `scripts\check.ps1` |
| OS tested | Windows local validation for issue #320; Linux GitHub Actions passed for latest merged baseline PR #321 final CI run `27494219818` on head `8fb9c46480885d92904e7e72b5d8765e07db5a81`, with merged baseline commit `38e01759204ea5eb124c3a33a134221c15d16c8d` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #321 final CI run `27494219818` passed on head `8fb9c46480885d92904e7e72b5d8765e07db5a81`; CodeRabbit status was success with no unresolved review threads after explicit review request comment `4701285848` and review-finished reply `4701286066`; merge-decision comment `4701307625`; PR #321 squash-merged as `38e01759204ea5eb124c3a33a134221c15d16c8d` |
