...
| Field | Value |
| --- | --- |
| Last verified | `2026-06-15 04:45 UTC` on branch `codex/payment-forced-eth-invariants`: full `scripts/check.ps1` local gate passed after adding ADV-005 payment/forced-ETH invariant coverage, refreshing retained randomizer operations evidence, and regenerating deterministic release manifest/checksum artifacts; branch started from PR #379 squash merge commit `217a3b38ae5058f397da324d54a343439bc5b2c8`; issue #217 remains open for real reviewed testnet deployment rehearsal evidence |
| OS tested | Local Windows PowerShell wrapper passed on branch `codex/payment-forced-eth-invariants`; latest merged baseline PR #379 CI run `27523500886` passed on head `11a0b3a47d445ed90c8bb95abcf65b172d4106e7`, including Windows PowerShell wrapper job `81346089967` and Foundry smoke job `81346089983` |
| Foundry version | `v1.7.1` |
| Solidity compiler version | `0.8.19` |
| Slither version | `0.11.5` |
| CI run | Latest merged baseline PR #379 CI run `27523500886` passed on head `11a0b3a47d445ed90c8bb95abcf65b172d4106e7`; CodeRabbit status was success after the exact-revert follow-up, with no unresolved review threads; PR #379 squash-merged as `217a3b38ae5058f397da324d54a343439bc5b2c8`; issue #378 closed completed. Current branch CI is pending until PR creation |
