...
| `encode-packed-collision` | 1 | `StreamDrops` | `retrieveMessageAndDropID(address,address,string,uint256,uint256,uint256,uint256)` | first-party | `smart-contracts/StreamDrops.sol#L235-L257` | High | High | Open | Replace ad hoc packed hashing with typed EIP-712 authorization | Replay, wrong-domain, and collision tests | [`P0-AUTH-002`](https://github.com/6529-Collections/6529Stream/issues/10) | Gate C | TBD |
| `encode-packed-collision` | 1 | `StreamDrops` | `mintDrop(address,address,string,uint256,uint256,uint256,uint256)` | first-party | `smart-contracts/StreamDrops.sol#L81-L146` | High | High | Open | Replace ad hoc packed hashing with typed EIP-712 authorization | Replay, wrong-domain, and collision tests | [`P0-AUTH-002`](https://github.com/6529-Collections/6529Stream/issues/10) | Gate C | TBD |
...
| `uninitialized-local` | 1 | `StreamDrops` | `mintDrop(...).tokenid` | first-party | `smart-contracts/StreamDrops.sol#L108` | Medium | Medium | Open | Initialize local before use or prove Solidity zero-value intent with tests/docs | Targeted regression for affected function | [`P0-INIT-001`](https://github.com/6529-Collections/6529Stream/issues/15) | Gate C | TBD |
