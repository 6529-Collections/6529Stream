...
source-specific evidence. At `5310fc7b`, all 2,381 Solidity sources pass
ABI/type/storage checks. Root passes 1,044 client cases and separate Museum
...
Newly joined record hydration (`75ad082d`) and adjudication V2 (`5310fc7b`)
retain independent source reviews and authored runtime recipes. Three joined
Artist hosts exceed EIP-170 (24,919 / 24,938 / 25,760 bytes); repair is active.
Explicit entropy policy (`e7b509ca`) is source-integrated; terminal sale handling
(`2e3744a6`) passes thirteen focused tests and 256 fuzz inputs with typed
surrounding contracts. Current citations (`84c69bc3`) have ten isolated codec
passes and separately authored current admission/history cases. Museum
mint/entropy (`1216379d`) and RIGHTS (`5975396a`) add 41 and 31 root passes.
Native publication12 still has five passes/four failures under original limits.
These scopes do not add up to a complete-system test count.

One-way phase FreezePolicy is source-integrated (`0ab60204`): 23 focused tests
pass, with final selected Manager/fallback sizes 24,396/24,513. Actual-current
governance and continuity execution remain pending. Active/cancelled-notice
recovery and original-living multiple-Artist hydration are source-integrated;
the original-living delegation profile (`48754d47`) now repairs the new
Identity/Coordinator size overruns at its exact source. All eighteen selected
products fit, but joined-source sizing and native acceptance remain. Older
Artist/Router/Estate blockers remain.

The actual staged-publication retry completed five passes and four failures.
Preparation fits the original transaction limit, but the final publication call
...
and fits four affected products. Actual publisher native11 closes five passes
and four failures: both carrier verifications finish, but the host tail remains
over gas. The integrated record-preimage repair (`822b0dc7`) has five focused passes;
full publication acceptance remains open. Fourteen current gate/Safe recipes,
...
archival/finality joins continue. Exact held patches remain unapplied.
...
capture and actual Safe workflow execution remain separate. Original operation60
clients (`ad74286b`) plus dedicated ERC-20 burn warnings (`3879d3e1`) now pass
991 root package tests and the ABI67 hydration fixture check. Museum native
citations/gathering (`79339af6`) adds47 root passes; the 19-item packet index
keeps incomplete evidence explicit. Combined Artist delegation hydration
(`588341d2`,14 reviewed cases), staging-family recovery (`6544ff47` plus
`1647c5c0`,18 reviewed cases), and current STATIC/Safe lifecycle (`2d7b4f25`,
five reviewed cases) are source-integrated; native execution is pending.

Latest-stack Safe/fuzz/gas/CI acceptance, source freeze and matching new testnet
evidence are still required. Seven inactive clean worktrees were removed with
all named branches preserved; no active task or release evidence was removed.
...
| [ART34](#art34-evidence) Migration of multiple identities, collaborators and corrected binding generations | In progress | Tests written | Not integrated | Original-living generation-1 PRIMARY_ONLY multiple-Artist/multiple-collection hydration is source-integrated (`8cc47857`) with ten reviewed actual-owner/Safe cases. Complete per-Artist guards and seven-owner/Archive atomicity are preserved. The delegation successor (`48754d47`) repairs those new size overruns at its exact source; all eighteen selected products fit. Combined multiple-Artist delegation (`588341d2`) adds fourteen reviewed actual-owner/Safe recipes with complete global journal and grant-use accounting. Complete original living record combinations (`75ad082d`) now include exhaustive economics/attestation witnesses and atomic seven-owner imports, with twenty independently reviewed authored cases. **Remaining:** Joined-source sizing, native acceptance, mixed record-family combinations, collaborator graphs, corrected/rebound generations, attribution disputes and Platform correction histories. |
| [ART35](#art35-evidence) Migration of delegated, rotated, estate, dormancy and recovered authority | In progress | Tests written | Not integrated | Original-living delegation/consent migration is source-integrated (`48754d47`), with complete journals, grant revisions, historical consent associations, both nonce kinds and atomic seven-owner/Archive import. Ten actual-owner/Safe cases are authored and independently reviewed. Combined multiple-Artist delegation (`588341d2`) adds fourteen reviewed actual-owner/Safe recipes with complete global journal and grant-use accounting. Complete original living record combinations (`75ad082d`) now include exhaustive economics/attestation witnesses and atomic seven-owner imports, with twenty independently reviewed authored cases. **Remaining:** Native acceptance, advanced delegated-record combinations and authority-transition profiles, provisional/guardian/closure/vesting/supersession histories and their composition. No readiness from partial imports. |
...
| Feature | Build | Tests | Integration | Scope and remaining work |
| --- | --- | --- | --- | --- |
| [entropy.policy](#entropypolicy-evidence) Explicit entropy policy, freeze and non-random token states | Built | Partly tested | Partial | Artist-consented DISABLED and ASYNC REQUIRED/NOT_REQUIRED source is integrated as `e7b509ca`, with29 authored cases. Shared terminal sale helper `2e3744a6` passes13 focused tests and256 fuzz inputs against typed boundaries. **Remaining:** Actual current/Safe execution, direct STATIC reads and complete render/finality/commerce joins; policy succession. |
| [entropy.instant](#entropyinstant-evidence) LOW_SECURITY synchronous provider requests after mint | In progress | Not tested | Not integrated | Mint builder implements the specified bounded STATICCALL provider profile, delayed request timing, explicit low-security disclosure and original request/seed domains without mint-commitment influence. **Remaining:** Coherent source integration, consumers, native tests, sizes and matching release evidence. This is an existing full-v1 requirement made explicit here. |
...
Source `e7b509ca` and `2e3744a6`; native evidence is scoped as stated above.

### entropy.instant evidence

Required by [EC-INSTANT and EC-CONFIG](../docs/stream-entropy-coordinator.md).
Implementation is active on the Mint branch; no integrated/runtime acceptance
is inferred from that work in progress.
