...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `fdb36e3f`: preservation repair `402bad28`, Artist phase5 `da61ee5f`, native Museum formats `fdb36e3f`; full source ABI201. Runtime evidence stays source-specific. |
...
| Latest broad cheap compilation evidence | ABI201: 4,631 sources at `fdb36e3f`, zero errors in 55.953s; types/interfaces/storage/method IDs only. |
