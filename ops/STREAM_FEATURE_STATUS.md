...
Recovered consent multiplicity, seven preservation capacity repairs, Museum
semantic/script exports, the multiple-Artist client and the caller-baseline
extraction are source integrated. Activation11 and baseline6 focused cases now
execute and pass. Museum semantic34 and script/dependency58 root cases pass;
client build/types and new schema-cache regressions pass.

Fresh native builds qualify983 library products plus243 authenticated reusable
products;29 oversized preservation helpers were found in refused contexts.
Seven reviewed repairs are integrated, with all remaining repairs assigned.
Compilation counts are not feature completion or executed-test counts.

[Current delivery status](V1_CURRENT_STATUS.md) records exact source and test
boundaries. Remaining work includes full feature composition, actual current
graph/Safe execution, stateful/fuzz, gas/size/CI, freeze and testnet. RC1 is preserved.
...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `b546af9ffd059b7ecd5343c20884408b35d45a41`; production `3d634a3f`. Existing native/runtime campaign remains fixed at `ea4cf6b0`. |
...
| Latest broad cheap compilation evidence | ABI170:4,205 sources at `b546af9f`, zero errors in49.984s, exact committed-source bridge; type/ABI/storage/method IDs only. |
