...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `a0f6535aa3fabd3374aae30b9de5c5ec60be4147`; four reviewed handoffs integrated after the original full inventory at `b2fc0c3cbcee85fb42c90db2d697653788df3706` |
...
| Latest broad cheap compilation evidence | 1,808-source ABI/type check passes at `a0f6535a`; this is not a runtime test |
...
| [ART06](#art06-evidence) Attribution dispute, counterstatement, resolution, revocation and repudiation | In progress | Not tested | Not integrated | Canonical operations44–50: open dispute; counterstatement; arbiter resolution; artist revocation; independently vetoable delayed repudiation/cancel/execute. **Remaining:** No corresponding production function occurs in current smart-contracts. Binding refusal/withdrawal, identity compromise, permissionless claims and Platform contests are distinct and do not supply this workflow. |
...
| [ART09](#art09-evidence) Delegation grant, revoke and authenticated delegated writes | Built | Tests written | Not integrated | Delegation grant/revoke and supported attestation, economics, royalty-freeze and intent capabilities exist. **Remaining:** ARTIST_DELEGATED policy/sale-consent mode is missing ART42; DISPUTE capability is being added with operations 44–46. Full latest delegated Safe execution remains pending. |
...
| [MUSEUM-07](#museum-07-evidence) Independent collection views host | In progress | Not tested | Not integrated | Adopted StreamCollectionViews surface is named by the specification; no concrete CollectionViews implementation was found in the current contract source. Core collection identity views and MetadataRouter reads are different surfaces. **Remaining:** Implement the specified view host, authority/current-selection behavior and actual integration; root should reconcile any separately owned unmerged implementation. |
