...
Reviewed repairs for ten Artist and two scoped-policy size failures, both
isolated preservation compiler errors, governance/role clients and the51-document
Museum reader are integrated. Original Provider12 actually passes at frozeneda,
with independent native/caller trace checks; root governance client78 and Museum23
focused cases pass at their recorded sources. Full current graph is unaccepted.
Large test-host timeouts led to concrete test-only construction changes; no
