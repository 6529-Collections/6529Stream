...
source-specific evidence. At `822b0dc7`, all 2,329 Solidity sources pass
ABI/type/storage checks. Root passes 991 client cases and separate Museum
...
| [ART34](#art34-evidence) Migration of multiple identities, collaborators and corrected binding generations | In progress | Tests written | Not integrated | Original-living generation-1 PRIMARY_ONLY multiple-Artist/multiple-collection hydration is source-integrated (`8cc47857`) with ten reviewed actual-owner/Safe cases. Complete per-Artist guards and seven-owner/Archive atomicity are preserved. The delegation successor (`48754d47`) repairs those new size overruns at its exact source; all eighteen selected products fit. Combined multiple-Artist delegation (`588341d2`) adds fourteen reviewed actual-owner/Safe recipes with complete global journal and grant-use accounting. **Remaining:** Joined-source sizing, native acceptance, mixed record-family combinations, collaborator graphs, corrected/rebound generations, attribution disputes and Platform correction histories. |
| [ART35](#art35-evidence) Migration of delegated, rotated, estate, dormancy and recovered authority | In progress | Tests written | Not integrated | Original-living delegation/consent migration is source-integrated (`48754d47`), with complete journals, grant revisions, historical consent associations, both nonce kinds and atomic seven-owner/Archive import. Ten actual-owner/Safe cases are authored and independently reviewed. Combined multiple-Artist delegation (`588341d2`) adds fourteen reviewed actual-owner/Safe recipes with complete global journal and grant-use accounting. **Remaining:** Native acceptance, advanced delegated-record combinations and authority-transition profiles, provisional/guardian/closure/vesting/supersession histories and their composition. No readiness from partial imports. |
