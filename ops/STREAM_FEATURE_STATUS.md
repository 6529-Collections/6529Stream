...
source-specific evidence. At `22e90a3b`, all 2,279 Solidity sources pass
ABI/type/storage checks. Root passes 836 client cases and separate Museum
...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `22e90a3b30c2c321ce0896b51a164608233fb0a7`; see the [20 September batch](#latest-integration-checkpoint-20-september) for bounded evidence and remaining joins |
...
| Latest broad cheap compilation evidence | 2,279-source ABI/type/storage pass at `22e90a3b` in20.906 seconds. Historical ABI52 and additive mode-2 ABI56 remain explicitly client-pinned; neither establishes whole-system runtime acceptance. |
