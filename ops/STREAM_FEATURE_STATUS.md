...
source-specific evidence. At `6ad73f77`, all 2,421 Solidity sources pass
...
and a later supplement failure under diagnosis. Whole-flow acceptance remains open.
...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `6ad73f778b1d4b600853bab38347072dacb278ac`; see the [20 September batch](#latest-integration-checkpoint-20-september) for bounded evidence and remaining joins |
...
| Latest broad cheap compilation evidence | 2,421-source ABI/type/storage pass at `6ad73f77` in23.391 seconds (ABI80). Historical ABI52 and additive mode-2 ABI56 remain explicitly client-pinned; neither establishes whole-system runtime acceptance. |
...
| [quality.capacity](#qualitycapacity-evidence) Full-system gas, deployment size and transaction capacity | In progress | Partly tested | Partial | Exact joined Artist repair `6d3e55df` fits all11 selected products; Registry24,018/Coordinator24,333/Identity24,179 runtime bytes. Commerce `128c8378` fits all52 captured production products; terminal consumers fit11 selected products. **Remaining:** Its native graph still has Router44,008 runtime/49,781 init; other held Attribution/Identity-deployment/Estate blockers remain. Native publication13 is5PASS/4FAIL: publication now fits15,664,912 including intrinsic, but a later supplement failure remains. Actual-current18 is held at known Router size preflight; a mechanical repair is being designed. Complete latest graph, cold gas, ceremonies and transaction limits remain. |
