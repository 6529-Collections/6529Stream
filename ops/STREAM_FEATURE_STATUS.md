...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `b1bd2bae2e89cbfdcb985f648e3bc72e4bb3b2ca`; see the [21 September batch](#latest-integration-checkpoint-21-september). |
...
| Latest broad cheap compilation evidence | ABI166: 4,121 sources at `b1bd2bae`, zero errors in 49.969 seconds; complete committed-source bridge. This is not runtime acceptance. |
