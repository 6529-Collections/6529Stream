...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `45828ad0db2a6d52c6b0c7aad8d25dd4ba866c65`; latest ABI178 `d823d82c`; broad runtime anchor `aa2ca4a2` excludes later generation source. |
...
| Latest broad cheap compilation evidence | ABI178: 4,321 sources at `d823d82c`, zero errors in 51.046s; types/interfaces/storage/method IDs only. |
