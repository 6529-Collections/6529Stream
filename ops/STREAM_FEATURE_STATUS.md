...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `98fcd45f232c3fa0d3360adc871153ebb7c530bd`; see the [20 September batch](#latest-integration-checkpoint-20-september) for bounded evidence and remaining joins |
...
| Latest broad cheap compilation evidence | 2,574-source ABI/type/storage pass at `98fcd45f` in 24.593 seconds (ABI96). Historical ABI52 and additive mode-2 ABI56 remain explicitly client-pinned; neither establishes whole-system runtime acceptance. |
