...
(`7a274c04`) add 27 authored cases. All 2,185 sources pass ABI/type/storage
checks at `770ccea5`. Complete activation, transitive STATIC analysis and
combined runtime acceptance remain open. The real publisher capacity run
continues separately from earlier inventory/environment probes.
...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `770ccea545fe703c996bc81920b093aa44037887`; see the [20 September batch](#latest-integration-checkpoint-20-september) for source-specific evidence and remaining joins |
