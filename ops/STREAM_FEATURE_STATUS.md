...
source-specific evidence. At `29cd8b2d`, all 2,251 sources pass ABI/type/storage
checks. Root passes 806 client cases, 47 related C2PA/catalog cases and 53
...
Registry native passes remain separate from actual Artist/STATIC admission.

The integrated source now includes standing C2PA conflicts, genuine C2PA
composition/read plans, recovered-living dormancy histories, delegated Manager
consent and mint-grace clients. The final selected Manager/fallback runtimes
...
| Item | Snapshot / state |
| --- | --- |
| Current integration source | `29cd8b2d10aa37d5d62ba91a4de994d2456e6c4c`; see the [20 September batch](#latest-integration-checkpoint-20-september) for bounded evidence and remaining joins |
...
| Latest broad cheap compilation evidence | 2,251-source ABI/type/storage pass at `29cd8b2d` in20.391 seconds. Historical ABI52 and additive mode-2 ABI56 remain explicitly client-pinned; neither establishes whole-system runtime acceptance. |
...
| [MUSEUM-27](#museum-27-evidence) PREMIS file/fixity facts and recorded source adapter | Built | Tested* | Integrated* | Original pinned PREMIS3 schema, exact file IDs/size/digest/format and correspondence from selected registered source facts. Missing fields yield explicit unsupported diagnostics. Direct native-catalog retained-file projection (`a69c377e`) adds exact supplied-byte measurements and complete replay; 53 root cases pass. **Remaining:** General source/authority coverage and actual institutional capture; local measurements do not invent historical fixity events. |
