// Retain the exact original ABI129 historical scoped finality source. Never invoke Solidity.
...
const contracts = {
  ...
  "canonicalFinality": "IStreamCanonicalArtworkFinality",
  "scopeEvidence": "IStreamFinalityScopeEvidence",
  "preparedScopeEvidence": "IStreamFinalityPreparedScopeEvidence",
  "preparedSanctionReview": "IStreamFinalityPreparedSanctionReview",
  "sanctionReview": "IStreamFinalitySanctionReview",
  "currentComponentRoutes": "IStreamFinalityCurrentComponentRoutes",
  "finalityDiscoveryInterface": "IStreamArtworkFinalityDiscovery",
  "scopedFinalityDiscoveryInterface": "IStreamArtworkScopedFinalityDiscovery",
  "nonSanctionDiscovery": "IStreamNonSanctionFinalityDiscovery",
  "finalityComponent": "IStreamArtworkFinalityComponent",
  "coreFinalityAdapter": "StreamCoreFinalityAdapter",
  "coreFinalityAdapterInterface": "IStreamCoreFinalityAdapter",
  "servingHostAdapter": "StreamFinalityServingHostAdapter",
  "servingHostAdapterInterface": "IStreamFinalityServingHostAdapter",
  "sanctionReads": "IStreamFinalitySanctionReads",
  "metadataReads": "IStreamFinalityMetadataReads",
  "sanctionPreparation": "IStreamArtistSanctionPreparation",
  "sanctionReviewPreparation": "IStreamArtistSanctionReviewPreparation",
  "sanctionArchive": "IStreamFinalitySanctionArchive",
  "sanctionArchiveFacts": "IStreamArtistSanctionArchiveFacts",
  "executor": "StreamGovernanceExecutor",
  "governanceReads": "IStreamGovernanceReads",
  "roleRegistry": "StreamRoleRegistry",
  "executorInterface": "IStreamGovernanceExecutor",
  "governanceExecution": "IStreamGovernanceExecution",
  "governanceActionFacts": "IStreamGovernanceActionFacts",
  "governanceCatalog": "IStreamGovernanceCatalog",
  "roleRegistryInterface": "IStreamRoleRegistry",
  "coreFinalitySource": "IStreamCoreFinalitySource",
  "finalityGovernanceAuthority": "IStreamFinalityGovernanceAuthority"
};
...
const libraryContracts = {
  ...
  "scopedFinalityInputManifestReads": "StreamScopedFinalityInputManifestReads",
  "scopedFinalityInputManifestSchemas": "StreamScopedFinalityInputManifestSchemas",
  "finalityHashes": "StreamFinalityHashes",
  "finalityPreparation": "StreamFinalityPreparation",
  "finalityGovernanceWitness": "StreamFinalityGovernanceWitness",
  "finalitySanctionArchive": "StreamFinalitySanctionArchive",
  "finalityRecordState": "StreamFinalityRecordState",
  "finalityScopedPolicyProviderReadsV2": "StreamFinalityScopedPolicyProviderReadsV2",
  "finalityScopedPolicyProviderOperationsV2": "StreamFinalityScopedPolicyProviderOperationsV2",
  "finalityScopedPolicyProviderMetadataV2": "StreamFinalityScopedPolicyProviderMetadataV2",
  "finalityScopedPolicySanctionReviewV2": "StreamFinalityScopedPolicySanctionReviewV2",
  "finalityScopedPolicyDiscoveryFactoryReadsV2": "StreamFinalityScopedPolicyDiscoveryFactoryReadsV2",
  "finalityProfileSourceReads": "StreamFinalityProfileSourceReads",
  "governanceBootstrap": "StreamGovernanceBootstrap"
};
const documents = [
  ...
  "docs/integrations/finality-input-manifests.md",
  "docs/integrations/native-finality-provider.md",
  "docs/integrations/multi-scope-finality-provider.md",
  "docs/integrations/policy-finality-provider-v2.md",
  "docs/integrations/profile-finality-discovery.md",
  "docs/integrations/fixed-finality-discovery.md",
  "docs/integrations/finality-router-evidence.md",
  "docs/finality-host-adapters.md",
  "docs/adr/0004-admin-governance.md",
  "docs/adr/0020-executor-only-finality-recovery.md",
  "docs/schemas/finality/scoped-input-manifest-v1.definition.json",
  "docs/schemas/finality/scoped-input-manifest-abi-v1.definition.json",
  "docs/schemas/finality/sanction-archive-v1.schema.json",
  "docs/schemas/finality/sanction-archive-abi-v1.json",
  "docs/schemas/finality/sanction-ceremony-v1.schema.json",
  "docs/schemas/finality/sanction-ceremony-jcs-v1.json",
  "artifacts/scoped-policy-finality-v2.md"
];
...
export function scopedPolicyFinalityV2Fixture(inputBytes, outputBytes, bridgeBytes) {
  ...
  if (input.language !== "Solidity" || Object.keys(input.sources ?? {}).length !== 3262
    || output.errors?.some(error => error.severity === "error")) throw Error("Invalid historical scoped policy finality V2 capture");
  ...
  return {
    schemaVersion: 1,
    profile: "scoped-policy-finality-v2",
    ...
    qualification: "Source/ABI and mocked client evidence for the historical original ABI129 scoped-policy finality profile at 896899f7. This closed profile uses actual selected TOKEN, RELEASE and SEASON STATIC ONCHAIN source-locked Artist evidence, genuine Provider/Discovery bindings and the original Registry. Provider and Discovery have no post-constructor mutators. Canonical scoped manifest bytes, current admission and immutable stored history remain separate. Manifest staging is permissionless; archived finalization executes only through the canonical original Executor class-2 singleton call. Direct wallet finalization and retired local lifecycle/preview methods do not establish readiness. Original per-call and aggregate governance transitions, sanction archive evidence and retained historical manifest/core/component commitments stay distinct. Unsupported newer current-authority, preservation and VIEW profiles are rejected. No actual native/Safe execution, runtime provenance, rollback, gas/capacity, release or deployment acceptance is established by this fixture.",
...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  if (!input || !output || !bridge || mode !== undefined && mode !== "--check") {
    throw Error("Usage: generate-current-scoped-policy-finality-v2-fixture.mjs INPUT OUTPUT COMMITTED_SOURCE_BRIDGE [--check]");
  }
  const rendered = JSON.stringify(scopedPolicyFinalityV2Fixture(await readFile(input), await readFile(output), await readFile(bridge)), null, 2) + "\n";
  const target = new URL("../test/fixtures/current-scoped-policy-finality-v2-abi.json", import.meta.url);
  if (mode === "--check") {
    if (await readFile(target, "utf8") !== rendered) throw Error("Stale historical scoped policy finality V2 fixture");
    process.stdout.write("Historical scoped policy finality V2 fixture matches\n");
  } else {
    await writeFile(target, rendered, "utf8");
    process.stdout.write("Historical scoped policy finality V2 fixture written\n");
  }
}
