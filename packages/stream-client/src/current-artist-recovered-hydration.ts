...
export function artistRecoveredHydrationOwnerDomain(index: ArtistHydrationOwnerIndex): Hex {
  return id(`domain:${ownerNames[owner(index)]}`) as Hex;
}

export function artistRecoveredHydrationOwnerTag(index: ArtistHydrationOwnerIndex): Hex {
  return id(`6529STREAM_ARTIST_RECOVERED_${tagNames[owner(index)]}_STATE_V1`) as Hex;
}

export function normalizeArtistRecoveredHydrationCoordinates(
...
export function normalizeArtistRecoveredHydrationCapability(
...
export function validateArtistRecoveredHydrationCapability(
  value: ArtistRecoveredHydrationCapability,
  ...
  if (c.profile !== ARTIST_RECOVERED_HYDRATION_PROFILE || c.version !== 1n || c.ownerIndex !== BigInt(index)
    ...
    || (requiredFeatures & ~255n) !== 0n || (requiredFeatures & c.supportedFeatures) !== requiredFeatures) {
...
export function normalizeArtistRecoveredHydrationRequestDraft(
...
export function normalizeArtistRecoveredHydrationRequest(
  value: ArtistRecoveredHydrationRequest,
): ArtistRecoveredHydrationRequest {
...
export function encodeArtistRecoveredHydrationRequest(value: ArtistRecoveredHydrationRequest): Hex {
  return encode([ARTIST_RECOVERED_HYDRATION_REQUEST_TUPLE], [normalizeArtistRecoveredHydrationRequest(value)]);
}

export function decodeArtistRecoveredHydrationRequest(raw: Hex): ArtistRecoveredHydrationRequest {
  return normalizeArtistRecoveredHydrationRequest(decode(ARTIST_RECOVERED_HYDRATION_REQUEST_TUPLE, raw));
}

export const CURRENT_ARTIST_RECOVERED_HYDRATION_ABI = Object.freeze([
...
export const ARTIST_RECOVERED_HYDRATION_CAPABILITY_ID = registryInterface.getFunction("hydrateRecoveredArtistAuthority")!.selector as Hex;

export function prepareArtistRecoveredHydrationCall(
  registry: Address,
  caller: Address,
...
export function normalizeArtistRecoveredHydrationCall(value: ArtistRecoveredHydrationCall): ArtistRecoveredHydrationCall {
...
export function normalizeArtistRecoveredHydrationOriginEnvironment(
...
export function artistRecoveredHydrationOriginHash(value: ArtistRecoveredHydrationOriginEnvironment): Hex {
...
export function artistRecoveredHydrationReplayKey(
...
export function normalizeArtistRecoveredHydrationOwnerProvenance(
...
export function artistRecoveredHydrationOwnerProvenance(
...
export function normalizeArtistRecoveredHydrationProvenance(
  value: ArtistRecoveredHydrationProvenance,
...
export function artistRecoveredHydrationProvenanceHash(value: ArtistRecoveredHydrationProvenance): Hex {
...
export function artistRecoveredHydrationOwnerProvenanceHash(
  value: ArtistRecoveredHydrationOwnerProvenance,
  index: ArtistHydrationOwnerIndex,
): Hex {
...
export function artistRecoveredHydrationAliasesHash(
...
export function compareArtistRecoveredHydrationPoints(
...
export function normalizeArtistRecoveredHydrationNonceInventory(
...
export function normalizeArtistRecoveredHydrationPublications(
...
export function normalizeArtistRecoveredHydrationOwnerPayload(
...
function validateHeader(
  ...
  if (h.profile !== ARTIST_RECOVERED_HYDRATION_PROFILE || h.version !== 1n || h.ownerIndex !== BigInt(index)
    ...
    || (h.requiredFeatures & ~255n) !== 0n || h.eraCount > 1n && (h.requiredFeatures & 16n) === 0n) {
    throw Error("Owner header differs from complete payload");
  }
}

export function encodeArtistRecoveredHydrationOwnerPayload(
  value: ArtistRecoveredHydrationOwnerPayload,
  index: ArtistHydrationOwnerIndex,
  requiredFeatures: bigint,
): Hex {
...
export function decodeArtistRecoveredHydrationOwnerPayload(
  raw: Hex,
  index: ArtistHydrationOwnerIndex,
...
export function normalizeArtistRecoveredHydrationTimingCheckpoint(
...
export function normalizeArtistRecoveredHydrationExternalGuards(
...
export function normalizeArtistRecoveredHydrationPrepared(
...
export function encodeArtistRecoveredHydrationPrepared(value: ArtistRecoveredHydrationPrepared): Hex {
...
export function decodeArtistRecoveredHydrationPrepared(raw: Hex): ArtistRecoveredHydrationPrepared {
...
export function artistRecoveredHydrationSemanticInventory(value: ArtistRecoveredHydrationPrepared): Hex {
...
export function artistRecoveredHydrationCommitment(
...
export function encodeArtistRecoveredHydrationProfileEvidence(
  request: ArtistRecoveredHydrationRequest,
  prepared: ArtistRecoveredHydrationPrepared,
): Hex {
  const r = normalizeArtistRecoveredHydrationRequest(request);
...
export function decodeArtistRecoveredHydrationProfileEvidence(raw: Hex): ArtistRecoveredHydrationProfileEvidence {
  const input = bytes(raw);
...
export const ARTIST_RECOVERED_HYDRATION_PREPARE_SELECTOR = "0x72c84763" as Hex;
export const ARTIST_RECOVERED_HYDRATION_PREPARE_ABI = Object.freeze([
...
export function artistRecoveredHydrationPreparationCalldata(
...
export function normalizeArtistRecoveredHydrationEvidenceDescriptor(
...
export function artistRecoveredHydrationEvidenceDescriptor(payload: Hex): ArtistRecoveredHydrationEvidenceDescriptor {
...
export function artistRecoveredHydrationEvidencePages(payload: Hex): readonly Hex[] {
  const raw = bytes(payload);
...
export function assembleArtistRecoveredHydrationEvidence(
...
export function artistRecoveredHydrationPageId(
  coordinates: ArtistRecoveredHydrationCoordinates,
  commitment: Hex,
  descriptor: ArtistRecoveredHydrationEvidenceDescriptor,
  index: bigint,
...
export function artistRecoveredHydrationEvidenceId(
  coordinates: ArtistRecoveredHydrationCoordinates,
  actor: Address,
  commitment: Hex,
): Hex {
...
export function encodeArtistRecoveredHydrationEvidenceCarrier(descriptor: ArtistRecoveredHydrationEvidenceDescriptor): Hex {
...
export function decodeArtistRecoveredHydrationEvidenceCarrier(raw: Hex): ArtistRecoveredHydrationEvidenceDescriptor {
  const input = bytes(raw);
...
export function encodeArtistRecoveredHydrationOperationEvidence(
...
export function decodeArtistRecoveredHydrationOperationEvidence(
  raw: Hex,
  maximumBytes = 24_575,
...
export function artistRecoveredHydrationOwnerReplayDelta(
...
export function artistRecoveredHydrationOwnerAfter(
  destination: ArtistRecoveredHydrationOriginEnvironment,
  index: ArtistHydrationOwnerIndex,
...
export function artistRecoveredHydrationRequiredFeatures(value: ArtistRecoveredHydrationFeatureFacts): bigint {
