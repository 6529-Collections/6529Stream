...
- CI run or operator transcript: `local transcript captured 2026-06-14T14:39Z; PR #347 CI run 27503447725 passed; PR #349 CI run 27504228132 passed; StreamMintManager PR review pending for changed CON-014 artifacts`
...
- Sanitized Foundry broadcast: `deployments/broadcasts/fork-mainnet-6529stream-v0.1.0-001-run-latest.json` / `sha256:a9a04e7770b59b4cf4b94921040684b48f3735e997adf07a9edb4e418925bf33`
- Generated deployment manifest: `deployments/examples/fork-mainnet-6529stream-v0.1.0-001-broadcast.json` / `sha256:b75d7a207fbf2fa7b4fceae1f45fe418d536c30a476f760a9c165a3ebfc58ba8`
- Generated address book: `deployments/address-books/fork-mainnet-6529stream-v0.1.0-001-broadcast.json` / `sha256:f27a73fe36514a539b6528813d877232bcc4b3c31e8bc242a26647013caa104b`
...
- Reviewer: `pending StreamMintManager PR review; historical CodeRabbit status success on PR #347 and PR #349`
...
- The public-beta requirement row remains `pending` until the changed CON-014
  deployment manifest and address book are reviewed in the StreamMintManager
  PR. Public beta as a release phase remains blocked on the remaining missing
  evidence rows in the shared evidence manifest.
