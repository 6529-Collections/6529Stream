...
| Primary settlement tests | [`test/StreamPrimarySaleSettlement.t.sol`](../../test/StreamPrimarySaleSettlement.t.sol) | Resolver precedence, template materialization, exact native/ERC-20 settlement, policy drift, replay, and adversarial asset behavior |
