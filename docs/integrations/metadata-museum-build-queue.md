# Metadata, records, and museum build queue
...
| 6 | Complete museum schema/profile source coverage and authoring workflow | Work through MUSEUM-01–40 and all MSM gate families; confirmation and later-edit continuity | Required queue |
...
in scope. Synthetic adapter tests are not actual publication/capture or institutional
acceptance. Shared Core/governance/Artist/revenue changes are coordinated before
editing; feature-owned producer code proceeds independently where possible.

No duplicate full native compilation, chain startup, broadcast, or release-artifact
refresh belongs to this build queue while the integrator owns the frozen campaign.
Source review and focused ABI/Python tests accompany coherent handoffs; combined
runtime, deployability, complete genesis inventory and operational acceptance
