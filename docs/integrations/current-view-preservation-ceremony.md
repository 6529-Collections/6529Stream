...
now includes the source-authored sanction/archive/finalization sequence.
Execution of that sequence and complete current-source acceptance remain required.
