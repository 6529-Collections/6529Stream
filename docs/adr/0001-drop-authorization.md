...
| Affected contract | `smart-contracts/domains/mint/legacy/StreamDrops.sol` |
| Work type | `DESIGN` |
...
- `smart-contracts/domains/mint/legacy/StreamDrops.sol#L58-L61`: `authorized` requires
  `msg.sender == tdhSigner`.
- `smart-contracts/domains/mint/legacy/StreamDrops.sol#L81-L146`: `mintDrop` accepts an explicit
  recipient, computes a packed drop ID, marks it executed, pushes fixed-price
  ETH, mints, and stores execution state.
- `smart-contracts/domains/mint/legacy/StreamDrops.sol#L92-L104`: drop ID is derived from
  `abi.encodePacked` string fragments including the explicit recipient.
- `smart-contracts/domains/mint/legacy/StreamDrops.sol#L105-L106`: replay prevention is keyed only by
  `dropExecuted[dropId]`.
- `smart-contracts/domains/mint/legacy/StreamDrops.sol#L113-L144`: fixed-price recipient and stored
...
- `smart-contracts/domains/mint/legacy/StreamDrops.sol#L235-L257`:
