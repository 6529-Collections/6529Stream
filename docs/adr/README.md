...
| [`0018-batch-operation-root-and-token-identity.md`](0018-batch-operation-root-and-token-identity.md) | Accepted | [#688](https://github.com/6529-Collections/6529Stream/issues/688): one manager batch root, `N` token operation IDs, ledger-owned root replay, and atomic Core replay-state cutover |
