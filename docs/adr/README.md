...
| [`0021-immutable-revenue-resolver-validation-adapter.md`](0021-immutable-revenue-resolver-validation-adapter.md) | Proposed | [#670](https://github.com/6529-Collections/6529Stream/issues/670); implementation remains blocked pending explicit acceptance |
