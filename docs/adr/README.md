...
| [`0018-batch-operation-root-and-token-identity.md`](0018-batch-operation-root-and-token-identity.md) | Accepted | [#688](https://github.com/6529-Collections/6529Stream/issues/688): accepted one manager batch root, `N` token operation IDs, ledger-owned root replay, and atomic Core replay-state cutover; implementation and settlement integration remain blocked on the atomic source cutover and ADR 0019 / #694 |
