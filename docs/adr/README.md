...
| [`0018-batch-operation-root-and-token-identity.md`](0018-batch-operation-root-and-token-identity.md) | Accepted | [#688](https://github.com/6529-Collections/6529Stream/issues/688): one manager batch root, `N` token operation IDs, ledger-owned root replay, and the atomic Core replay-state cutover are implemented; typed settlement and repeated-sale replay remain ADR 0019 / #694 blockers |
...
| [`0023-modular-artist-authority-domain-ownership.md`](0023-modular-artist-authority-domain-ownership.md) | Proposed | Non-roadmap successor architecture packet; if accepted, supersedes ADR 0022's monolithic artist topology with seven global semantic-domain owners, 57 immutable stateless coordinator recipes, five manifest-pinned external providers, a slim typed Registry, and evidence-only ArchiveV2; candidate provider values and interface reconciliation remain implementation blockers |
