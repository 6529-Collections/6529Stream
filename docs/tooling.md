...
committed tracker map, body-sync artifact, packet index, and public-beta
evidence manifest agree on which tracker issues may close. To audit live
GitHub closure state without adding network access to CI, export all linked
issue states and pass the snapshot to the checker:
