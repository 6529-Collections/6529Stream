...
accounting, randomizer reserves, emergency withdrawal boundaries outside the
currently bounded local payment contracts, randomizer hardening,
static-analysis triage, admin/pause controls, deployment discipline, and the
broader P0/P1 test suite.
