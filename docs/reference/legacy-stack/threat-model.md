# Historical threat-model baseline

> Historical reference from commit 330ac1d4; internal current claims describe the
> earlier stack. See the [current threat model](../../threat-model.md).
...
- [`test/regression/legacy/protocol/StreamProtocolStateMachine.t.sol`](../../../test/regression/legacy/protocol/StreamProtocolStateMachine.t.sol)
- [`test/regression/legacy/protocol/StreamMEVTiming.t.sol`](../../../test/regression/legacy/protocol/StreamMEVTiming.t.sol)
...
- [payment invariant tests](../../../test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol)
- [supply, replay, and freeze invariant tests](../../../test/regression/legacy/protocol/StreamSupplyReplayFreezeInvariant.t.sol)
- [auction invariant tests](../../../test/regression/legacy/auctions/StreamAuctionInvariant.t.sol)
- [protocol state-machine smoke harness](../../../test/regression/legacy/protocol/StreamProtocolStateMachine.t.sol)
- [randomizer payment tests](../../../test/unit/entropy/StreamRandomizerPayments.t.sol)
- [deployment manifest tests](../../../test/regression/legacy/protocol/StreamDeploymentManifest.t.sol)
- [audit package checker](../../../tools/docs/check_audit_package.py)
