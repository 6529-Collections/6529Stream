# Historical reference: wallets and signatures
...
> Use the [current guide](../../../integrations/wallets-and-signatures.md) for new integrations.
...
| Contract implementation | [`smart-contracts/domains/mint/legacy/StreamDrops.sol`](../../../../smart-contracts/domains/mint/legacy/StreamDrops.sol) | Domain separator, digest, signer validation, replay, and sale validation |
...
| EIP-712 tests | [`test/unit/mint/StreamDropsEIP712.t.sol`](../../../../test/unit/mint/StreamDropsEIP712.t.sol) | EOA, wrong domain, wrong chain, expiry, replay, cancellation, epoch, malformed, and sale-field tests |
| ERC-1271 tests | [`test/unit/mint/StreamDropsERC1271.t.sol`](../../../../test/unit/mint/StreamDropsERC1271.t.sol) | Contract-signer success and fail-closed tests |
| Fork-aware Safe/ERC-1271 smoke tests | [`test/regression/legacy/protocol/StreamSafeERC1271ForkSmoke.t.sol`](../../../../test/regression/legacy/protocol/StreamSafeERC1271ForkSmoke.t.sol) | Safe-shaped approved-hash threshold, fixed-price, auction, wrong-chain, and wrong-verifying-contract smoke coverage |
...
| Fixture checker | [`tools/protocol/check_drop_authorization_fixtures.py`](../../../../tools/protocol/check_drop_authorization_fixtures.py) | Canonical domain/type/fixture validation |
| Signing evidence checker | [`tools/release/check_drop_authorization_signing_evidence.py`](../../../../tools/release/check_drop_authorization_signing_evidence.py) | Retained evidence validation |
| Signer custody checker | [`tools/release/check_signer_custody_readiness.py`](../../../../tools/release/check_signer_custody_readiness.py) | Signer custody readiness validation |
...
[`test/regression/legacy/protocol/StreamSafeERC1271ForkSmoke.t.sol`](../../../../test/regression/legacy/protocol/StreamSafeERC1271ForkSmoke.t.sol).
...
forge test --match-path test/regression/legacy/protocol/StreamSafeERC1271ForkSmoke.t.sol
```
