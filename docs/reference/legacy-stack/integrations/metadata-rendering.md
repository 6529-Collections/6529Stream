# Historical reference: metadata rendering
...
> Use the [current guide](../../../integrations/metadata-rendering.md) for new integrations.
...
| Marketplace/indexer evidence | [`docs/integrations/marketplace-indexer-evidence.md`](../../../integrations/marketplace-indexer-evidence.md) | `ONE-005` retained marketplace/indexer evidence requirements for contract metadata, token refresh, animation rendering, royalty display, event replay, and cache invalidation |
...
| Randomizer lifecycle | [`smart-contracts/integrations/randomizers/legacy/StreamRandomizerLifecycle.sol`](../../../../smart-contracts/integrations/randomizers/legacy/StreamRandomizerLifecycle.sol) | Pending/stale/failed/final request state |
...
| Stream contract metadata interface | [`smart-contracts/interfaces/stream/metadata/IStreamContractMetadata.sol`](../../../../smart-contracts/interfaces/stream/metadata/IStreamContractMetadata.sol) | Adapter-specific views for core/admin/URI hash binding |
...
| Fixture tests | [`test/regression/legacy/metadata/StreamMetadataGolden.t.sol`](../../../../test/regression/legacy/metadata/StreamMetadataGolden.t.sol), [`tools/protocol/check_metadata_fixtures.py`](../../../../tools/protocol/check_metadata_fixtures.py), [`tools/protocol/test_metadata_fixtures.py`](../../../../tools/protocol/test_metadata_fixtures.py) | Golden output and fixture policy checks |
| Browser sandbox tests | [`tools/deployment/check_metadata_browser_sandbox.py`](../../../../tools/deployment/check_metadata_browser_sandbox.py), [`tools/deployment/test_metadata_browser_sandbox.py`](../../../../tools/deployment/test_metadata_browser_sandbox.py), [`tools/deployment/check_rehearsal_metadata_browser_sandbox.py`](../../../../tools/deployment/check_rehearsal_metadata_browser_sandbox.py), [`tools/deployment/test_rehearsal_metadata_browser_sandbox.py`](../../../../tools/deployment/test_rehearsal_metadata_browser_sandbox.py) | Local browser execution checks |
| Metadata behavior tests | [`test/regression/legacy/metadata/StreamMetadataEvents.t.sol`](../../../../test/regression/legacy/metadata/StreamMetadataEvents.t.sol), [`test/regression/legacy/metadata/StreamContractMetadata.t.sol`](../../../../test/regression/legacy/metadata/StreamContractMetadata.t.sol), [`test/regression/legacy/metadata/StreamMetadataFreeze.t.sol`](../../../../test/regression/legacy/metadata/StreamMetadataFreeze.t.sol), [`test/regression/legacy/core/StreamCoreBurn.t.sol`](../../../../test/regression/legacy/core/StreamCoreBurn.t.sol), [`test/regression/legacy/entropy/StreamRandomizerLifecycle.t.sol`](../../../../test/regression/legacy/entropy/StreamRandomizerLifecycle.t.sol), [`test/unit/entropy/StreamRandomizerRetry.t.sol`](../../../../test/unit/entropy/StreamRandomizerRetry.t.sol), [`test/regression/legacy/dependencies/StreamDependencyRegistry.t.sol`](../../../../test/regression/legacy/dependencies/StreamDependencyRegistry.t.sol) | Current event/state behavior |
...
follow [`docs/integrations/marketplace-indexer-evidence.md`](../../../integrations/marketplace-indexer-evidence.md)
