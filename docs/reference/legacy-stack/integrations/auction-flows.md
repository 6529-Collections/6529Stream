# Historical reference: auction flows
...
> Use the [current guide](../../../integrations/auction-flows.md) for new integrations.
...
[`smart-contracts/interfaces/stream/legacy/auctions/IStreamAuctions.sol`](../../../../smart-contracts/interfaces/stream/legacy/auctions/IStreamAuctions.sol),
...
| Auction contract | [`smart-contracts/domains/auctions/legacy/AuctionContract.sol`](../../../../smart-contracts/domains/auctions/legacy/AuctionContract.sol) | Bid, settlement, credit, and pause logic |
| Drops contract | [`smart-contracts/domains/mint/legacy/StreamDrops.sol`](../../../../smart-contracts/domains/mint/legacy/StreamDrops.sol) | Authorization validation and auction registration bridge |
| Minter contract | [`smart-contracts/domains/mint/legacy/StreamMinter.sol`](../../../../smart-contracts/domains/mint/legacy/StreamMinter.sol) | NFT mint and auction custody transfer bridge |
| Auction interface | [`smart-contracts/interfaces/stream/legacy/auctions/IStreamAuctions.sol`](../../../../smart-contracts/interfaces/stream/legacy/auctions/IStreamAuctions.sol) | Integration-facing auction calls |
...
| Auction custody tests | [`test/regression/legacy/auctions/StreamAuctionCustody.t.sol`](../../../../test/regression/legacy/auctions/StreamAuctionCustody.t.sol) | Custody and no-bid characterization |
...
| Auction invariant tests | [`test/regression/legacy/auctions/StreamAuctionInvariant.t.sol`](../../../../test/regression/legacy/auctions/StreamAuctionInvariant.t.sol) | Auction accounting invariant baseline |
| Payment invariant tests | [`test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol`](../../../../test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol) | Cross-payment owed/surplus invariants |
| Protocol state-machine tests | [`test/regression/legacy/protocol/StreamProtocolStateMachine.t.sol`](../../../../test/regression/legacy/protocol/StreamProtocolStateMachine.t.sol) | End-to-end deterministic protocol flows |
| Pause tests | [`test/regression/legacy/protocol/StreamPauseControls.t.sol`](../../../../test/regression/legacy/protocol/StreamPauseControls.t.sol) | Pause-domain expectations |
...
| Payload generator | [`tools/protocol/generate_drop_authorization_payload.py`](../../../../tools/protocol/generate_drop_authorization_payload.py) | No-secret typed-data payload generator |
...
```sh
forge test --match-path test/regression/legacy/auctions/StreamAuctionCustody.t.sol
forge test --match-path test/regression/legacy/auctions/StreamAuctionPayments.t.sol
forge test --match-path test/regression/legacy/auctions/StreamAuctionInvariant.t.sol
forge test --match-path test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol
forge test --match-path test/regression/legacy/protocol/StreamPauseControls.t.sol
forge test --match-path test/regression/legacy/protocol/StreamProtocolStateMachine.t.sol
...
Refresh this document and `tools/docs/check_auction_flows.py` whenever:
