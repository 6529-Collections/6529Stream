...
> **Earlier optional-stack reference.** These contracts and discovery examples are
> not installed by the current permanent-Core deployment. Use the
> [current integration index](../../../integrations/README.md) for supported calls.
...
[`docs/integrations/README.md`](../../../integrations/README.md), the event/indexer guide in
[`docs/integrations/events-and-indexing.md`](../../../integrations/events-and-indexing.md), the
operator guide in [`docs/reference/legacy-stack/integrations/operator-admin-ui.md`](operator-admin-ui.md),
...
| --- | --- | --- |
| Integration entrypoint | [`docs/integrations/README.md`](../../../integrations/README.md) | Starts frontend, mobile, Electron, indexer, operator UI, and signing-service discovery |
| Event/indexer model | [`docs/integrations/events-and-indexing.md`](../../../integrations/events-and-indexing.md) | Event subscriptions, read-after-event calls, and reconstruction guidance |
| Operator UI model | [`docs/reference/legacy-stack/integrations/operator-admin-ui.md`](operator-admin-ui.md) | Admin ceremony and monitoring surfaces |
...
| Curator pool tests | [`test/unit/revenue/StreamCuratorsPool.t.sol`](../../../../test/unit/revenue/StreamCuratorsPool.t.sol) | Claim, delegated claim, failed withdrawal, leaf hash, root epoch, and emergency surplus behavior |
| Payment invariant tests | [`test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol`](../../../../test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol) | Cross-payment owed/surplus invariant baseline |
...
Refresh this document and `tools/docs/check_curator_rewards_flow.py` whenever:
