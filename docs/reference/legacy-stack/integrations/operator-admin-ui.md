...
> **Historical client design / legacy API reference.** The API examples below
> target the earlier drop/minter/randomizer stack. Platform design advice may still
> be useful, but use the [current integration guides](../../../integrations/README.md) for
> permanent Core transactions, signatures and events.
...
- [smart-contracts/domains/access/StreamPauseDomains.sol](../../../../smart-contracts/domains/access/StreamPauseDomains.sol)
...
- [test/unit/access/StreamAdmins.t.sol](../../../../test/unit/access/StreamAdmins.t.sol)
- [test/regression/legacy/access/StreamAdminSelectors.t.sol](../../../../test/regression/legacy/access/StreamAdminSelectors.t.sol)
- [test/regression/legacy/core/StreamCoreAdminCharacterization.t.sol](../../../../test/regression/legacy/core/StreamCoreAdminCharacterization.t.sol)
...
- [test/unit/protocol/StreamEmergencyWithdraw.t.sol](../../../../test/unit/protocol/StreamEmergencyWithdraw.t.sol)
- [test/regression/legacy/metadata/StreamMetadataFreeze.t.sol](../../../../test/regression/legacy/metadata/StreamMetadataFreeze.t.sol)
- [test/regression/legacy/dependencies/StreamDependencyRegistry.t.sol](../../../../test/regression/legacy/dependencies/StreamDependencyRegistry.t.sol)
