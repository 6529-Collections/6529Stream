...
Use [docs/integrations/metadata-rendering.md](../../../integrations/metadata-rendering.md) for the
...
Use [docs/integrations/events-and-indexing.md](../../../integrations/events-and-indexing.md) for the
...
Use [docs/reference/legacy-stack/integrations/examples/react-viem.md](examples/react-viem.md) for
