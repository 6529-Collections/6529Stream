# Historical reference: withdrawals and credits
...
> Use the [current guide](../../../integrations/withdrawals-and-credits.md) for new integrations.
...
flow in [`docs/reference/legacy-stack/integrations/curator-rewards.md`](curator-rewards.md), the
event/indexer guide in
[`docs/integrations/events-and-indexing.md`](events-and-indexing.md), the
mobile guide in [`docs/reference/legacy-stack/integrations/mobile-walletconnect.md`](mobile-walletconnect.md),
...
| Curator rewards flow | [`docs/reference/legacy-stack/integrations/curator-rewards.md`](curator-rewards.md) | Curator reward claim, delegated claim, credit, and withdrawal details |
...
| Mobile wallet guide | [`docs/reference/legacy-stack/integrations/mobile-walletconnect.md`](mobile-walletconnect.md) | Mobile foreground wallet action and stale-credit constraints |
| Electron security guide | [`docs/reference/legacy-stack/integrations/electron-security-wallets.md`](electron-security-wallets.md) | Renderer/process isolation and no-secret wallet boundaries |
| Drops contract | [`smart-contracts/domains/mint/legacy/StreamDrops.sol`](../../../../smart-contracts/domains/mint/legacy/StreamDrops.sol) | Fixed-price credits, owed totals, surplus, and withdrawal functions |
| Auction contract | [`smart-contracts/domains/auctions/legacy/AuctionContract.sol`](../../../../smart-contracts/domains/auctions/legacy/AuctionContract.sol) | Bidder credits, proceeds credits, owed totals, surplus, and withdrawal functions |
...
| Minter bridge | [`smart-contracts/domains/mint/legacy/StreamMinter.sol`](../../../../smart-contracts/domains/mint/legacy/StreamMinter.sol) | Emergency-surplus boundary for minter-held ETH |
| Randomizer adapter | [`smart-contracts/integrations/randomizers/legacy/RandomizerRNG.sol`](../../../../smart-contracts/integrations/randomizers/legacy/RandomizerRNG.sol) | Randomizer reserved-balance boundary |
...
| Fixed-price payment tests | [`test/regression/legacy/mint/StreamFixedPricePayments.t.sol`](../../../../test/regression/legacy/mint/StreamFixedPricePayments.t.sol) | Fixed-price credit split, failed withdrawal, and surplus behavior |
| Auction payment tests | [`test/regression/legacy/auctions/StreamAuctionPayments.t.sol`](../../../../test/regression/legacy/auctions/StreamAuctionPayments.t.sol) | Outbid credit, proceeds credit, failed withdrawal, and surplus behavior |
| Curator pool tests | [`test/unit/revenue/StreamCuratorsPool.t.sol`](../../../../test/unit/revenue/StreamCuratorsPool.t.sol) | Curator credit, delegated claim, failed withdrawal, and surplus behavior |
| Payment invariant tests | [`test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol`](../../../../test/regression/legacy/protocol/StreamPaymentsInvariant.t.sol) | Cross-contract owed/surplus invariant baseline |
...
forge test --match-path test/regression/legacy/mint/StreamFixedPricePayments.t.sol
forge test --match-path test/regression/legacy/auctions/StreamAuctionPayments.t.sol
forge test --match-path test/unit/revenue/StreamCuratorsPool.t.sol
