...
Use these snippets with [docs/integrations/events-and-indexing.md](../../../../integrations/events-and-indexing.md),
[docs/reference/legacy-stack/integrations/frontend-reference-architecture.md](../frontend-reference-architecture.md),
[docs/reference/legacy-stack/integrations/examples/react-viem.md](react-viem.md), and
[docs/reference/legacy-stack/integrations/examples/typescript-artifacts-and-chain-config.md](typescript-artifacts-and-chain-config.md).
...
- [test/regression/legacy/mint/StreamMinterEvents.t.sol](../../../../../test/regression/legacy/mint/StreamMinterEvents.t.sol)
- [test/regression/legacy/metadata/StreamMetadataEvents.t.sol](../../../../../test/regression/legacy/metadata/StreamMetadataEvents.t.sol)
...
const EXPECTED_EVENT_TOPIC_CATALOG_GENERATOR = "tools/build/generate_release_artifacts.py:1";
