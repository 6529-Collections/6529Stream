...
preflight, use
[docs/reference/legacy-stack/integrations/examples/typescript-eip712-drop-authorization.md](typescript-eip712-drop-authorization.md).
...
[docs/reference/legacy-stack/integrations/examples/typescript-event-decoding-and-indexer-ingestion.md](typescript-event-decoding-and-indexer-ingestion.md).
