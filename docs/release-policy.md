...
Current `StreamCore` runtime size is 18,997 bytes with 5,579 bytes of EIP-170
...
That is below the approved 22,184-byte objective and passes the normative
...
This does not make the protocol production-ready or make Core the default home
for future marketplace, provenance, permanence, royalty-policy, frontend,
indexer, or collector-evidence features.
[Issue #654](https://github.com/6529-Collections/6529Stream/issues/654) remains
open for the unresolved #670 artist and royalty pointer interface bindings.
Future Core work continues to follow [PV1-CORE-CUTOVER]: it is satellite-only
with zero Core delta, or pairs a mandatory Core addition with real removal and
reports a net-negative production-profile runtime delta. The approved
bytecode-spend ceiling remains 22,184 bytes with 2,392 bytes of baseline margin,
