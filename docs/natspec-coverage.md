...
| `declaration_not_in_source` | 401 | ABI entry is inherited or otherwise not declared in the first-party source body |

The checker reports 136 documented release-surface entries and 863 explicit
