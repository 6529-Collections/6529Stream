...
| `declaration_not_in_source` | 226 | ABI entry is inherited or otherwise not declared in the first-party source body |

The checker reports 86 documented release-surface entries and 646 explicit
