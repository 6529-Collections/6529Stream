...
families (including WORK_DESCRIPTION/RIGHTS),
...
The [recorded LIDO adapter](museum-recorded-lido.md) requires separate selected
publisher/legal-body statements; the historical account issuer remains an account.
