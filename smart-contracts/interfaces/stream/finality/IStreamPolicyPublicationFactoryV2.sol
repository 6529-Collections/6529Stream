...
} from "./StreamPolicyPublicationGraphTypesV2.sol";

interface IStreamPolicyPublicationFactoryV2 is IERC165 {
    ...
    function policyPublicationFactoryProfile() external pure returns (bytes32);
