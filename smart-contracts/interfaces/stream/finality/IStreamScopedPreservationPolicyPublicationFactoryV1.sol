...
interface IStreamScopedPreservationPolicyPublicationFactoryV1 is IERC165 {
    ...
    function scopedPreservationPolicyPublicationFactoryProfile() external pure returns (bytes32);
