...
library StreamViewPolicyManifestTypesV2 {
    bytes32 internal constant PROFILE =
        keccak256("6529STREAM_ADOPTED_POLICY_VIEW_OUTPUT_MANIFEST_V2");
    ...
    /// @dev Twelve static words. The full four-word scope is never replaced by its numeric id.
    struct Header {
