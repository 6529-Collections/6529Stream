...
} from "./StreamViewPreservationSnapshotTypesV1.sol";
import { StreamFinalityScope } from "../finality/StreamArtworkFinalityTypes.sol";

/// @notice Root-free current VIEW preservation snapshot with original writer grants and class-2 lock.
/// @dev Artist CONTENT_ROOT authority is a subsequent distinct original op17 transition.
interface IStreamViewPreservationSnapshotPublicationV1 is IERC165 {
    event ViewPreservationSnapshotPublished(
    ...
    event ViewPreservationSnapshotLocked(
