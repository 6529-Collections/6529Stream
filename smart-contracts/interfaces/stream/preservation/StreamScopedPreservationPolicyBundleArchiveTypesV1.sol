...
/// is only decoded after the distinct preservation archive capability and profile are authenticated.
library StreamScopedPreservationPolicyBundleArchiveTypesV1 {
    ...
    bytes32 internal constant COVERAGE_DOMAIN =
        keccak256("6529STREAM_SCOPED_PRESERVATION_POLICY_BUNDLE_ARCHIVE_COVERAGE_V1");
    bytes32 internal constant ITEM_DOMAIN =
        keccak256("6529STREAM_SCOPED_PRESERVATION_POLICY_BUNDLE_COVERED_ITEM_V1");
    bytes32 internal constant REFRESH_DOMAIN =
        keccak256("6529STREAM_SCOPED_PRESERVATION_POLICY_BUNDLE_REFRESH_V1");
    bytes32 internal constant OBSERVATION_DOMAIN =
        keccak256("6529STREAM_SCOPED_PRESERVATION_POLICY_BUNDLE_CURRENT_OBSERVATION_V1");
