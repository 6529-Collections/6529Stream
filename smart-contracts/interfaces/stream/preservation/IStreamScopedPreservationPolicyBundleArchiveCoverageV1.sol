...
} from "./StreamScopedPreservationPolicyBundleArchiveTypesV1.sol";
...
interface IStreamScopedPreservationPolicyBundleArchiveCoverageV1 is IERC165 {
    function scopedPreservationPolicyBundleArchiveProfile() external pure returns (bytes32);
