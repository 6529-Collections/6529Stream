...
} from "./StreamScopedPreservationPolicyRenderCriticalTypesV1.sol";
...
/// @notice Scoped preservation inventory with captured current authority, original receipt locators and six token phases.
/// @dev A current completed inventory authenticates source closure, not archive coverage or finality.
interface IStreamCurrentAuthorityScopedPreservationPolicyRenderCriticalInventoryV1 is
    IERC165,
