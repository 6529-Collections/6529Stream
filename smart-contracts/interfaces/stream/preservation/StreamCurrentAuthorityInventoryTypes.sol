...
library StreamCurrentAuthorityInventoryTypes {
    ...
    bytes32 internal constant PRESERVATION_POLICY_INVENTORY_PROFILE =
        keccak256("6529STREAM_CURRENT_AUTHORITY_PRESERVATION_POLICY_RENDER_CRITICAL_INVENTORY_V1");
    bytes32 internal constant SCOPED_PRESERVATION_POLICY_INVENTORY_PROFILE = keccak256(
        "6529STREAM_CURRENT_AUTHORITY_SCOPED_PRESERVATION_POLICY_RENDER_CRITICAL_INVENTORY_V1"
    );
