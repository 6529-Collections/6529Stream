...
import {
    StreamViewPreservationReferenceTypesV1 as S
...
/// @notice Admitted VIEW preservation BYTE_EXACT observation records; permissionless preparation grants no authority.
interface IStreamViewPreservationReferencePublicationV1 is IERC165 {
    event ViewPreservationReferencePublished(
    ...
    event ViewPreservationReferenceLocked(
