...
import {
    StreamScopedPreservationPolicyReferenceTypesV1 as S
...
interface IStreamScopedPreservationPolicyReferencePublicationV1 is IERC165 {
    ...
    function scopedPreservationPolicyReferenceProfile() external pure returns (bytes32);
