...
import { StreamPolicySnapshotAssemblyV2 as Assembly } from "./StreamPolicySnapshotAssemblyV2.sol";
...
/// @notice Distinct current COLLECTION policy/output snapshot; original V1 receipts remain unchanged.
...
contract StreamPolicySnapshotPublicationV2 is I, StreamGasParameterHost {
        ...
        returns (bytes32 hash)
    {
        ...
        emit PolicySnapshotPublished(2, r.scopeSubject, p.snapshotId, hash, p, r);
    }
        ...
        returns (bytes32 actionScope, bytes32 oldState, bytes32 newState)
    {
        ...
        actionScope = keccak256(
            abi.encode(
                keccak256("6529STREAM_POLICY_SNAPSHOT_LOCK_V2"),
                _fixed.chainId,
                address(this),
                core,
                scope
    ...
    function lockSnapshot(StreamFinalityScope calldata scope) external override guarded {
        ...
        emit PolicySnapshotLocked(2, r.scopeSubject, _locks[r.scopeSubject]);
    }
