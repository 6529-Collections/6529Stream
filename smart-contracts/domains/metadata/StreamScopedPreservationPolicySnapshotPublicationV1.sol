...
contract StreamScopedPreservationPolicySnapshotPublicationV1 is I, StreamGasParameterHost {
        ...
        returns (bytes32 hash)
    {
        ...
        emit ScopedPolicySnapshotPublished(1, r.scopeSubject, p.snapshotId, hash, p, r);
    }
    ...
    function lockSnapshot(StreamFinalityScope calldata scope) external override guarded {
        ...
        emit ScopedPolicySnapshotLocked(1, r.scopeSubject, _locks[r.scopeSubject]);
    }
