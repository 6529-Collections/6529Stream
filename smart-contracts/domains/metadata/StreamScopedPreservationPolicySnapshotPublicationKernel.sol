...
import {
    IStreamScopedPreservationPolicySnapshotPublicationV1 as I
...
abstract contract StreamScopedPreservationPolicySnapshotPublicationKernel is
    I,
    StreamGasParameterHost
{
    ...
    function scopedPreservationPolicySnapshotProfile()
        external
        pure
        virtual
        override
        ...
        returns (bytes32 actionScope, bytes32 oldState, bytes32 newState)
    {
        ...
        actionScope = keccak256(
            abi.encode(
                SnapshotFamilies.lockDomain(_family, true),
                _fixed.chainId,
                address(this),
                core,
                scope
    ...
    function lockSnapshot(StreamFinalityScope calldata scope) external override guarded {
        ...
        emit ScopedPolicySnapshotLocked(
