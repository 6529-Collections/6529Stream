...
contract StreamPreservationPolicySnapshotPublicationV1 is I, StreamGasParameterHost {
        ...
        returns (bytes32 hash)
    {
        ...
        emit PolicySnapshotPublished(1, r.scopeSubject, p.snapshotId, hash, p, r);
    }
    ...
    function lockSnapshot(StreamFinalityScope calldata scope) external override guarded {
        ...
        emit PolicySnapshotLocked(1, r.scopeSubject, _locks[r.scopeSubject]);
    }
