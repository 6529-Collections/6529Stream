...
/// @dev Fixed linked original-source reader; the host retains the Original ABI tuple.
library StreamPreservationPolicyTokenOriginalReadsV1 {
    function original(
        ...
        uint64 index,
        uint256 token
    ) public view returns (Tokens.Original memory o) {
    ...
    function _preservation(S.Dependencies memory d, Tokens.Original memory o, bytes32 family)
        private
        view
    {
        if (
