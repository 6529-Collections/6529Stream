...
import {
    IStreamPolicySnapshotPublicationV2 as P
} from "../../interfaces/stream/metadata/IStreamPolicySnapshotPublicationV2.sol";
import {
    StreamPolicySnapshotDefinitionsV2 as D
...
library StreamPolicyRenderCriticalNativeReadsV2 {
        ...
        returns (T.Item[] memory rows)
    {
        ...
        rows[next++] = Items.bytesItem(
            T.Kind.NATIVE_BYTES,
            keccak256("ORIGINAL_POLICY_CONTENT_ROOT_RECORD_V2"),
            d.targets[4],
