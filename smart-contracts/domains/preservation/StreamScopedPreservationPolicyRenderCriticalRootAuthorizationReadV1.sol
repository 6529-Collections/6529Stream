...
/// @notice Complete original scoped preservation root authorization in a fixed read worker.
/// @dev Retains original op17 proof order, full wire layouts and historical provenance.
library StreamScopedPreservationPolicyRenderCriticalRootAuthorizationReadV1 {
    struct Envelope {
        uint16 version;
