...
library StreamMultiOriginPreservationPolicyRootAuthorizationV1 {
    struct Envelope {
        uint16 version;
    ...
    function contentItem(
        ...
        // The unchanged occurrence proof certifies op17, not a root profile. Only this
        // exact preservation codec assigns the new role after all original evidence checks.
        original.role = keccak256("ORIGINAL_PRESERVATION_POLICY_CONTENT_ROOT_AUTHORIZATION_V1");
