    ...
    StreamGasParameterHost
{
        ...
        returns (bytes32 hash)
    {
        ...
        hash = keccak256(
            abi.encode(
                F.recordDomain(_referenceFamily, false),
                deploymentChainId,
                address(this),
                core,
                metadataHost,
        ...
        r.observation.recordChainHash = keccak256(
            abi.encode(
                F.chainDomain(_referenceFamily, false),
                deploymentChainId,
                address(this),
                core,
                subject,
        ...
        returns (T.Receipt memory r)
    {
        ...
        r.observation.schemaHash = F.definition(_referenceFamily, false).schemaHash;
        r.observation.profileHash = F.definition(_referenceFamily, false).profileHash;
        r.observation.canonicalizationHash = F.definition(_referenceFamily, false).canonHash;
    }
