...
/// @notice Exact original op17 evidence behind a canonical COLLECTION preservation root.
...
library StreamPreservationPolicyRenderCriticalRootAuthorizationV1 {
    struct Envelope {
        uint16 version;
    ...
    function contentItem(
        ...
        raw = IO.fixedRead(
            d.targets[4],
            abi.encodeCall(
                PreservationRoot.preservationPolicyContentRootBinding, (c.records.rootRecordHash)
            ),
            608,
            d.readGas
        );
