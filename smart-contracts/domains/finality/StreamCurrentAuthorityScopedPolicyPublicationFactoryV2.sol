...
import {
    IStreamCurrentAuthorityScopedPolicyPublicationFactoryV2 as I
} from "../../interfaces/stream/finality/IStreamCurrentAuthorityScopedPolicyPublicationFactoryV2.sol";
import {
...
import {
    StreamCurrentAuthorityScopedPolicyPublicationGraphReadsV2 as Reads
} from "./StreamCurrentAuthorityScopedPolicyPublicationGraphReadsV2.sol";
import {
...
import {
    StreamCurrentAuthorityScopedPolicyPublicationInventoryDeploymentV2 as Inventory
} from "./StreamCurrentAuthorityScopedPolicyPublicationInventoryDeploymentV2.sol";
import {
    StreamCurrentAuthorityScopedPolicyPublicationBundleDeploymentV2 as Bundle
} from "./StreamCurrentAuthorityScopedPolicyPublicationBundleDeploymentV2.sol";

/// @notice Additive current-authority children from one constructor-fixed original recipe.
/// @dev Can precede the Registry without a minted scope. Preparation grants no publication,
/// Artist, archival or finality authority. The predicted resolver is admitted at operative reads,
/// breaking the constructor cycle without weakening its eventual runtime and anchor checks.
contract StreamCurrentAuthorityScopedPolicyPublicationFactoryV2 is I {
