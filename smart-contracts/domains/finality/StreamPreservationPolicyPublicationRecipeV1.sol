...
library StreamPreservationPolicyPublicationRecipeV1 {
    function validate(T.Recipe memory r) public view {
        ...
        _gas(r.snapshotGas[0], "POLICY_SNAPSHOT_READ_GAS", 2);
        _gas(r.snapshotGas[1], "POLICY_SNAPSHOT_SOURCE_GAS", 2);
        _gas(r.snapshotGas[2], "POLICY_SNAPSHOT_INVENTORY_GAS", 2);
        _gas(r.referenceGas[0], "POLICY_REFERENCE_READ_GAS", 1);
        _gas(r.referenceGas[1], "POLICY_REFERENCE_SOURCE_GAS", 1);
        _gas(r.referenceGas[2], "POLICY_REFERENCE_SNAPSHOT_GAS", 1);
        _gas(r.referenceGas[3], "POLICY_REFERENCE_ARCHIVE_GAS", 1);
        if (
