...
import "../../interfaces/stream/finality/StreamFinalityPreservationPolicyInputManifestTypesV1.sol";
...
library StreamFinalityPreservationPolicyInputManifestReadsV1 {
    struct Dependencies {
    ...
    function encode(
        ...
        payload = abi.encode(
            StreamFinalityPreservationPolicyInputManifestSchemasV1.SCHEMA_ID,
            StreamFinalityPreservationPolicyInputManifestSchemasV1.CANON_ID,
            d.chainId,
            d.targets[0],
            d.targets[1],
            d.targets[4],
    ...
    function requireCurrent(
        ...
        schemaId = StreamFinalityPreservationPolicyInputManifestSchemasV1.SCHEMA_ID;
        canonicalizationId = StreamFinalityPreservationPolicyInputManifestSchemasV1.CANON_ID;
    ...
    function _definition(Dependencies memory d, bytes32 id, IStreamSchemaRegistry.DocumentKind kind)
        ...
        view
    {
        bytes memory expected = StreamFinalityPreservationPolicyInputManifestSchemasV1.document(id);
        bytes memory raw = StreamFinalityRouterEvidence.read(
            d.targets[2],
