...
import "./StreamCurrentAuthorityMultiScopeEvidenceProvider.sol";
import {
...
contract StreamCurrentAuthorityPolicyMultiScopeEvidenceProvider is
    StreamCurrentAuthorityMultiScopeEvidenceProvider,
    Profiles,
    IStreamPolicyOutputEvidenceBindingV2,
    IStreamPolicyPublicationEvidenceBindingV2
{
    ...
    ) StreamCurrentAuthorityMultiScopeEvidenceProvider(original, scoped) {
        if (
