...
contract StreamFinalityFullPolicyBaseEvidenceProviderV2 is
    ...
    IStreamScopedContentRootEvidenceBinding
{
    ...
    constructor(
        ...
        for (uint256 i; i < 22; ++i) {
            ...
            // Scoped STATIC output/checkpoint and snapshot/reference/inventory/bundle replace original roles.
            // No alias of their records or profiles is inferred from sharing the other roles.
            if (i != 6 && i != 7 && i != 8 && i != 9 && i != 18 && i != 19) {
                if (
