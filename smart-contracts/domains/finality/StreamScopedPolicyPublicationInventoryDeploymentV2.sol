...
import {
    StreamScopedPolicyPublicationInventoryConstructorV2 as Constructor
} from "./StreamScopedPolicyPublicationInventoryConstructorV2.sol";
import {
...
library StreamScopedPolicyPublicationInventoryDeploymentV2 {
    function deploy(T.Recipe memory r, T.Graph memory g) public returns (address) {
        return Constructor.deploy(Recipe.inventory(r, g));
    }
}
