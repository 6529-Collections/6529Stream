...
import {
    IStreamScopedPreservationPolicyReferencePublicationV1 as Ref
...
library StreamCurrentAuthorityScopedPreservationPolicyPublicationGraphReadsV1 {
    function bindings(
        T.Recipe memory r,
