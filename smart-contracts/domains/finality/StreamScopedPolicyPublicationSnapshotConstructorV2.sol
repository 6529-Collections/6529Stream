...
import {
    StreamScopedPolicySnapshotPublicationV2 as Child
} from "../metadata/StreamScopedPolicySnapshotPublicationV2.sol";

/// @notice Fixed delegate-host CREATE from the original typed constructor arguments.
library StreamScopedPolicyPublicationSnapshotConstructorV2 {
    function deploy(
