...
import {
    StreamCurrentAuthorityScopedPolicyPublicationTypesV2 as Current
...
library StreamCurrentAuthorityScopedPolicyDiscoveryFactoryReadsV2 {
        ...
        returns (address entropyFactory, bytes32 entropyCodeHash)
    {
        ...
        bytes memory raw = Reads.read(
            c.provider, abi.encodeCall(Binding.scopedPolicyPublicationBinding, ()), 192, c.readGas
        );
