...
import {
    StreamCurrentAuthorityConfiguration as Configuration
...
library StreamCurrentAuthorityPresentation {
    ...
    function artist(
        ...
        if (
            current.environment.registry != d.artistTargets[0]
                || current.registryCodeHash != d.artistCodeHashes[0]
