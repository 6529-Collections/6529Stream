...
import "./StreamFinalityMultiOriginMultiScopeEvidenceProvider.sol";
import {
...
import {
    StreamFinalityMultiOriginPolicyProviderOperationsV2 as PolicyOperations
} from "./StreamFinalityMultiOriginPolicyProviderOperationsV2.sol";
import {
...
/// @notice Multi-origin COLLECTION, scoped STATIC and policy COLLECTION V2 at one selected provider.
...
contract StreamFinalityMultiOriginPolicyMultiScopeEvidenceProvider is
    StreamFinalityMultiOriginMultiScopeEvidenceProvider,
    Profiles,
    IStreamPolicyOutputEvidenceBindingV2,
    IStreamPolicyPublicationEvidenceBindingV2
{
    ...
    ) StreamFinalityMultiOriginMultiScopeEvidenceProvider(original, scoped) {
        if (
