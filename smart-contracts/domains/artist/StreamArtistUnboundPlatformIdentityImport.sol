...
import {
    StreamArtistUnboundPlatformActivation as History
...
library StreamArtistUnboundPlatformIdentityImport {
    function importState(
        ...
        if (s.artists.length != 0) {
            ...
            Empty.install(roots, p.provenance, p.nonces, s.collections, s.rows[0]);
