...
library StreamArtistPrimaryCollaboratorIdentityVestings {
    function validate(IH.Bundle calldata b, RH.OwnerProvenance calldata p) public pure {
        ...
        if (
            b.heads.latestVesting != previous || b.heads.latestExecution != previous
                || b.heads.latestRecovery
                    != (b.recoveries.length == 0
                            ? bytes32(0)
                            : b.recoveries[b.recoveries.length - 1].record.recordHash)
