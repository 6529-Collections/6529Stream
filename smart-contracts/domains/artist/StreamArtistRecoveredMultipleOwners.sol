...
import {
    StreamArtistRecoveredMultipleCollectionSource as Collections
} from "./StreamArtistRecoveredMultipleCollectionSource.sol";
import {
...
library StreamArtistRecoveredMultipleOwners {
    struct Context {
