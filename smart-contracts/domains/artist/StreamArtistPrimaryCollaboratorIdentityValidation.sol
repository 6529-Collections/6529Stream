...
import {
    StreamArtistRecoveredMultipleConsentNonces as Delegations
} from "./StreamArtistRecoveredMultipleConsentNonces.sol";

import {
    StreamArtistPrimaryCollaboratorIdentityNative as Native
} from "./StreamArtistPrimaryCollaboratorIdentityNative.sol";
import {
    StreamArtistRecoveredIdentitySourceCauses as Causes
} from "./StreamArtistRecoveredIdentitySourceCauses.sol";
import {
    StreamArtistPrimaryCollaboratorIdentityVestings as Vestings
} from "./StreamArtistPrimaryCollaboratorIdentityVestings.sol";
import {
...
import {
    StreamArtistRecoveredMultipleConsentDelegations as Grants
} from "./StreamArtistRecoveredMultipleConsentDelegations.sol";

/// @notice Complete original Identity validation and grants, then exact aggregate-local nonce membership.
library StreamArtistPrimaryCollaboratorIdentityValidation {
