...
/// @notice Resolver-owned continuity read GGP in appended namespaced storage; no provider parameter borrowing.
/// @dev Uses the original GGP V2 commitments and delayed, monotonic, at-most-2x transition.
library StreamRoyaltyContinuityParameters {
    bytes32 internal constant READ_GAS = keccak256("6529STREAM_GGP_ROYALTY_CONTINUITY_READ_GAS");
    bytes32 private constant SLOT =
        keccak256("6529STREAM_ROYALTY_CONTINUITY_PARAMETERS_STORAGE_V1");
    ...
    function initialize(address authority) internal {
        ...
        _register(s, READ_GAS, "ROYALTY_CONTINUITY_READ_GAS", 500000, 1);
    }
