...
library StreamPreparedNativeContentValidation {
            ...
            abi.decode(
                    read(
                        ...
                        abi.encodeWithSelector(
                            bytes4(0x01ffc9a7),
                            type(IStreamPreparedNativeContentSettlement).interfaceId
                        ),
                        32
                    ),
                    (uint256)
    ...
    function requireActive(
        ...
        StreamPreparedNativeContentReads.requireActive(registry, facts, intent);
