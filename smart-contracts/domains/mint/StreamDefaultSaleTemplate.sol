...
/// @notice Default TEMPLATE families selected explicitly by the signed prepared or custody-rights mode.
library StreamDefaultSaleTemplate {
    function resolve(
        ...
        return preview(resolver, collection, mode, poster, a);
    }
    ...
    function preview(
        ...
        if (
            !a.exists || a.assignmentType != 2 || a.scope != 0 || a.scopeId != 0 || a.profileId != 0
    ...
    function materialize(
        ...
        if (
            !a.exists || a.scope != 0 || a.scopeId != 0 || a.assignmentType != 2 || a.profileId != 0
                || a.templateId != s.templateId || a.assignmentHash != s.assignmentHash
                || a.policyHash != 0
        ...
        if (mode == 7) {
            ...
            if (mode != 5 && mode != 6) revert StreamSaleTemplate.UnsupportedSaleTemplate();
