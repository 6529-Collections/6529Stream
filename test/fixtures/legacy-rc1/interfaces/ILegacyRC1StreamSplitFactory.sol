...
import "./ILegacyRC1StreamSplitWallet.sol";
import "./ILegacyRC1StreamAssetPolicyRegistry.sol";

/// @notice Interface for creating deterministic split profiles and wallets.
interface ILegacyRC1StreamSplitFactory {
    ...
    function assetPolicyRegistry() external view returns (ILegacyRC1StreamAssetPolicyRegistry);
