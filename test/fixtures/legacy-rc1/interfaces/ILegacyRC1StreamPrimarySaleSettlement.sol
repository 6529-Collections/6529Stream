...
import "./ILegacyRC1StreamRevenueResolver.sol";

/// @notice Interface for outside-Core primary-sale settlement evidence.
interface ILegacyRC1StreamPrimarySaleSettlement {
    ...
    function revenueResolver() external view returns (ILegacyRC1StreamRevenueResolver);
