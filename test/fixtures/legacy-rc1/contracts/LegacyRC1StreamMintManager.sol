...
import "../../../../smart-contracts/interfaces/stream/mint/IStreamMintLedger.sol";
import "../../../../smart-contracts/interfaces/stream/mint/IStreamMintManager.sol";
import "../../../../smart-contracts/interfaces/stream/mint/compatibility/IStreamMintModuleRegistry.sol";
import "../../../../smart-contracts/vendor/openzeppelin/Ownable.sol";
import "../../../../smart-contracts/vendor/openzeppelin/ReentrancyGuard.sol";
import "../../../../smart-contracts/vendor/openzeppelin/ERC165.sol";
import "../../../../smart-contracts/domains/mint/StreamMintCoreExecutor.sol";
import "./LegacyRC1StreamMintGateValidator.sol";
import "./LegacyRC1StreamMintOperationIdentity.sol";

/// @notice Outside-Core phase policy and prepared mint execution manager.
contract LegacyRC1StreamMintManager is IStreamMintManager, Ownable, ReentrancyGuard, ERC165 {
    ...
    struct OperationTranscript {
        ...
        LegacyRC1StreamMintOperationIdentity.MintAuthorization authorization;
    }
    ...
    constructor(IStreamCore core_, IStreamMintLedger mintLedger_, IERC165 moduleRegistry_) {
        ...
        if (!LegacyRC1StreamMintGateValidator.isSupportedRegistry(moduleRegistry_)) {
    ...
    function configurePhase(
        ...
        MintGateConfig memory validatedGateConfig =
            LegacyRC1StreamMintGateValidator.validateConfiguration(gateConfig, moduleRegistry);
    ...
    function previewSubjectKey(
        ...
        LegacyRC1StreamMintOperationIdentity.SubjectContext memory context =
            LegacyRC1StreamMintOperationIdentity.SubjectContext({
        ...
        return LegacyRC1StreamMintOperationIdentity.subjectKey(keyMode, context);
    }
    ...
    function _operationTranscript(
        ...
        transcript.authorization = LegacyRC1StreamMintGateValidator.validateAuthorization(
            batch,
            gateData,
            transcript.quantity,
            transcript.boundPolicyHash,
        ...
        LegacyRC1StreamMintOperationIdentity.TranscriptContext memory context =
            LegacyRC1StreamMintOperationIdentity.TranscriptContext({
                chainId: block.chainid,
        ...
        (transcript.operationRoot, transcript.operationIds) = LegacyRC1StreamMintOperationIdentity.derive(
        ...
        returns (IStreamMintLedger.CounterConsumption[] memory consumptions)
    {
        ...
        LegacyRC1StreamMintOperationIdentity.CounterContext memory context =
            LegacyRC1StreamMintOperationIdentity.CounterContext({
                chainId: block.chainid,
                manager: address(this),
                ledger: address(mintLedger),
                executor: msg.sender,
        ...
        return LegacyRC1StreamMintOperationIdentity.deriveCounterConsumptions(
        ...
        returns (bytes32)
    {
        ...
        LegacyRC1StreamMintOperationIdentity.PolicyContext memory context =
            LegacyRC1StreamMintOperationIdentity.PolicyContext({
                chainId: block.chainid,
                manager: address(this),
                ledger: address(mintLedger),
        ...
        return LegacyRC1StreamMintOperationIdentity.computePolicyHash(
