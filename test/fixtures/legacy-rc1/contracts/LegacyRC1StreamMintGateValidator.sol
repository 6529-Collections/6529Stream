...
library LegacyRC1StreamMintGateValidator {
    ...
    function validateAuthorization(
        ...
        IERC165 moduleRegistry,
        address executor
    ) external view returns (LegacyRC1StreamMintOperationIdentity.MintAuthorization memory) {
        ...
        if (gateConfig.gate == address(0)) {
            ...
            return LegacyRC1StreamMintOperationIdentity.MintAuthorization({
