...
contract StreamCurrentFixedSurplusTest is StreamCurrentNativeSettlementTest {
    ...
    function _earned() private {
        ...
        // Paid setup already installed a genuine threshold Safe governor.
        require(address(governorSafe) != address(0), "current Safe governor retained");
...
contract StreamCurrentClearingSurplusTest is StreamCurrentClearingSaleTest {
    ...
    {
        return _withSurplusPolicy(
            StreamCurrentClearingSaleTest._additionalOperatingPolicies(), address(clearing)
        );
    }
