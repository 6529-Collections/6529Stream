...
import {
    StreamCurrentAuthorityPreservationCallerBaseline as Bootstrap
} from "../../helpers/StreamCurrentAuthorityPreservationCallerBaseline.sol";

interface CallerBaselineTestVm {
...
/// @notice Shared baseline VM cases only; these do not prepare or admit a protocol graph.
contract StreamCurrentAuthorityPreservationCallerBaselineTest {
    CallerBaselineTestVm private constant vm =
        CallerBaselineTestVm(address(uint160(uint256(keccak256("hevm cheat code")))));
