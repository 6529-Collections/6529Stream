...
import {
    StreamArtistIdentityRecoveryGovernance as Governance
...
contract ActualRecoveryPreparationTarget {
    ...
    function context() public pure returns (Recovery35.Context memory c) {
        c.scopeHash = keccak256("actual preparation scope");
        c.oldValueHash = keccak256("prior guardian fixture");
...
contract StreamArtistRecoveryPreparationGovernanceTest is ArtistRecoveryGovernanceFixture {
    ActualRecoveryPreparationTarget private target;
    ...
    function _initializeRecoveryWitness() private {
        ...
        target = new ActualRecoveryPreparationTarget(
    ...
    function testActualPublishedScheduledAssociationAndStrictExecution() public {
    ...
    function testActualLateRegistrationAndTerminalVetoStayDistinct() public {
        _initializeRecoveryWitness();
        (
            GovernanceCall[] memory calls,
            bytes[] memory data,
