...
contract StreamArtistPublicationAuthorityHydrationTest is ArtistOnboardingFixture {
    ...
    uint256[] private publicationIndices;
    P.Publication[] private publications;
    T.Authorization[] private publicationAuthorizations;
    ArtistPublicationHostFixture private candidateHost;

    function _publicationHistory() private {
    ...
    function _assertPublications(Next memory n) private view {
        _assertHistorical(n);
