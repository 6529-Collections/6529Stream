...
import {
    StreamArtistRecoveredMultipleAttestationCodec as ConsentCodec
} from "../../../smart-contracts/domains/artist/StreamArtistRecoveredMultipleAttestationCodec.sol";
import {
...
abstract contract ArtistRecoveredMultipleAttestationFixture is ArtistRecoveredMultipleFixture {
    ...
    function _multiFeature() internal pure override returns (uint256) {
        return RH.MULTIPLE_ATTESTATIONS;
    }
