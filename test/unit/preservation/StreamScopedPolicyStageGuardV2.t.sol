...
} from "../../../smart-contracts/domains/preservation/StreamScopedPolicyRenderCriticalStageGuardV2.sol";
import {
...
interface ScopedStageGuardVmV2 {
...
contract ScopedStageGuardHarnessV2 {
...
contract StreamScopedPolicyStageGuardV2Test {
    ScopedStageGuardVmV2 private constant vm =
        ScopedStageGuardVmV2(address(uint160(uint256(keccak256("hevm cheat code")))));
    ScopedStageGuardHarnessV2 private host;
    S.Dependencies private d;
    C.Context private context;
    bytes32 private id;

    function setUp() public {
        host = new ScopedStageGuardHarnessV2();
