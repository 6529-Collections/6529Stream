...
import "../../../smart-contracts/domains/preservation/StreamScopedBundleArchiveCoverage.sol";
import {
    StreamPreservationInventoryItems as Items
} from "../../../smart-contracts/domains/preservation/StreamPreservationInventoryItems.sol";

/// @dev Explicit complete-inventory boundary; archive observations, native proofs and Safes are real.
contract ScopedBundleInventoryBoundary {
    address public core;
...
contract ScopedBundleEnvironmentBoundary {
...
contract StreamScopedBundleArchiveCoverageTest is ScopedBundleArchiveFixture {
    StreamScopedBundleArchiveCoverage private bundle;
    ScopedBundleInventoryBoundary private inventory;
    ScopedBundleEnvironmentBoundary private onchain;
    T.Item[] private rows;
    ...
    function setUp() public {
        ...
        onchain = new ScopedBundleEnvironmentBoundary();
        inventory = new ScopedBundleInventoryBoundary(
        ...
        bundle = new StreamScopedBundleArchiveCoverage(d);
