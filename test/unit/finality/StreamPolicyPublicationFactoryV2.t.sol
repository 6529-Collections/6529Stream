...
import {
    StreamPolicyPublicationFactoryV2 as GraphFactory
} from "../../../smart-contracts/domains/finality/StreamPolicyPublicationFactoryV2.sol";
import {
    StreamPolicyPublicationGraphTypesV2 as GraphTypes
} from "../../../smart-contracts/interfaces/stream/finality/StreamPolicyPublicationGraphTypesV2.sol";
import {
    StreamPolicyPublicationRecipeV2 as GraphRecipe
} from "../../../smart-contracts/domains/finality/StreamPolicyPublicationRecipeV2.sol";
import {
    IStreamPolicyPublicationFactoryV2 as GraphInterface
...
import {
    IStreamPolicySnapshotPublicationV2 as GraphSnapshot
} from "../../../smart-contracts/interfaces/stream/metadata/IStreamPolicySnapshotPublicationV2.sol";
import {
    IStreamPolicyReferencePublicationV2 as GraphReference
...
contract PolicyGraphLateBoundaryV2 {
    function marker() external pure returns (uint256) {
        return 1;
    }
}

/// @notice Genuine original mixed native policies, collection inventory/source factory and all seven factory children.
...
contract StreamPolicyPublicationFactoryV2Test is ScopedPolicyReferenceFixtureV2 {
    ...
    function testRecipeConstructionRequiresNoInventoryReadsOrPreparedChildren() public {
        ...
        require(f.policyPublicationFactoryProfile() == GraphTypes.PROFILE);
    ...
    function _recipeFixture() private returns (GraphTypes.Recipe memory r) {
        address late = address(new PolicyGraphLateBoundaryV2());
