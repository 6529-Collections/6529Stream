...
import {
    StreamCurrentAuthorityScopedPolicyPublicationFactoryV2 as GraphFactory
...
import {
    IStreamCurrentAuthorityScopedPolicyPublicationFactoryV2 as AuthorityFactory
...
import {
    StreamCurrentAuthorityScopedPolicyGraphSelectionV2 as Selection
...
import {
    StreamFinalityScopedPolicyProviderReadsV2 as Policy
...
import {
    StreamCurrentAuthorityScopedPolicyRenderCriticalInventoryV2 as InventoryChild
} from "../../../smart-contracts/domains/preservation/StreamCurrentAuthorityScopedPolicyRenderCriticalInventoryV2.sol";
import {
    StreamCurrentAuthorityScopedBundleArchiveCoverage as BundleChild
...
contract AuthorityScopedPolicyLateBoundary {
...
contract AuthorityScopedPolicyResolverBoundary {
...
contract AuthorityScopedPolicySelectionHarness {
...
/// @notice Genuine seven fixed CREATE workers with explicit resolver/Artist topology boundaries.
...
contract StreamCurrentAuthorityScopedPolicyPublicationFactoryV2Test is
    ScopedPolicyReferenceFixtureV2
{
    ...
    AuthorityScopedPolicyResolverBoundary private resolver;
        ...
        public
    {
        ...
        AuthorityScopedPolicyResolverBoundary template =
            new AuthorityScopedPolicyResolverBoundary(a);
        address predicted =
        ...
        require(graphFactory.scopedPolicyPublicationFactoryProfile() == Domains.FACTORY_PROFILE);
        resolver = new AuthorityScopedPolicyResolverBoundary(a);
        require(
    ...
    function testSelectionUsesNewRecipeGraphAndInventoryDomains() public {
        StreamFinalityScope memory scope = _setup();
        GraphTypes.Graph memory g = graphFactory.prepareGraph(scope, 7);
        AuthorityScopedPolicySelectionHarness h = new AuthorityScopedPolicySelectionHarness();
    ...
    function _setup() private returns (StreamFinalityScope memory scope) {
        ...
        resolver = new AuthorityScopedPolicyResolverBoundary(_anchors(graphRecipe));
    ...
    function _recipeFixture() private returns (GraphTypes.Recipe memory r) {
        address late = address(new AuthorityScopedPolicyLateBoundary());
