    ...
    EntropyTimeAuthorityFixture
{
    ...
    function testGovernedProbeBudgetUsesCanonicalCommitmentsAndReplayRules() public {
        ...
        bytes32[] memory ids = entropy.gasParameterIds();
        require(ids.length == 5 && ids[0] == CAP);
        require(ids[1] == keccak256("6529STREAM_GGP_ENTROPY_INSTANT_READ_GAS_LIMIT"));
        require(ids[2] == keccak256("6529STREAM_GGP_ENTROPY_RELAY_AUTH_READ_GAS_LIMIT"));
        require(ids[3] == keccak256("6529STREAM_GGP_ENTROPY_RELAY_INSTANT_READ_GAS_LIMIT"));
        require(ids[4] == keccak256("6529STREAM_GGP_ENTROPY_RELAY_DELIVERY_GAS_LIMIT"));
        require(
