...
contract StreamCurrentTestPaidDocumentaryStackDeployment is ArtistArtifactCreate, IStreamCurrentTestPaidStackDeployment {
    ...
    constructor(address artistSuiteDeployment_) {
        _foundation = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidDocumentaryStackFoundation.sol:StreamCurrentTestPaidDocumentaryStackFoundation",
            abi.encode(msg.sender)
        );
        _products = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidDocumentaryStackProducts.sol:StreamCurrentTestPaidDocumentaryStackProducts",
            abi.encode(msg.sender, artistSuiteDeployment_)
        );
        _activation = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidDocumentaryStackActivation.sol:StreamCurrentTestPaidDocumentaryStackActivation",
            abi.encode(msg.sender, artistSuiteDeployment_)
        );
        _productsActivation = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidDocumentaryStackProductsActivation.sol:StreamCurrentTestPaidDocumentaryStackProductsActivation",
            abi.encode(msg.sender)
        );
        _artistActivation = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidDocumentaryStackArtistActivation.sol:StreamCurrentTestPaidDocumentaryStackArtistActivation",
            abi.encode(msg.sender)
        );
    }
