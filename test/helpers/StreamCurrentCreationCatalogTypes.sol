...
/// @notice Test-facing nominal catalog declarations without implementation imports.
/// @dev Kind ordinals and name bodies are copied exactly from the original script catalogs.
/// The native artifact roster remains an explicit build input; this file supplies no code.
/// Script callers retain their original types and cross this test boundary by ordinal.
