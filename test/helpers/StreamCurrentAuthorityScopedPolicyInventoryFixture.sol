...
import {
    StreamCurrentAuthorityScopedPolicyReferenceFixture
} from "./StreamCurrentAuthorityScopedPolicyReferenceFixture.sol";
import { CurrentAuthorityAssemblyVm } from "./StreamCurrentAuthorityNativeAssemblyFixture.sol";
import {
    StreamCurrentAuthorityScopedPolicyRenderCriticalInventoryV2 as ActualScopedInventory
} from "../../smart-contracts/domains/preservation/StreamCurrentAuthorityScopedPolicyRenderCriticalInventoryV2.sol";
import {
    StreamScopedPolicyRenderCriticalTypesV2 as ActualScopedInventoryTypes
...
/// @notice Complete dynamic source-stage traversal after actual scoped referenceResult/record publication.
...
abstract contract StreamCurrentAuthorityScopedPolicyInventoryFixture is
    StreamCurrentAuthorityScopedPolicyReferenceFixture
{
        ...
        returns (ActualItems.Item[][] memory rows)
    {
        ...
        for (uint256 i; i < logs.length; ++i) {
            ...
            require(version == 2, "actual scoped policy segment version");
            require(
