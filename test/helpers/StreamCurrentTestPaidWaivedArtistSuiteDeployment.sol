...
contract StreamCurrentTestPaidWaivedArtistSuiteDeployment is StreamCurrentTestPaidWaivedPhaseBase, IStreamCurrentTestPaidArtistSuiteDeployment {
    ...
    constructor() {
        _start = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidWaivedArtistSuiteStart.sol:StreamCurrentTestPaidWaivedArtistSuiteStart",
            abi.encode(msg.sender)
        );
        _finish = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidWaivedArtistSuiteFinish.sol:StreamCurrentTestPaidWaivedArtistSuiteFinish",
            abi.encode(msg.sender)
        );
        _complete = _artistArtifactCreate(
            "test/helpers/StreamCurrentTestPaidWaivedArtistSuiteComplete.sol:StreamCurrentTestPaidWaivedArtistSuiteComplete",
            abi.encode(msg.sender)
        );
    }
